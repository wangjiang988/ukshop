//样式模板2的js文件
  ...
  var slide_pic_max = 3;//切换广告图片限制
  var sale_max = 10;//促销区组数
	...
	for (var i = 1; i <= recommend_max; i++) {//防止数组下标重复
		if ($(".middle dl[recommend_id='"+i+"']").size()==0) {//编号不存在时添加
			...
			add_html = '<dl recommend_id="'+i+'"><dt><h4>商品推荐</h4>'+del_append+
    			...
    			'<dd><ul class="goods-list" style="width: 700px !important;height:400px"><li style="width:135px;height:200px"><span><i class="icon-gift"></i></span></li><li style="width:135px;height:200px"><span><i class="icon-gift"></i></span></li><li style="width:135px;height:200px"><span><i class="icon-gift"></i></span></li>'+
    			'<li style="width:135px;height:200px"><span><i class="icon-gift"></i></span></li><li style="width:135px;height:200px"><span><i class="icon-gift"></i></span></li><li style="width:135px;height:200px"><span><i class="icon-gift"></i></span></li>'+
    			'<li style="width:135px;height:200px"><span><i class="icon-gift"></i></span></li><li style="width:135px;height:200px"><span><i class="icon-gift"></i></span></li><li style="width:135px;height:200px"><span><i class="icon-gift"></i></span></li><li style="width:135px;height:200px"><span><i class="icon-gift"></i></span></li></ul></dd></dl>';
			...
			$("#add_recommend_list").before('<dl select_recommend_id="'+i+'"><dt><h4 class="dialog-handle-title">商品推荐模块标题名称</h4>'+
    			...
    			'<div class="s-tips"><i></i>小提示：单击查询出的商品选中，双击已选择的可以删除，最多10个，保存后生效。</div></ul></dd></dl>');
			$("#recommend_list_form dl dd ul").sortable({ items: 'li' });
			break;
		}
	}
