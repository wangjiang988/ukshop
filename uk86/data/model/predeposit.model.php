    ...
    public function changeRcb($type, $data = array())
    {
        ...
        $msg = array(
            ...
            'param' => array(
                ...
                'url' => uk86_urlShop('predeposit', 'rcb_log_list'),
                'available_amount' => uk86_ncPriceFormat($available),
                'freeze_amount' => uk86_ncPriceFormat($freeze),
                'description' => $desc,
            ),
        );

        // 发送买家消息
        Uk86QueueClient::push('sendMemberMsg', $msg);
