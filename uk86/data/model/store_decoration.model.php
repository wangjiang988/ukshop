    ...
    public function getStoreDecorationInfoDetail($decoration_id, $store_id) {
        ...
        if(!empty($store_decoration_info)) {
            ...
            if(empty($store_decoration_info['decoration_setting'])) {
                ...
                $decoration_setting['background_image_url'] = uk86_getStoreDecorationImageUrl($setting['background_image'], $store_id);
            ...
            $decoration_banner['image_url'] = uk86_getStoreDecorationImageUrl($decoration_banner['image'], $store_id);
