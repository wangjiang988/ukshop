...
class groupbuyModel extends Model{
    ...
    public function getGroupbuyListByGoodsCommonIDString($goods_commonid_string) {
        ...
        $groupbuy_list = uk86_array_under_reset($groupbuy_list, 'goods_commonid');
        return $groupbuy_list;
    }
    ...
    private function _unlockGoods($goods_commonid) {
        ...
        // 添加对列 更新商品促销价格
        Uk86QueueClient::push('updateGoodsPromotionPriceByGoodsCommonId', $goods_commonid);
    }
     ...
     *
	 */
    public function reviewFailGroupbuy($groupbuy_id, $reject_reason) {
        // 商品解锁
    ...
    public function editExpireGroupbuy($condition) {
        ...
        if (!empty($expire_groupbuy_list)) {
            ...
            Uk86QueueClient::push('updateGoodsPromotionPriceByGoodsCommonId', $goodscommonid_array);
        }
        $groupbuy_id_string = '';
        if(!empty($expire_groupbuy_list)) {
    ...
    public function getGroupbuyExtendInfo($groupbuy_info) {
        $groupbuy_info['groupbuy_url'] = uk86_urlShop('show_groupbuy', 'groupbuy_detail', array('group_id' => $groupbuy_info['groupbuy_id']));
        $groupbuy_info['goods_url'] = uk86_urlShop('goods', 'index', array('goods_id' => $groupbuy_info['goods_id']));
    ...
    private function _rGoodsGroupbuyCache($goods_commonid) {
        return uk86_rcache($goods_commonid, 'goods_groupbuy');
    }
    ...
    private function _wGoodsGroupbuyCache($goods_commonid, $info) {
        return uk86_wcache($goods_commonid, $info, 'goods_groupbuy');
    }
    ...
    private function _dGoodsGroupbuyCache($goods_commonid) {
        return uk86_dcache($goods_commonid, 'goods_groupbuy');
    }
