...
class cms_articleModel extends Model{
    ...
    public function  getNewArticle(){
        ...
        //$condition['article_end_time']=array('gt',time());
        $order="article_sort asc,article_commend_flag desc,article_type";
        $articleList=$this->where($condition)->order($order)->limit(8)->select();
        return $articleList;
    }
}
