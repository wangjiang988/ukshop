 ...
 *
 *
 * @copyright  Copyright (c) 2015 Inc. (
...
class web_conModel extends Model{ 
    ...
    public function getStyleList($style_id = 'index'){
        $style_data = array(
            'red' => Uk86Language::uk86_read('web_config_style_red'),
            'pink' => Uk86Language::uk86_read('web_config_style_pink'),
            'orange' => Uk86Language::uk86_read('web_config_style_orange'),
            'green' => Uk86Language::uk86_read('web_config_style_green'),
            'blue' => Uk86Language::uk86_read('web_config_style_blue'),
            'purple' => Uk86Language::uk86_read('web_config_style_purple'),
            'brown' => Uk86Language::uk86_read('web_config_style_brown'),
            'default' =>Uk86Language::uk86_read('web_config_style_default')
            );
