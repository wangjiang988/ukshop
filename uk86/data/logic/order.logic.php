...
class orderLogic {
    ...
    public function changeOrderSpayPrice($order_info, $role, $user = '', $price) {
        try {
            ...
            $insert_arr['msg_content'] = "订单价格修改通知，您的订单价格得到了修改";
    ...
    public function changeOrderSend($order_info, $role, $user = '', $post = array()) {
        ...
        $param['param'] = array(
            ...
            'order_url' => uk86_urlShop('member_order', 'show_order', array('order_id' => $order_id))
        );
    ...
    public function changeOrderReceivePay($order_list, $role, $user = '', $post = array()) {
        ...
        foreach($order_list as $order_info) {
            ...
            $param['param'] = array(
                    'order_sn' => $order_info['order_sn'],
                    'order_url' => uk86_urlShop('member_order', 'show_order', array('order_id' => $order_info['order_id']))
            );
            Uk86QueueClient::push('sendMemberMsg', $param);
