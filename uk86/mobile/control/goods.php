...
class goodsControl extends mobileHomeControl{
    ...
    public function goods_listOp() {
        ...
        if (is_array($indexer_ids)) {
            ...
            uk86_pagecmd('setEachNum',$this->page);
    ...
    private function _goods_list_extend($goods_list) {
        ...
        foreach ($goods_list as $key => $value) {
            ...
            //商品图片url
            $goods_list[$key]['goods_image_url'] = uk86_cthumb($value['goods_image'], 360, $value['store_id']);
    ...
    private function _goods_detail_extend($goods_detail) {
        ...
        //商品链接
        $goods_detail['goods_info']['goods_url'] = uk86_urlShop('goods', 'index', array('goods_id' => $goods_detail['goods_info']['goods_id']));
