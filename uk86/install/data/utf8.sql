...
CREATE TABLE `#__member` (
  ...
  `member_points` int(11) NOT NULL DEFAULT '0' COMMENT '会员U币',
...
CREATE TABLE `#__order_common` (
  ...
  `order_pointscount` int(11) NOT NULL DEFAULT '0' COMMENT '订单赠送U币',
  `voucher_price` int(11) DEFAULT NULL COMMENT '卡券包面额',
  `voucher_code` varchar(32) DEFAULT NULL COMMENT '卡券包编码',
...
CREATE TABLE `#__points_cart` (
  ...
  `pgoods_id` int(11) NOT NULL COMMENT 'U币礼品序号',
  `pgoods_name` varchar(100) NOT NULL COMMENT 'U币礼品名称',
  `pgoods_points` int(11) NOT NULL COMMENT 'U币礼品兑换U币',
  `pgoods_choosenum` int(11) NOT NULL COMMENT '选择U币礼品数量',
  `pgoods_image` varchar(100) DEFAULT NULL COMMENT 'U币礼品图片',
  PRIMARY KEY (`pcart_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='U币礼品兑换购物车';

CREATE TABLE `#__points_goods` (
  `pgoods_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'U币礼品索引id',
  `pgoods_name` varchar(100) NOT NULL COMMENT 'U币礼品名称',
  `pgoods_price` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT 'U币礼品原价',
  `pgoods_points` int(11) NOT NULL COMMENT 'U币礼品兑换所需U币',
  `pgoods_image` varchar(100) NOT NULL COMMENT 'U币礼品默认封面图片',
  `pgoods_tag` varchar(100) NOT NULL COMMENT 'U币礼品标签',
  `pgoods_serial` varchar(50) NOT NULL COMMENT 'U币礼品货号',
  `pgoods_storage` int(11) NOT NULL DEFAULT '0' COMMENT 'U币礼品库存数',
  `pgoods_show` tinyint(1) NOT NULL COMMENT 'U币礼品上架 0表示下架 1表示上架',
  `pgoods_commend` tinyint(1) NOT NULL COMMENT 'U币礼品推荐',
  `pgoods_add_time` int(11) NOT NULL COMMENT 'U币礼品添加时间',
  `pgoods_keywords` varchar(100) DEFAULT NULL COMMENT 'U币礼品关键字',
  `pgoods_description` varchar(200) DEFAULT NULL COMMENT 'U币礼品描述',
  `pgoods_body` text NOT NULL COMMENT 'U币礼品详细内容',
  `pgoods_state` tinyint(1) NOT NULL DEFAULT '0' COMMENT 'U币礼品状态，0开启，1禁售',
  `pgoods_close_reason` varchar(255) DEFAULT NULL COMMENT 'U币礼品禁售原因',
  `pgoods_salenum` int(11) NOT NULL DEFAULT '0' COMMENT 'U币礼品售出数量',
  `pgoods_view` int(11) NOT NULL DEFAULT '0' COMMENT 'U币商品浏览次数',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='U币礼品表';

CREATE TABLE `#__points_log` (
  `pl_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'U币日志编号',
  ...
  `pl_points` int(11) NOT NULL DEFAULT '0' COMMENT 'U币数负数表示扣除',
  ...
  PRIMARY KEY (`pl_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='会员U币日志表';
...
CREATE TABLE `#__points_order` (
  ...
  `point_allpoint` int(11) NOT NULL DEFAULT '0' COMMENT '兑换总U币',
...
CREATE TABLE `#__points_ordergoods` (
  ...
  `point_goodspoints` int(11) NOT NULL COMMENT '礼品兑换U币',
...
CREATE TABLE `#__stat_member` (
  ...
  `statm_pointsincrease` int(11) NOT NULL DEFAULT '0' COMMENT 'U币增加额',
  `statm_pointsreduce` int(11) NOT NULL DEFAULT '0' COMMENT 'U币减少额',
...
CREATE TABLE `#__upload` (
  ...
  `upload_type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '文件类别，0为无，1为文章图片，默认为0，2为帮助内容图片，3为店铺幻灯片，4为系统文章图片，5为U币礼品切换图片，6为U币礼品内容图片',
...
CREATE TABLE `#__voucher` (
  `voucher_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '卡券包编号',
  `voucher_code` varchar(32) NOT NULL COMMENT '卡券包编码',
  `voucher_t_id` int(11) NOT NULL COMMENT '卡券包模版编号',
  `voucher_title` varchar(50) NOT NULL COMMENT '卡券包标题',
  `voucher_desc` varchar(255) NOT NULL COMMENT '卡券包描述',
  `voucher_start_date` int(11) NOT NULL COMMENT '卡券包有效期开始时间',
  `voucher_end_date` int(11) NOT NULL COMMENT '卡券包有效期结束时间',
  `voucher_price` int(11) NOT NULL COMMENT '卡券包面额',
  `voucher_limit` decimal(10,2) NOT NULL COMMENT '卡券包使用时的订单限额',
  `voucher_store_id` int(11) NOT NULL COMMENT '卡券包的店铺id',
  `voucher_state` tinyint(4) NOT NULL COMMENT '卡券包状态(1-未用,2-已用,3-过期,4-收回)',
  `voucher_active_date` int(11) NOT NULL COMMENT '卡券包发放日期',
  `voucher_type` tinyint(4) NOT NULL COMMENT '卡券包类别',
  `voucher_owner_id` int(11) NOT NULL COMMENT '卡券包所有者id',
  `voucher_owner_name` varchar(50) NOT NULL COMMENT '卡券包所有者名称',
  `voucher_order_id` int(11) DEFAULT NULL COMMENT '使用该卡券包的订单编号',
  PRIMARY KEY (`voucher_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='卡券包表';

CREATE TABLE `#__voucher_price` (
  `voucher_price_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '卡券包面值编号',
  `voucher_price_describe` varchar(255) NOT NULL COMMENT '卡券包描述',
  `voucher_price` int(11) NOT NULL COMMENT '卡券包面值',
  `voucher_defaultpoints` int(11) NOT NULL DEFAULT '0' COMMENT '代金劵默认的兑换所需U币可以为0',
  PRIMARY KEY (`voucher_price_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='卡券包面额表';
...
CREATE TABLE `#__voucher_quota` (
  ...
  PRIMARY KEY (`quota_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='卡券包套餐表';

CREATE TABLE `#__voucher_template` (
  `voucher_t_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '卡券包模版编号',
  `voucher_t_title` varchar(50) NOT NULL COMMENT '卡券包模版名称',
  `voucher_t_desc` varchar(255) NOT NULL COMMENT '卡券包模版描述',
  `voucher_t_start_date` int(11) NOT NULL COMMENT '卡券包模版有效期开始时间',
  `voucher_t_end_date` int(11) NOT NULL COMMENT '卡券包模版有效期结束时间',
  `voucher_t_price` int(11) NOT NULL COMMENT '卡券包模版面额',
  `voucher_t_limit` decimal(10,2) NOT NULL COMMENT '卡券包使用时的订单限额',
  `voucher_t_store_id` int(11) NOT NULL COMMENT '卡券包模版的店铺id',
  `voucher_t_storename` varchar(100) DEFAULT NULL COMMENT '店铺名称',
  `voucher_t_creator_id` int(11) NOT NULL COMMENT '卡券包模版的创建者id',
  `voucher_t_state` tinyint(4) NOT NULL COMMENT '卡券包模版状态(1-有效,2-失效)',
  `voucher_t_total` int(11) NOT NULL COMMENT '模版可发放的卡券包总数',
  `voucher_t_giveout` int(11) NOT NULL COMMENT '模版已发放的卡券包数量',
  `voucher_t_used` int(11) NOT NULL COMMENT '模版已经使用过的卡券包',
  `voucher_t_add_date` int(11) NOT NULL COMMENT '模版的创建时间',
  `voucher_t_quotaid` int(11) NOT NULL COMMENT '套餐编号',
  `voucher_t_points` int(11) NOT NULL DEFAULT '0' COMMENT '兑换所需U币',
  `voucher_t_eachlimit` int(11) NOT NULL DEFAULT '1' COMMENT '每人限领张数',
  `voucher_t_styleimg` varchar(200) DEFAULT NULL COMMENT '样式模版图片',
  `voucher_t_customimg` varchar(200) DEFAULT NULL COMMENT '自定义卡券包模板图片',
  PRIMARY KEY (`voucher_t_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='卡券包模版表';
...
('flea_isuse', '1'),
('flea_loginpic', 'a:4:{i:1;a:2:{s:3:"pic";s:5:"flea_1.jpg";s:3:"url";s:22:"http://www.ukshop.com/";}i:2;a:2:{s:3:"pic";s:5:"flea_2.jpg";s:3:"url";s:22:"http://www.ukshop.com/";}i:3;a:2:{s:3:"pic";s:5:"flea_3.jpg";s:3:"url";s:22:"http://www.ukshop.com/";}i:4;a:2:{s:3:"pic";s:5:"flea_4.jpg";s:3:"url";s:22:"http://www.ukshop.com/";}i:5;a:2:{s:3:"pic";s:5:"flea_5.jpg";s:3:"url";s:22:"http://www.ukshop.com/";}}'),
('flea_site_description', '优康商城系统闲置市场'),
('flea_site_keywords', '优康商城系统闲置市场'),
('flea_site_name', '优康商城系统闲置市场'),
('flea_site_title', '优康商城系统闲置市场'),
('goods_verify', '0'),
('groupbuy_allow', '1'),
('groupbuy_price', '10'),
...
('live_link1', 'http://www.ukshop.com'),
('live_link2', 'http://www.ukshop.com'),
('live_link3', ''),
('live_link4', ''),
...
('mobile_apk', 'http://v3.ukshop.com/v3.apk'),
('mobile_apk_version', '3.0.2'),
('mobile_app', 'mb_app.png'),
('mobile_ios', 'http://v3.ukshop.com/v3.api'),
('mobile_isuse', '1'),
('pointprod_isuse', '1'),
('pointshop_isuse', '1'),
('points_comments', '50'),
...
(35, 1, 'http://www.ukshop.com/', 1, 1, '火爆销售中', '火爆销售中<br />', 1389864697),
(36, 1, '', 1, 255, '管理功能说明', '管理功能说明', 1389864697),
(37, 1, '', 1, 255, '如何扩充水印字体库', '如何扩充水印字体库', 1389864697),
(38, 1, '', 1, 255, '提示信息', '提示信息', 1389864697),
(39, 2, '', 1, 255, 'U币细则', 'U币细则U币细则', 1389864697),
(40, 2, '', 1, 255, 'U币兑换说明', 'U币兑换说明', 1389864697),
...
('predeposit_change', '余额变动提醒', 1, '你的账户于 {$time} 账户资金有变化，描述：{$desc}，可用金额变化 ：{$av_amount}元，冻结金额变化：{$freeze_amount}元。<a href="{$pd_url}" target="_blank"></a>', 0, '【{$site_name}】你的账户于 {$time} 账户资金有变化，描述：{$desc}，可用金额变化： {$av_amount}元，冻结金额变化：{$freeze_amount}元。', 0, '{$site_name}提醒：你的账户于 {$time} 账户资金有变化，描述：{$desc}，可用金额变化： {$av_amount}元，冻结金额变化：{$freeze_amount}元。', '<p>\r\n	{$site_name}提醒：\r\n</p>\r\n<p>\r\n	你的账户于 {$time} 账户资金有变化，描述：{$desc}，可用金额变化：{$av_amount}元，冻结金额变化：{$freeze_amount}元。\r\n</p>\r\n<p>\r\n	<a href="{$pd_url}" target="_blank"></a> \r\n</p>\r\n<p>\r\n	<br />\r\n</p>\r\n<p>\r\n	<br />\r\n</p>\r\n<p>\r\n	<br />\r\n</p>\r\n<p style="text-align:right;">\r\n	{$site_name}\r\n</p>\r\n<p style="text-align:right;">\r\n	{$mail_send_time}\r\n</p>'),
...
('voucher_use', '卡券包使用提醒', 1, '您有卡券包已经使用，卡券包编号：{$voucher_code}。<a href="{$voucher_url}" target="_blank">点击查看</a>', 0, '【{$site_name}】您有卡券包已经使用，卡券包编号：{$voucher_code}。', 0, '{$site_name}提醒：您有卡券包已经使用，卡券包编号：{$voucher_code}。', '<p>\r\n	{$site_name}提醒：\r\n</p>\r\n<p>\r\n	您有卡券包已经使用，卡券包编号：{$voucher_code}。\r\n</p>\r\n<p>\r\n	&lt;a href="{$voucher_url}" target="_blank"&gt;点击查看&lt;/a&gt;\r\n</p>\r\n<p>\r\n	<br />\r\n</p>\r\n<p>\r\n	<br />\r\n</p>\r\n<p>\r\n	<br />\r\n</p>\r\n<p style="text-align:right;">\r\n	{$site_name}\r\n</p>\r\n<p style="text-align:right;">\r\n	{$mail_send_time}\r\n</p>\r\n<p>\r\n	<br />\r\n</p>\r\n<p>\r\n	<br />\r\n</p>');
...
INSERT INTO `#__seo` (`id`, `title`, `keywords`, `description`, `type`) VALUES (1, '{sitename} - 程序来源于优康商城-www.ukshop.com', '优康商城,PHP商城系统,优康商城商城系统,多用户商城系统,电商ERP,电商CRM,电子商务解决方案', '优康商城专注于研发符合时代发展需要的电子商务商城系统，以专业化的服务水平为企业级用户提供B(2B)2C【B2B2C】电子商务平台解决方案，全力打造电商平台专项ERP(CRM)系统、ERP(RFID)系统等，引领中国电子商务行业企业级需求的发展方向。咨询电话：400-611-5098', 'index'),
(2, '{sitename} - 团购', '优康商城,{sitename}', '优康商城专注于研发符合时代发展需要的电子商务商城系统，以专业化的服务水平为企业级用户提供B(2B)2C【B2B2C】电子商务平台解决方案，全力打造电商平台专项ERP(CRM)系统、ERP(RFID)系统等，引领中国电子商务行业企业级需求的发展方向。咨询电话：400-611-5098', 'group'),
(3, '{sitename} - {name}', '优康商城,{name},{sitename}', '优康商城,{name},{sitename}', 'group_content'),
(4, '{sitename} - 品牌', '优康商城,{sitename}', '优康商城,{sitename}', 'brand'),
(5, '{sitename} - {name}', '优康商城,{sitename},{name}', '优康商城,{sitename},{name}', 'brand_list'),
(7, '{sitename} - {name}', '优康商城,{sitename},{name}', '优康商城,{sitename},{name}', 'coupon_content'),
(8, '{sitename} - U币商城', '优康商城,{sitename}', '优康商城,{sitename}', 'point'),
(9, '{sitename} - {name}', '优康商城,{sitename},{key}', '优康商城,{sitename},{description}', 'point_content'),
(10, '{sitename} - {article_class}', '优康商城,{sitename}', '优康商城,{sitename}', 'article'),
(11, '{sitename} - {name}', '优康商城,{sitename},{key}', '优康商城,{sitename},{description}', 'article_content'),
(12, '{sitename} - {shopname}', '优康商城,{sitename},{key}', '优康商城,{sitename},{description}', 'shop'),
(13, '{name} - {sitename}', '优康商城,{sitename},{key}', '优康商城,{sitename},{description}', 'product'),
(14, '看{name}怎么淘到好的宝贝-{sitename}', '优康商城,{sitename},{name}', '优康商城,{sitename},{name}', 'sns');
...
ALTER TABLE `#__points_order` CHANGE `point_orderstate` `point_orderstate` int(11) NOT NULL DEFAULT '20' COMMENT '订单状态：20(默认):已兑换并扣除U币;30:已发货;40:已收货;50已完成;2已取消';
...
INSERT INTO `#__member_msg_tpl` (`mmt_code`, `mmt_name`, `mmt_message_switch`, `mmt_message_content`, `mmt_short_switch`, `mmt_short_content`, `mmt_mail_switch`, `mmt_mail_subject`, `mmt_mail_content`) VALUES('voucher_will_expire', '卡券包即将到期提醒', 1, '您有一个卡券包即将在{$indate}过期，请记得使用。<a href="{$voucher_url}" target="_blank">点击查看</a>', 0, '【{$site_name}】您有一个卡券包即将在{$indate}过期，请记得使用。', 0, '{$site_name}提醒：您有一个卡券包即将在{$indate}过期，请记得使用。', '<p>\r\n	{$site_name}提醒：\r\n</p>\r\n<p>\r\n	您有一个卡券包即将在{$indate}过期，请记得使用。\r\n</p>\r\n<p>\r\n	<a href="{$voucher_url}" target="_blank">点击查看</a> \r\n</p>\r\n<p>\r\n	<br />\r\n</p>\r\n<p>\r\n	<br />\r\n</p>\r\n<p>\r\n	<br />\r\n</p>\r\n<p style="text-align:right;">\r\n	{$site_name}\r\n</p>\r\n<p style="text-align:right;">\r\n	{$mail_send_time}\r\n</p>\r\n<p>\r\n	<br />\r\n</p>\r\n<p>\r\n	<br />\r\n</p>');
