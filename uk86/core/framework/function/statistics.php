 ...
 */
function uk86_getStatData_LineLabels($stat_arr){
	//图表区、图形区和通用图表配置选项
 ...
 * 获得Column2D统计图数据
 */
function uk86_getStatData_Column2D($stat_arr){
    //图表区、图形区和通用图表配置选项
 ...
 * 获得Basicbar统计图数据
 */
function uk86_getStatData_Basicbar($stat_arr){
    //图表区、图形区和通用图表配置选项
 ...
 * 计算环比
 */
function uk86_getHb($updata, $currentdata){
	if($updata != 0){
 ...
 * 计算同比
 */
function uk86_getTb($updata, $currentdata){
	if($updata != 0){
 ...
 * 地图统计图
 */
function uk86_getStatData_Map($stat_arr){
 ...
 * 获得饼形图数据
 */
function uk86_getStatData_Pie($data){
