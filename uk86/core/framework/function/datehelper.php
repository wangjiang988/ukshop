 ...
 * 获得系统年份数组
 */
function uk86_getSystemYearArr(){
 ...
 * 获得系统月份数组
 */
function uk86_getSystemMonthArr(){
 ...
 * 获得系统周数组
 */
function uk86_getSystemWeekArr(){
 ...
 * 获取某月的最后一天
 */
function uk86_getMonthLastDay($year, $month){
 ...
 */
function uk86_getMonthWeekArr($current_year, $current_month){
	//该月第一天
 ...
 * 获取本周的开始时间和结束时间
 */
function uk86_getWeek_SdateAndEdate($current_time){
