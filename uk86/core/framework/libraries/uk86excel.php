...
class Uk86Excel{
	...
	* @todo 行创建
	*/
	private function Uk86_addRow ($array)
	{
		//初始化单元格
		$cells = "";
		//构建单元格
	...
	* @todo 构造多行
	*/
	public function uk86_addArray ($array)
	{
		$this->lines = array();
		//构建行数据
	...
	* @todo 构造工作表XML
	*/
	public function uk86_addWorksheet($sheettitle)
	{
		//剔除特殊字符
	...
	*/
	public function uk86_setStyle ($style_arr){
		if(empty($style_arr)){
			return false;
		}
		$id = $style_arr['id'];
	...
	* @param string
	*/
	public function uk86_setDefaultFormat ($format_str){
		if(empty($style_arr)){
			return false;
		}
	...
	*/
	public function uk86_generateXML ($filename)
	{
	 ...
	 * @return mixed
	 */
    public function uk86_charset($content, $from='gbk', $to='utf-8') {
