...
<div class="microshop-store-top">
  <div class="left-box">
    <dl class="store-intro">
      <dt>
        <h2><a href="<?php echo uk86_urlShop('show_store', 'index', array('store_id' => $output['detail']['store_id']), $output['detail']['store_domain']);?>" target="_blank"><?php echo $output['detail']['store_name'];?></a></h2>
  ...
  <div class="right-box">
    ...
    <div class="store-logo">
        <a href="<?php echo uk86_urlShop('show_store', 'index', array('store_id'=>$output['detail']['store_id']), $output['detail']['store_domain']);?>" target="_blank"> 
            <img src="<?php echo uk86_getStoreLogo($output['detail']['store_label']);?>" alt="<?php echo $output['detail']['store_name'];?>" />
        </a>
    </div>
    <p><a href="<?php echo uk86_urlShop('show_store', 'index', array('store_id'=>$output['detail']['store_id']), $output['detail']['store_domain']);?>" target="_blank"><?php echo $lang['microshop_text_enter'].$lang['microshop_text_store'];?><i></i></a></p>
  </div>
</div>
  ...
  <div class="store-goods-list-box">
    ...
    <div class="store-goods-list">
      ...
      <div class="store-goods-item">
        <div class="picture"> <a href="<?php echo uk86_urlShop('goods', 'index', array('goods_id'=>$output['list'][$i]['goods_id']));?>" target="_blank">
          <?php $image_url = uk86_cthumb($output['list'][$i]['goods_image'], 240,$output['list'][$i]['store_id']);?>
          ...
          <div class="price"> <?php echo $lang['currency'];?><strong><?php echo uk86_ncPriceFormat($output['list'][$i]['goods_price']);?></strong></div>
        </div>
        <div class="goods-title"> <a href="<?php echo uk86_urlShop('goods', 'index',array('goods_id'=>$output['list'][$i]['goods_id']));?>" target="_blank"> <?php echo $output['list'][$i]['goods_name'];?> </a> </div>
