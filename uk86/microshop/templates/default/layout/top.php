...
<div class="public-top-layout w">
  <div class="topbar warp-all">
    <div class="user-entry">
      ...
      <?php echo $lang['nc_hello'];?><span><a href="<?php echo uk86_urlShop('member', 'home');?>"><?php echo uk86_str_cut($_SESSION['member_name'],20);?></a></span><?php echo $lang['nc_comma'],$lang['welcome_to_site'];?> <a href="<?php echo SHOP_SITE_URL;?>"  title="<?php echo $lang['homepage'];?>" alt="<?php echo $lang['homepage'];?>"><span><?php echo $output['setting_config']['site_name']; ?></span></a> <span>[<a href="<?php echo uk86_urlShop('login','logout');?>"><?php echo $lang['nc_logout'];?></a>]</span>
      <?php }else{?>
      <?php echo $lang['nc_hello'].$lang['nc_comma'].$lang['welcome_to_site'];?> <a href="<?php echo SHOP_SITE_URL;?>" title="<?php echo $lang['homepage'];?>" alt="<?php echo $lang['homepage'];?>"><?php echo $output['setting_config']['site_name']; ?></a> <span>[<a href="<?php echo uk86_urlShop('login');?>"><?php echo $lang['nc_login'];?></a>]</span> <span>[<a href="<?php echo uk86_urlShop('login','register');?>"><?php echo $lang['nc_register'];?></a>]</span>
      <?php }?>
      <span class="seller-login"><a href="<?php echo uk86_urlShop('seller_login','show_login');?>" target="_blank" title="登录商家管理中心"><i class="icon-signin"></i>商家管理中心</a></span></div>
...
<div id="navBar" class="pngFix">
  <div id="navBox">
    ...
    <div class="microMall-user">
      ...
      <?php $member_avatar = uk86_getMemberAvatar($_SESSION['member_avatar']); ?>
      <?php } ?>
