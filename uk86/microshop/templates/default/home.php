...
<div class="user-page-top">
  <div class="user-info-box">
    <div class="user-avatar"><span class="thumb size100"><i></i><img src="<?php echo uk86_getMemberAvatar($output['member_info']['member_avatar']);?>" alt="<?php echo $output['member_info']['member_name'];?>" onload="javascript:DrawImage(this,120,120);" /></span></div>
    <dl class="user-intro">
      <dt>
