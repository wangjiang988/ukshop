    ...
    <form action="<?php echo MICROSHOP_SITE_URL;?>/index.php?act=share&op=share_save&type=<?php echo $_GET['act'];?>" method="post" id="share_form" class="feededitor">
        ...
        <div class="command-goods">
            <div class="pic">
                <span class="thumb size100">
                    <i></i>
                <?php $image_url = uk86_cthumb($output['detail']['commend_goods_image'], 60,$output['detail']['commend_goods_store_id']);?>
        ...
        <div class="command-goods">
            <div class="pic">
                <span class="thumb size100">
                    <i></i>
                    <?php $personal_image_array = uk86_getMicroshopPersonalImageUrl($output['detail'],'tiny');?>
