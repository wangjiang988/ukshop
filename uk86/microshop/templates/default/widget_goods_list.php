...
<div class="commend-goods-list">
    <ul id="pinterest">
        ...
        <div class="picture"> <a href="<?php echo MICROSHOP_SITE_URL;?>/index.php?act=goods&op=detail&goods_id=<?php echo $value['commend_id'];?>" target="_blank">
                <?php $image_url = uk86_cthumb($value['commend_goods_image'], 240,$value['commend_goods_store_id']);?>
            ...
            <div class="price"> <?php echo $lang['currency'];?><strong><?php echo uk86_ncPriceFormat($value['commend_goods_price']);?></strong></div>
        ...
        <dl class="commentary">
            <dt><span class="thumb size30"><i></i><a href="<?php echo MICROSHOP_SITE_URL;?>/index.php?act=home&member_id=<?php echo $value['commend_member_id'];?>" target="_blank"> <img src="<?php echo uk86_getMemberAvatar($value['member_avatar']);?>" alt="<?php echo $value['member_name'];?>" onload="javascript:DrawImage(this,30,30);" /> </a></span></dt>
            <dd>
