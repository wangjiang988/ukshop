...
<div class="index">
  ...
  <div class="right">
    ...
    <div class="user-box">
      ...
      <dl class="big-gun">
        <dt class="portrait"><a href="<?php echo MICROSHOP_SITE_URL.DS;?>index.php?act=home&member_id=<?php echo $value['member_id'];?>" target="_blank"><img src="<?php echo uk86_getMemberAvatar($value['member_avatar']);?>" onload="javascript:DrawImage(this,60,60);" /></a></dt>
...
<div class="main-box personal">
  ...
  <ul id="indexPersonal" class="jcarousel-skin-personal">
    ...
    <?php $personal_image_array = uk86_getMicroshopPersonalImageUrl($value,'list');?>
    <li style="background-image: url(<?php echo $personal_image_array[0];?>)"><a href="<?php echo MICROSHOP_SITE_URL;?>/index.php?act=personal&op=detail&personal_id=<?php echo $value['personal_id'];?>"></a>
      <div class="arrow">&nbsp;</div>
      <dl>
        <dt><img src="<?php echo uk86_getMemberAvatar($value['member_avatar']);?>" onload="javascript:DrawImage(this,30,30);" /></dt>
...
<div class="main-box goods">
  ...
  <ul class="goods-class-pic">
    ...
    <?php $image_url = uk86_cthumb($value_goods['commend_goods_image'], 240,$value_goods['commend_goods_store_id']);?>
