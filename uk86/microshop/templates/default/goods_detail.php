...
<div class="commend-goods">
  <div class="commend-goods-info">
    <div class="user">
      <div class="user-face"><span class="thumb size60"><i></i><a href="<?php echo MICROSHOP_SITE_URL;?>/index.php?act=home&member_id=<?php echo $output['detail']['commend_member_id'];?>" target="_blank"> <img src="<?php echo uk86_getMemberAvatar($output['detail']['member_avatar']);?>" alt="<?php echo $output['detail']['member_name'];?>" onload="javascript:DrawImage(this,60,60);" /> </a></span> </div>
      <dl>
    ...
    <div class="goods">
      <h3><a href="<?php echo uk86_urlShop('goods', 'index', array('goods_id'=>$output['detail']['commend_goods_id']));?>" target="_blank" title="<?php echo $output['detail']['commend_goods_name'];?>"> <?php echo $output['detail']['commend_goods_name'];?> </a></h3>
      <div class="handle-bar">
        <div class="buy-btn"><a href="javascript:void(0)"><span><?php echo $lang['microshop_text_buy'];?></span><i></i></a>
          <div class="buy-info">
            <dl>
              <dt class="goods-pic"><img src="<?php echo uk86_cthumb($output['detail']['commend_goods_image'], 60,$output['detail']['commend_goods_store_id']);?>" alt="<?php echo $output['detail']['commend_goods_name'];?>" /></dt>
              <dd><a href="<?php echo uk86_urlShop('goods', 'index', array('goods_id'=>$output['detail']['commend_goods_id']));?>" target="_blank" title="<?php echo $output['detail']['commend_goods_name'];?>" class="goods-name"><?php echo $output['detail']['commend_goods_name'];?></a>
...
<div class="microshop-store-list">
  <div class="top">
    <h2><a href="<?php echo uk86_urlShop('show_store', 'index', array('store_id' => $output['store_info']['store_id']), $output['store_info']['store_domain']);?>" target="_blank"><?php echo $output['store_info']['store_name'];?></a></h2>
  ...
  <div>
    ...
    <div class="microshop-store-info-image">
      <ul>
        ...
        <li style="background-image: url(<?php echo uk86_thumb($v, 240);?>)" title="<?php echo $v['goods_name'];?>"><a href="<?php echo uk86_urlShop('goods', 'index', array('goods_id'=>$v['goods_id']));?>" target="_blank">&nbsp;</a> <em><?php echo $v['goods_store_price'];?></em> </li>
        <?php if($i >=5) break; ?>
        <?php $i++; ?>
        <?php }?>
        <?php }?>
