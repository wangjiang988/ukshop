...
class goodsControl extends MircroShopControl{
	...
	public function listOp() {
        ...
        Tpl::output('html_title',Uk86Language::uk86_get('nc_microshop_goods').'-'.Uk86Language::uk86_get('nc_microshop').'-'.C('site_name'));
    ...
    public function detailOp() {
        ...
        Tpl::output('html_title',$detail['commend_goods_name'].'-'.Uk86Language::uk86_get('nc_microshop_goods').'-'.Uk86Language::uk86_get('nc_microshop').'-'.C('site_name'));
