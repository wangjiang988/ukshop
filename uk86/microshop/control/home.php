...
class homeControl extends MircroShopControl{
	...
	public function __construct() {
        ...
        Tpl::output('html_title',$member_info['member_name'].'-'.Uk86Language::uk86_get('nc_microshop').'-'.C('site_name'));
    ...
    public function home_dropOp() {
        ...
        if(empty($_SESSION['member_id'])) {
            self::return_json(Uk86Language::uk86_get('no_login'),'false');
        }
    ...
    public function add_followOp() {
        ...
        if(empty($member_list)){
            self::return_json(Uk86Language::uk86_get('nc_common_save_fail'),'false');
        }
        $self_info = array();
        $member_info = array();
        ...
        if($result){
            ...
            self::return_json(Uk86Language::uk86_get('nc_common_save_succ'),'true');
        }else{
            self::return_json(Uk86Language::uk86_get('nc_common_save_fail'),'false');
        }
    }
