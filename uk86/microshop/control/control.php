...
class MircroShopControl{
    ...
    protected function share_app_publish($type,$publish_info=array()) {
        ...
        switch ($type) {
        case 'comment':
            $param['comment'] = "'".$_SESSION['member_name']."'".Uk86Language::uk86_get('microshop_text_zai').Uk86Language::uk86_get('nc_microshop').Uk86Language::uk86_get('microshop_text_comment').Uk86Language::uk86_get('microshop_text_le').Uk86Language::uk86_get("nc_microshop_{$publish_info['type']}_content");
            $param['title'] = "'".$_SESSION['member_name']."'".Uk86Language::uk86_get('microshop_text_zai').Uk86Language::uk86_get('nc_microshop').Uk86Language::uk86_get('microshop_text_comment').Uk86Language::uk86_get('microshop_text_le').Uk86Language::uk86_get("nc_microshop_{$publish_info['type']}_content");
            break;
        case 'publish':
            $param['comment'] = "'".$_SESSION['member_name']."'".Uk86Language::uk86_get('microshop_text_zai').Uk86Language::uk86_get('nc_microshop').Uk86Language::uk86_get('microshop_text_commend').Uk86Language::uk86_get('microshop_text_le').Uk86Language::uk86_get("nc_microshop_{$publish_info['type']}_content");
            $param['title'] = "'".$_SESSION['member_name']."'".Uk86Language::uk86_get('microshop_text_zai').Uk86Language::uk86_get('nc_microshop').Uk86Language::uk86_get('microshop_text_commend').Uk86Language::uk86_get('microshop_text_le').Uk86Language::uk86_get("nc_microshop_{$publish_info['type']}_content");
            break;
        case 'share':
            $param['comment'] = "'".$_SESSION['member_name']."'".Uk86Language::uk86_get('microshop_text_zai').Uk86Language::uk86_get('nc_microshop').Uk86Language::uk86_get('microshop_text_share').Uk86Language::uk86_get('microshop_text_le').Uk86Language::uk86_get("nc_microshop_{$publish_info['type']}_content");
            $param['title'] = "'".$_SESSION['member_name']."'".Uk86Language::uk86_get('microshop_text_zai').Uk86Language::uk86_get('nc_microshop').Uk86Language::uk86_get('microshop_text_share').Uk86Language::uk86_get('microshop_text_le').Uk86Language::uk86_get("nc_microshop_{$publish_info['type']}_content");
            break;
        }
    ...
    protected function get_share_app_goods_content($goods_info,$param) {
        $content_str = "
            <div class='fd-media'>
            <div class='goodsimg'><a target=\"_blank\" href=\"{$param['url']}\"><img src=\"".uk86_cthumb($goods_info['commend_goods_image'], 240, $goods_info['commend_goods_store_id'])."\" onload=\"javascript:DrawImage(this,120,120);\" title=\"{$goods_info['commend_goods_name']}\" alt=\"{$goods_info['commend_goods_name']}\"></a></div>
            <div class='goodsinfo'>
            <dl>
            <dt><a target=\"_blank\" href=\"{$param['url']}\">{$goods_info['commend_goods_name']}</a></dt>
            <dd>".Uk86Language::uk86_get('nc_common_price').Uk86Language::uk86_get('nc_colon').Uk86Language::uk86_get('currency').$goods_info['commend_goods_price']."</dd>
            <dd>{$param['comment']}<a target=\"_blank\" href=\"{$param['url']}\">".Uk86Language::uk86_get('nc_common_goto')."</a></dd>
            </dl>
            </div>
            </div>
            ";
    ...
    protected function get_share_app_personal_content($personal_info,$param) {
        $personal_image_array = uk86_getMicroshopPersonalImageUrl($personal_info,'list');
        $personal_image_array_tiny = uk86_getMicroshopPersonalImageUrl($personal_info,'tiny');
        $content_str = "
            <div class='fd-media'>
        ...
        $content_str .= "</ul><p>{$param['comment']}<a target=\"_blank\" href=\"{$param['url']}\">".Uk86Language::uk86_get('nc_common_goto')."</a></p>
            </div>
            </div>
            ";
        return $content_str;
    ...
    protected function get_share_app_store_content($store_info,$param) {
        $content_str = "
            <div class='fd-media'>
            <div class='goodsimg'><a target=\"_blank\" href=\"{$param['url']}\"><img src=\"".uk86_getStoreLogo($store_info['store_label'])."\" onload=\"javascript:DrawImage(this,120,120);\"></a></div>
            <div class='goodsinfo'>
            <dl>
	...
	protected function get_member_detail_info($member_info) {
		...
		//先查找$member_id缓存
		if ($_cache = uk86_rcache($member_id,'sns_member')){
			...
			uk86_wcache($member_id,$member_info,'sns_member');
		}
        return $member_info;
	}
