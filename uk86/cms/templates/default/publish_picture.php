            ...
            <td rowspan="3" class="w200"><input id="picture_image" name="picture_image" type="hidden" value="" />
              <div class="edit-cover-pic">
                ...
                <?php if(!empty($output['picture_detail']['picture_image'])) { ?>
                 <img alt="" src="<?php echo uk86_getCMSArticleImageUrl($output['picture_detail']['picture_attachment_path'],$output['picture_detail']['picture_image'], 'list');?>">
                 <?php } ?>
             </div>
                ...
                <li>
                  <dl class="picture-content">
                    <dt class="picture-img">
                      <div class="upload-thumb"><a href="Javascript: void(0);"><img nctype="picture_image_item" alt="" src="<?php echo uk86_getCMSArticleImageUrl(empty($value['image_path'])?$output['picture_detail']['picture_attachment_path']:$value['image_path'], $value['image_name'], 'list');?>"></a></div>
