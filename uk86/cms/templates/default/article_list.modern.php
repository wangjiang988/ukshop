  ...
  <div class="modern-box">
    ...
    <div class="modern-list">
      ...
      <div class="modern-list-tag block-style-two">
        ...
        <?php $article_url = uk86_getCMSArticleUrl($output['article_list'][$i]['article_id']);?>
        <div class="modern-list-item">
          <div class="article-cover">
            <?php if(!empty($output['article_list'][$i]['article_image'])) { ?>
            <a href="<?php echo $article_url;?>" target="_blank"> <img class="image_lazy_load" data-src="<?php echo uk86_getCMSArticleImageUrl($output['article_list'][$i]['article_attachment_path'], $output['article_list'][$i]['article_image'], 'list');?>" src="<?php echo getLoadingImage();?>" alt="" /> </a>
            <?php } ?>
