...
<div class="block-style-one">
    ...
    <div class="content">
        ...
        <ol class="article-liked-top">
            ...
            <div class="article-cover" style=" background-image:url(<?php echo uk86_getCMSArticleImageUrl($value['article_attachment_path'], $value['article_image'], 'list');?>)"></div>
            <div class="article-title"><a href="<?php echo uk86_getCMSArticleUrl($value['article_id']);?>"><?php echo $value['article_title'];?></a></div>
            </li>
            <?php $commend_count++;?>
            <?php } ?>
        </ol>
...
<div class="block-style-one">
    ...
    <div class="content">
        ...
        <ul class="article-recommand-list">
            ...
            <li><a href="index.php?act=article&op=article_list&class_id=<?php echo $value['class_id'];?>" class="class" target="_blank">[<?php echo $value['class_name'];?>]</a><a href="<?php echo uk86_getCMSArticleUrl($value['article_id']);?>"><?php echo $value['article_title'];?></a></li>
