    ...
    <article class="article-detail-content">
      ...
      <section class="article-related-articles"> 
        ...
        <ul>
          ...
          <li><a target="_blank" href="<?php echo uk86_getCMSArticleUrl($value['article_id']);?>"> <?php echo $value['article_title'];?> </a> </li>
          <?php } ?>
        </ul>
          <?php } ?>
      </section>
