...
<form action="<?php echo CMS_SITE_URL;?>/index.php?act=share&op=share_save&type=<?php echo $_GET['act'];?>" method="post" id="share_form" class="feededitor">
  ...
  <input type="hidden" value="<?php echo uk86_getCMSArticleImageUrl($output[$_GET['act'].'_detail'][$_GET['act'].'_attachment_path'], $output[$_GET['act'].'_detail'][$_GET['act'].'_image']);?>" name="share_image">
  </input>
...
$(document).ready(function(){
    ...
    $("#btn_sns_share").nc_login({
        ...
        formhash:'<?php echo Uk86Security::uk86_getTokenValue();?>',
