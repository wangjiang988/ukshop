  ...
  <div class="mainbox">
    ...
    <div class="picture-images-list clearfix">
      <ul>
        ...
        <li><a href="<?php echo uk86_getCMSPictureUrl($output['picture_detail']['picture_id'], FALSE).'&count='.$image_count;?>"><img src="<?php echo uk86_getCMSArticleImageUrl(empty($value['image_path'])?$output['picture_detail']['picture_attachment_path']:$value['image_path'], $value['image_name']);?>"/></a> </li>
        <?php $image_count++;?>
        <?php } ?>
        <?php } ?>
      </ul>
    ...
    <div class="block-style-three">
      ...
      <div class="content">
        ...
        <ul class="recommand-pic-list">
          ...
          <li>
            <div class="thumb"> <a href="<?php echo uk86_getCMSPictureUrl($value['picture_id']);?>" target="_blank"> <img src="<?php echo uk86_getCMSArticleImageUrl($value['picture_attachment_path'], $value['picture_image']);?>" alt="<?php echo $value['picture_title'];?>" class="t-img"/> </a></div>
            <p class="title"> <a href="<?php echo uk86_getCMSPictureUrl($value['picture_id']);?>" target="_blank"> <?php echo $value['picture_title'];?> </a> </p>
          </li>
          <?php } ?>
        </ul>
        <?php } ?>
