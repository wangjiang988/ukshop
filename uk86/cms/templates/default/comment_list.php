...
<dl>
  <dt><span class="thumb"><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=member_snshome&mid=<?php echo $value['comment_member_id'];?>" target="_blank"> <img src="<?php echo uk86_getMemberAvatar($value['member_avatar']);?>" alt="<?php echo $value['member_name'];?>"/></a></span></dt>
  <dd>
