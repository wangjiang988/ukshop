  ...
  <div class="mainbox">
    ...
    <ul class="picture-list">
      ...
      <li>
        ...
        <div class="thumb"> <a href="<?php echo uk86_getCMSPictureUrl($value['picture_id']);?>" target="_blank"><img src="<?php echo uk86_getCMSArticleImageUrl($value['picture_attachment_path'], $value['picture_image']);?>" alt="<?php echo $value['picture_title'];?>" class="t-img"/></a></span> </div>
