        ...
        <div class="upload-images-box">
          ...
          <div class="upload-img-list" id="art-upload-scrollbar">
            <ul id="article_image_list" class="article-image-list" style="position:relative;">
              ...
              <li><div class="picture"><a href="Javascript: void(0);"><img alt="" src="<?php echo uk86_getCMSArticleImageUrl($output['article_detail']['article_attachment_path'], serialize($value), 'max');?>"></a></div>
      ...
      <tbody>
        <tr>
          ...
          <td rowspan="3" align="center" valign="middle" class="w200">
              ...
              <img alt="" src="<?php echo uk86_getCMSArticleImageUrl($output['article_detail']['article_attachment_path'],$output['article_detail']['article_image'], 'list');?>">
              <?php } ?>
              </div>
              <p class="edit-cover-text"><?php echo $lang['cms_cover'];?></p>
            <input id="article_image" name="article_image" type="hidden" value="<?php if(!empty($output['article_detail'])) echo uk86_getCMSImageName($output['article_detail']['article_image']);?>" /></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td colspan="2"><?php uk86_showEditor('article_content',$output['article_detail']['article_content'],'700px','400px','visibility:hidden;',"false",$output['editor_multimedia'],'simple');?></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td colspan="2"><input id="article_link" name="article_link" type="hidden" value="<?php if(!empty($output['article_detail'])) echo $output['article_detail']['article_link'];?>"/>
            <ul id="article_link_list" class="article-link-list">
              ...
              <li article_id="<?php echo $value['article_id'];?>" nctype="btn_article_select"><a target="_blank" href="<?php echo uk86_getCMSArticleUrl($value['article_id']);?>"> <?php echo $value['article_title'];?> </a> <i><?php echo $lang['cms_article_article_delete_explain'];?></i> </li>
              <?php } ?>
              <?php } ?>
            </ul>
