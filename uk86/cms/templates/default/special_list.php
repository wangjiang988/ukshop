...
<div class="warp-all">
  <div class="mainbox">
    ...
    <ul class="special-list">
      ...
      <li>
        <h3 class="special-title"> <a href="<?php echo uk86_getCMSSpecialUrl($value['special_id']);?>" target="_blank"> <?php echo $value['special_title'];?> </a> </h3>
        <div class="special-cover">
            <a href="<?php echo uk86_getCMSSpecialUrl($value['special_id']);?>" target="_blank"> <img src="<?php echo uk86_getCMSSpecialImageUrl($value['special_image']);?>" alt="" /></a>
        </div>
      </li>
      <?php } ?>
    </ul>
