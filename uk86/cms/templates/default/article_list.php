...
<div class="warp-all article-layout-a">
  <div class="mainbox">
    ...
    <ul class="article-list">
      ...
      <?php $article_url = uk86_getCMSArticleUrl($value['article_id']);?>
      <li>
        ...
        <div class="article-cover"><a href="<?php echo $article_url;?>" target="_blank"> <img class="image_lazy_load" data-src="<?php echo uk86_getCMSArticleImageUrl($value['article_attachment_path'], $value['article_image'], 'list');?>" src="<?php echo getLoadingImage();?>" alt="" /></a></div>
        <?php } ?>
