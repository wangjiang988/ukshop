      ...
      <tbody>
        ...
        <tr>
          ...
          <td><dl class="article-info">
              ...
              <dd class="thumb" title="<?php echo $lang['cms_cover'];?>"><a href="<?php echo $article_url;?>" target="_blank"> <img src="<?php echo uk86_getCMSArticleImageUrl($value['article_attachment_path'], $value['article_image']);?>" alt="" class="t-img"/></a></dd>
