...
<div class="warp-all picture-layout-a">
  ...
  <div class="picture-detail-header">
    ...
    <div class="action-bar"><span class="PV"><i></i><?php echo $lang['cms_text_view'];?>&nbsp;<em>(<b><?php echo $output['picture_detail']['picture_click'];?></b>)</em></span> <span id="btn_sns_share" data-title="<?php echo $output['picture_detail']['picture_title'];?>" data-image="<?php echo uk86_getCMSArticleImageUrl($output['picture_detail']['picture_attachment_path'], $output['picture_detail']['picture_image'], 'list');?>" data-publisher="<?php echo empty($output['picture_detail']['picture_author'])?$lang['cms_text_guest']:$output['picture_detail']['picture_author'];?>" data-origin="<?php echo empty($output['picture_detail']['picture_origin'])?C('site_name'):$output['picture_detail']['picture_origin'];?>" data-publish_time="<?php echo date('Y-m-d',$output['picture_detail']['picture_publish_time']);?>" data-abstract="<?php echo $output['picture_detail']['picture_abstract'];?>" class="share" title="<?php echo $lang['cms_text_share_count'];?>"><i></i><?php echo $lang['cms_text_share'];?>&nbsp;<em>(<b><?php echo $output['picture_detail']['picture_share_count'];?></b>)</em></span> <span class="all-picture"><a href="<?php echo getPictureImageUrl($output['picture_detail']['picture_id']);?>"><i></i><?php echo $lang['cms_text_all_image'];?></a></span> </div>
  </div>
  <div class="mainbox">
      ...
      <div class="picture-slide-bar">
        <div class="previous-album">
          <div class="cover thumb">
            ...
            <a href="<?php echo uk86_getCMSPictureUrl($output['pre_picture']['picture_id']);?>" class="size60" title="<?php echo $output['pre_picture']['picture_title'];?>"> <img src="<?php echo uk86_getCMSArticleImageUrl($output['pre_picture']['picture_attachment_path'], $output['pre_picture']['picture_image']);?>" class="t-img" /> </a>
            <?php } else { ?>
        ...
        <div class="picture-nav">
          <ul id="picture_gallery" class="picture-gallery">
            ...
            <li data-image="<?php echo uk86_getCMSArticleImageUrl(empty($value['image_path'])?$output['picture_detail']['picture_attachment_path']:$value['image_path'], $value['image_name'], 'max');?>" data-abstract="<?php echo empty($value['image_abstract'])?$output['picture_detail']['picture_abstract']:$value['image_abstract'];?>">
              <div class="thumb"><img src="" data-src="<?php echo uk86_getCMSArticleImageUrl(empty($value['image_path'])?$output['picture_detail']['picture_attachment_path']:$value['image_path'], $value['image_name']);?>" <?php echo getMiddleImgStyleString($value['image_width'], $value['image_height'], 60 ,60);?> /></div>
        ...
        <div class="next-album">
          <div class="cover thumb">
            ...
            <a href="<?php echo uk86_getCMSPictureUrl($output['next_picture']['picture_id']);?>" class="size60" title="<?php echo $output['next_picture']['picture_title'];?>"> <img src="<?php echo uk86_getCMSArticleImageUrl($output['next_picture']['picture_attachment_path'], $output['next_picture']['picture_image']);?>" class="t-img" /> </a>
            <?php } else { ?>
            <span><?php echo $lang['cms_picture_null'];?></span>
            <?php } ?>
          </div>
