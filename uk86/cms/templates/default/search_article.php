...
<div class="warp-all article-layout-a">
  <div class="mainbox">
    ...
    <ul class="article-search-list">
      ...
      <li>
        <div class="article-cover thumb"><a href="<?php echo $article_url;?>" target="_blank" class="size60"> <img src="<?php echo uk86_getCMSArticleImageUrl($value['article_attachment_path'], $value['article_image'], 'list');?>" alt="" class="t-img"/></a></div>
