  ...
  <div class="cms-member-main">
    ...
    <table class="cms-member-table">
      ...
      <tbody>
        ...
        <?php $picture_url = uk86_getCMSPictureUrl($value['picture_id']);?>
        <tr>
          ...
          <td><dl class="picture-info">
              ...
              <dd class="cover thumb" title="<?php echo $lang['cms_cover'];?>"><a><img src="<?php echo uk86_getCMSArticleImageUrl($value['picture_attachment_path'], $value['picture_image']);?>" alt="<?php echo $value['picture_title'];?>" class="t-img"/></a></dd>
              ...
              <ul>
                  ...
                  <li class="thumb"><a href="Javascript: void(0)"><img src="<?php echo uk86_getCMSArticleImageUrl($value['picture_attachment_path'], $image_value);?>" alt="<?php echo $value['picture_title'];?>" class="t-img"/></a></li>
                  <?php $image_count++;?>
