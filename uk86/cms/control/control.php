...
class CMSControl{
    ...
    protected function check_login() {
        if(!isset($_SESSION['is_login'])) {
            $ref_url = CMS_SITE_URL.uk86_request_uri();
    ...
    protected function get_article_state_list() {
        $array = array();
        $array[self::ARTICLE_STATE_DRAFT] = Uk86Language::uk86_get('cms_text_draft');
        $array[self::ARTICLE_STATE_VERIFY] = Uk86Language::uk86_get('cms_text_verify');
        $array[self::ARTICLE_STATE_PUBLISHED] = Uk86Language::uk86_get('cms_text_published');
        $array[self::ARTICLE_STATE_RECYCLE] = Uk86Language::uk86_get('cms_text_recycle');
        return $array;
    }
    ...
    protected function share_app_publish($publish_info=array()) {
        $param = array();
        $param['comment'] = "'".$_SESSION['member_name']."'".Uk86Language::uk86_get('cms_text_zai').C('cms_seo_title').Uk86Language::uk86_get('share_article');
        $param['title'] = "'".$_SESSION['member_name']."'".Uk86Language::uk86_get('cms_text_zai').C('cms_seo_title').Uk86Language::uk86_get('share_article');
    ...
    protected function get_share_app_content($info) {
        $content_str = "
            ...
            <dd>{$info['comment']}<a target=\"_blank\" href=\"{$info['url']}\">".Uk86Language::uk86_get('nc_common_goto')."</a></dd>
            </dl>
            </div>
            </div>
            ";
...
class CMSHomeControl extends CMSControl{
	...
	public function __construct() {
        ...
        $article_class_list = uk86_array_under_reset($article_class_list, 'class_id');
        ...
        $picture_class_list = uk86_array_under_reset($picture_class_list, 'class_id');
