...
class articleControl extends CMSHomeControl{
    ...
    public function article_detailOp() {
        ...
        if(empty($article_detail)) {
            uk86_showMessage(Uk86Language::uk86_get('article_not_exist'), CMS_SITE_URL, '', 'error');
        }
        ...
        $article_attitude_list[1] = Uk86Language::uk86_get('attitude1');
        $article_attitude_list[2] = Uk86Language::uk86_get('attitude2');
        $article_attitude_list[3] = Uk86Language::uk86_get('attitude3');
        $article_attitude_list[4] = Uk86Language::uk86_get('attitude4');
        $article_attitude_list[5] = Uk86Language::uk86_get('attitude5');
        $article_attitude_list[6] = Uk86Language::uk86_get('attitude6');
