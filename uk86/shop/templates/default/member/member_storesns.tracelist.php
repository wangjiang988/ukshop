...
<div id="lazymodule">
  ...
  <ul class="fd-list">
    ...
    <div class="fd-aside"> <span class="thumb size60"><i></i> <a href="index.php?act=store_snshome&sid=<?php echo $val['strace_storeid'];?>" target="_blank"> <img onload="javascript:DrawImage(this,60,60);" src="<?php echo uk86_getStoreLogo($val['strace_storelogo']);?>"> </a> </span> </div>
      <dl class="fd-wrap">
        <dt>
