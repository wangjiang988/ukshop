  ...
  <table class="ncm-default-table shoplist">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td class="w50"><div class="pic-uk86_thumb"><a href="index.php?act=goods&goods_id=<?php echo $favorites['goods']['goods_id'];?>" target="_blank"><img src="<?php echo uk86_thumb($favorites['goods'], 60);?>" onMouseOver="toolTip('<img src=<?php echo uk86_thumb($favorites['goods'], 240);?>>')" onMouseOut="toolTip()" /></a></div></td>
        ...
        <td><p> <a href="<?php echo uk86_urlShop('show_store','index',array('store_id'=> $favorites['goods']['store_id']), $favorites['goods']['store_domain']);?>" ><?php echo $favorites['goods']['store_name'];?></a>
