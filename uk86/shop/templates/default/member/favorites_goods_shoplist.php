...
<style type="text/css">
a.btn-red:hover{color:#dc3600; width:40px; height:40px; border:1px solid #d93600;}
</style>
<div class="wrap">
  <div class="tabmenu">
  ...
  <table class="ncm-default-table">
    ...
    <tbody>
      ...
      <tr>
        <th colspan="20"><span class="ml5"><?php echo $lang['favorite_store_name'].$lang['nc_colon'];?><a href="<?php echo uk86_urlShop('show_store','index',array('store_id'=> $goods_list[0]['goods']['store_id']), $favorites['goods']['store_domain']);?>" ><?php echo $goods_list[0]['goods']['store_name'];?></a>
      ...
      <tr class="bd-line">
        ...
        <td class="w50"><div class="pic-thumb"><a href="index.php?act=goods&goods_id=<?php echo $favorites['goods']['goods_id'];?>" target="_blank"><img src="<?php echo uk86_thumb($favorites['goods'], 60);?>" onMouseOver="toolTip('<img src=<?php echo uk86_thumb($favorites['goods'], 240);?>>')" onMouseOut="toolTip()" /></a></div></td>
        ...
        <td>&nbsp;</td>
        <td><span class="goods-price"><?php echo uk86_ncPriceFormat($favorites['goods']['goods_price']);?></span></td>
      ...
      <?php }else{?>
      <tr>
        <td colspan="20" class="norecord"><div class="warning-option"><i>&nbsp;</i><span>还未收藏过商品哦，先去逛逛吧！</span></div></td>
      </tr>
      <?php }?>
    </tbody>
    <tfoot>
