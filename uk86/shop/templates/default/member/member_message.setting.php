...
<div class="wrap">
  ...
  <div class="ncm-message-setting">
    <form method="post" action="<?php echo uk86_urlShop('member_message', 'setting');?>" id="setting_form" onsubmit="ajaxpost('setting_form', '', '', 'onerror');">
        ...
        <dd>
          <ul>
            ...
            <li>
              ...
              <label for="voucher_use">卡券包使用提醒</label></li>
            <li>
              ...
              <label for="voucher_will_expire">卡券包即将到期提醒</label></li>
          </ul>
        </dd>
      </dl>
      <dl>
