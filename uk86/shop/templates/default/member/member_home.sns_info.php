    ...
    <?php if(!empty($output['circle_list'])){?>
      <div class="ncm-circle">
            <ul id="circleList" class="jcarousel-skin-tango">
              ...
              <li>
                <div class="ncm-circle-pic"><a href="<?php echo CIRCLE_SITE_URL;?>/index.php?act=group&c_id=<?php echo $val['circle_id'];?>" target="_blank"><img alt="" src="<?php echo uk86_circleLogo($val['circle_id']);?>"></a></div>
                <dl>
