...
<div class="ncm-flow-layout">
  ...
  <div class="ncm-flow-item">
    ...
    <div class="item-goods">
      ...
      <dl>
        <dt>
          <div class="ncm-goods-thumb-mini"><a href="index.php?act=goods&goods_id=<?php echo $val['goods_id']; ?>" target="_blank"><img src="<?php echo uk86_thumb($val,'60'); ?>" onMouseOver="toolTip('<img src=<?php echo uk86_thumb($val,'240'); ?>>')" onMouseOut="toolTip()"/></a></div>
        </dt>
        ...
        <font color="#AAA">（<?php echo uk86_orderGoodsType($val['goods_type']);?>）</font>
        <?php } ?>
        </span></dd>
      </dl>
      <?php } } ?>
...
$(function(){
	...
	$.getJSON('index.php?act=member_order&op=get_express&e_code=<?php echo $output['e_code']?>&shipping_code=<?php echo $output['order_info']['shipping_code']?>&t=<?php echo uk86_random(7);?>',function(data){
		if(data){
