  ...
  <table class="ncm-default-table order">
    ...
    <tbody>
      ...
      <tr>
        ...
        &nbsp;<?php if ($order_info['order_from'] == 2){?><i class="icon-mobile-phone"></i><?php }?></span><span>下单时间：<?php echo date("Y-m-d H:i",$order_info['add_time']);?></span><span><a href="<?php echo uk86_urlShop('show_store','index',array('store_id'=>$order_info['store_id']));?>" title="<?php echo $order_info['store_name'];?>"><?php echo $order_info['store_name'];?></a></span>
      ...
      <tr>
        <td class="bdl"></td>
        <td class="w70"><div class="ncm-goods-uk86_thumb"><a href="<?php echo uk86_urlShop('goods','index',array('goods_id'=>$order_info['goods_id']));?>" target="_blank" onMouseOver="toolTip('<img src=<?php echo uk86_thumb($order_info, 240);?>>')" onMouseOut="toolTip()"/><img src="<?php echo uk86_thumb($order_info, 60);?>"/></a></div></td>
        <td class="tl"><dl class="goods-name">
            <dt><a href="<?php echo uk86_urlShop('goods','index',array('goods_id'=>$order_info['goods_id']));?>" target="_blank" title="<?php echo $order_info['goods_name'];?>"><?php echo $order_info['goods_name'];?></a></dt>
            <dd>
        ...
        <td class="bdl bdr">
          ...
          <p><a class="ncm-btn ncm-btn-acidblue" href="index.php?act=member_evaluate&op=add_vr&order_id=<?php echo $order_info['order_id']; ?>"><i class="icon-uk86_thumbs-up-alt"></i><?php echo $lang['member_order_want_evaluate'];?></a></p>
          <?php } ?>
