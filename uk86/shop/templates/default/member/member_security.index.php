...
<div class="wrap">
  ...
  <div class="ncm-security-user">
    <h3>您的账户信息</h3>
    <div class="user-avatar"><span><img src="<?php echo uk86_getMemberAvatar($output['member_info']['member_avatar']);?>"></span></div>
    <div class="user-intro">
      ...
      <dl>
        <dt>绑定邮箱：</dt>
        <dd><?php echo uk86_encryptShow($output['member_info']['member_email'],4,4);?></dd>
      </dl>
      <dl>
        <dt>手机号码：</dt>
        <dd><?php echo uk86_encryptShow($output['member_info']['member_mobile'],4,4);?></dd>
      </dl>
      <dl>
        <dt>上次登录：</dt>
  ...
  <div class="ncm-security-container">
    ...
    <dl id="email" class="<?php echo $output['member_info']['member_email_bind'] == 1 ? 'yes' : 'no';?>">
      <dt><span class="icon"><i></i></span><span class="item">
        <h4>邮箱验证</h4>
        <h6><?php echo $output['member_info']['member_email_bind'] == 1 ? '已验证' : '未验证';?></h6>
        </span></dt>
      <dd><span class="explain">进行邮箱验证后，可用于接收敏感操作的身份验证信息，以及订阅更优惠商品的促销邮件。</span><span class="handle"><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=member_security&op=auth&type=modify_email" class="ncm-btn ncm-btn-acidblue bd">验证邮箱</a><a href="index.php?act=member_security&op=auth&type=modify_email" class="ncm-btn ncm-btn-orange jc">修改邮箱</a></span></dd>
    </dl>
    <dl id="mobile" class="<?php echo $output['member_info']['member_mobile_bind'] == 1 ? 'yes' : 'no';?>">
      ...
      <dd><span class="explain">进行手机验证后，可用于接收敏感操作的身份验证信息，以及进行U币消费的验证确认，非常有助于保护您的账号和账户财产安全。</span><span class="handle"><a href="index.php?act=member_security&op=auth&type=modify_mobile" class="ncm-btn ncm-btn-acidblue bd">绑定手机</a><a href="index.php?act=member_security&op=auth&type=modify_mobile" class="ncm-btn ncm-btn-orange jc">修改手机</a></span></dd>
    </dl>
