<?php defined('InUk86') or exit('Access Invalid!');?>
  ...
  <div class="ncm-flow-item">
    ...
    <div class="item-goods">
      ...
      <dl>
        <dt>
          <div class="ncm-goods-uk86_thumb-mini"><a target="_blank" href="<?php echo uk86_urlShop('goods','index',array('goods_id'=> $output['order']['goods_id'])); ?>">
            <img src="<?php echo uk86_thumb($output['order'],60); ?>" onMouseOver="toolTip('<img src=<?php echo uk86_thumb($output['order'],240); ?>>')" onMouseOut="toolTip()" /></a></div>
        </dt>
        <dd><a target="_blank" href="<?php echo uk86_urlShop('goods','index',array('goods_id'=> $output['order']['goods_id'])); ?>"><?php echo $output['order']['goods_name']; ?></a>
