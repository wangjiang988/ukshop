      ...
      <ul class="ncm-browse-list">
        ...
        <li id="browserow_<?php echo $v['goods_id']; ?>">
          ...
          <div class="browse-goods">
            <div class="goods-thumb"><a href="<?php echo uk86_urlShop('goods', 'index', array('goods_id'=>$v['goods_id'])); ?>" target="_blank"><img src="<?php echo uk86_cthumb($v['goods_image'], 60);?>" /></a> </div>
            <dl class="goods-info">
