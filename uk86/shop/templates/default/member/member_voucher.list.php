    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td class="tl"><dl class="goods-name">
            ...
            <dd><a href="<?php echo uk86_urlShop('show_store', 'index', array('store_id'=>$val['store_id']));?>" title="<?php echo $lang['voucher_voucher_storename'];?>"><?php echo $val['store_name'];?></a>（<?php echo $lang['voucher_voucher_usecondition'];?>：<?php echo $lang['voucher_voucher_usecondition_desc'].$val['voucher_limit'].$lang['currency_zh'];?>）</dd>
          </dl></td>
        ...
        <td class="ncm-table-handle"><?php if ($val['voucher_state'] == '1'){?>
          <span><a href="<?php echo uk86_urlShop('show_store', 'index', array('store_id'=>$val['store_id']));?>" class="btn-green" ><i class="icon-shopping-cart"></i><p>使用</p></a></span>
