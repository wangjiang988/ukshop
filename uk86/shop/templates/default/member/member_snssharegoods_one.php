...
<div class="dialog-share">
  <form method="post" action="index.php?act=member_snsindex&op=sharegoods" id="sharegoods_form">
    ...
    <div class="share-content">
      ...
      <div class="avatar"><img src="<?php echo uk86_getMemberAvatar($output['member_info']['member_avatar']);?>"><i></i></div>
      ...
      <div class="share-goods">
        <div class="goods-thumb"><a target="_blank" href="<?php echo uk86_urlShop('goods','index',array('goods_id'=>$output['goods_info']['goods_id']));?>"> <img title="<?php echo $output['goods_info']['goods_name']; ?>" src="<?php echo uk86_thumb($output['goods_info'],240);?>" /></a></div>
        <dl class="goods-intro">
          <dt><a target="_blank" href="<?php echo uk86_urlShop('goods','index',array('goods_id'=>$output['goods_info']['goods_id']));?>"><?php echo $output['goods_info']['goods_name']; ?></a></dt>
