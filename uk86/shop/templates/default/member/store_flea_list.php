...
<div class="wrap">
  <div class="tabmenu">
    <?php include uk86_template('layout/submenu');?>    <a href="javascript:void(0)"  class="ncm-btn ncm-btn-orange" onclick="go('index.php?act=member_flea&op=add_goods');" title="<?php echo $lang['store_goods_index_new_goods'];?>"><?php echo $lang['store_goods_index_new_flea'];?></a>
  </div>
