              ...
              <div>
                ...
                <div class="list" nctype="slider_div">
                  <ul class="F-center">
                    ...
                    <li><span class="thumb size40"><i></i><a href="javascript:void(0);"><img title="<?php echo $v['member_name'];?>" src="<?php echo uk86_getMemberAvatar($v['member_avatar']);?>"  onload="javascript:DrawImage(this,40,40);"/></a></span></li>
                    <?php }?>
                  </ul>
                </div>
