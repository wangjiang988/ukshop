      ...
      <tr>
        <td colspan="2" class="pic-model"><ul>
            ...
            <li class="favorite-pic-list">
              <div class="favorite-goods-uk86_thumb"><a href="index.php?act=goods&goods_id=<?php echo $favorites['goods']['goods_id'];?>" target="_blank"><img src="<?php echo uk86_thumb($favorites['goods'], 240);?>" /></a></div>
