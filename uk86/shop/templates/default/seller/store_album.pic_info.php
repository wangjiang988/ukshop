  ...
  <div id="gallery" class="ad-gallery">
    <div class="ad-nav">
      <div class="ad-thumbs">
        <ul class="ad-thumb-list">
          ...
          <li><a href="<?php echo uk86_thumb($v, 1280);?>" value="<?php echo $v['apic_id'] ?>"> <img title="<?php echo $v['apic_name']?>" src="<?php echo uk86_thumb($v, 60);?>" class="image0"/>
    ...
    <div class="ad-image-date">
      ...
      <dd>
        ...
        <p><b><?php echo $lang['album_pinfo_class_name'].$lang['nc_colon'];?></b><?php echo uk86_str_cut($output['class_info']['aclass_name'],20);?></p>
