  ...
  <div class="ncsc-order-info">
    <div class="ncsc-order-details">
      ...
      <div class="content">
        <dl>
          ...
          <dd><?php echo $output['order_info']['extend_order_common']['reciver_name'];?>&nbsp; <?php echo @$output['order_info']['extend_order_common']['reciver_info']['phone'];?>&nbsp; <?php if($output['order_info']['store_mentioning'] != 1 ){ ?> <?php echo @$output['order_info']['extend_order_common']['reciver_info']['address'];?><?php echo $output['order_info']['extend_order_common']['reciver_info']['dlyp'] ? '[自提服务站]' : '';?><?php } ?></dd>
        </dl>
        <dl>
          <dt>发&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;票：</dt>
          <dd>
    ...
    <div class="ncsc-order-condition">
      ...
      <ul>
        ...
        <?php } else { ?>
        <li>1. 买家已使用“<?php echo uk86_orderPaymentName($output['order_info']['payment_code']);?>”方式成功对订单进行支付，支付单号 “<?php echo $output['order_info']['pay_sn'];?>”。</li>
        <li>2. 订单已提交商家进行备货发货准备。</li>
        <?php } ?>
      </ul>
    </div>
    ...
    <table class="ncsc-default-table order">
      ...
      <tbody>
        ...
        <tr class="bd-line">
          ...
          <?php echo $goods['goods_pay_price']; ?> * <?php echo $goods['commis_rate']; ?>% = <b><?php echo uk86_ncPriceFormat($goods['goods_pay_price']*$goods['commis_rate']/100); ?></b>
          <?php } ?>
          </td>
      ...
      <tfoot>
        ...
        <tr>
          <td colspan="20"><dl class="ncsc-store-sales">
              ...
              <dd>使用了面额为 <?php echo $output['order_info']['extend_order_common']['voucher_price'];?> 元的卡券包，编码：<?php echo $output['order_info']['extend_order_common']['voucher_code'];?></span></dd>
              <?php } ?>
            </dl></td>
        </tr>
        <?php } ?>
...
$(function(){
    $('#show_shipping').on('hover',function(){
    	...
    	$.getJSON('index.php?act=store_deliver&op=get_express&e_code=<?php echo $output['order_info']['express_info']['e_code']?>&shipping_code=<?php echo $output['order_info']['shipping_code']?>&t=<?php echo uk86_random(7);?>',function(data){
    		if(data){
    			data = var_send+data;
