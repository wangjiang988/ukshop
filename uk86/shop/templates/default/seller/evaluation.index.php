...
<div class="tabmenu">
    <ul id="listpj" class="tab">
        <li class="active"><a href="<?php echo uk86_urlShop('store_evaluate', 'list');?>"><?php echo $lang['member_evaluation_frombuyer'];?></a></li>
    </ul>
</div>
<form method="get">
...
<table class="ncsc-default-table">
    ...
    <tbody>
        ...
        <tr>
            <th></th>
            <th>
                <span class="goods-name"><a target="_blank" href="<?php echo uk86_urlShop('goods', 'index', array('goods_id' => $v['geval_goodsid']));?>"><?php echo $v['geval_goodsname']?></a></span>
...
$(document).ready(function(){
    ...
    $('#btn_explain_submit').on('click', function() {
        if($('#explain_form').valid()){
            ...
            $.post("<?php echo uk86_urlShop('store_evaluate', 'explain_save');?>",{
                geval_id: geval_id,
