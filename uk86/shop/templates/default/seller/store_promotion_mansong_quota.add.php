...
<div class="ncsc-form-default">
  <form id="add_form" action="<?php echo uk86_urlShop($_GET['act'], 'quota_create_order',array('type'=>'3'));?>" method="post">
    ...
    <dl>
      ...
      <dd>
          <input id="quota_quantity" name="quota_quantity" type="text" class="text w50"/><em class="add-on"><?php echo $lang['text_month'];?></em>
          <span></span>
