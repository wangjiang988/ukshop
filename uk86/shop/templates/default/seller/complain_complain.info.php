...
<table class="order ncsc-table-style">
  ...
  <tbody>
    ...
    <tr>
      <td class="bdl"></td>
      <td><div class="goods-pic-small"><span class="thumb size60"><i></i><a href="<?php echo uk86_urlShop('goods', 'index', array('goods_id'=>$complain_goods['goods_id']));?>" target="_blank"> <img onload="javascript:DrawImage(this,60,60);" src="<?php echo uk86_cthumb($complain_goods['goods_image'], 60,$output['order_info']['store_id']);?>"/> </a></span></div></td>
      <td>
        <a href="<?php echo uk86_urlShop('goods', 'index', array('goods_id'=>$complain_goods['goods_id']));?>" target="_blank"> <?php echo $complain_goods['goods_name'];?> </a>
        </td>
