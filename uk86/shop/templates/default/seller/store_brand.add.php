<div class="eject_con">
  ...
  <form method="post" target="_parent" action="index.php?act=store_brand&op=<?php if ($output['brand_array']['brand_id']!='') echo 'brand_edit'; else echo 'brand_save'; ?>"enctype="multipart/form-data" id="brand_apply_form">
    ...
    <dl>
      ...
      <dd>
        <div class=""><span class="sign"><img src="<?php echo uk86_brandImage($output['brand_array']['brand_pic']);?>" onload="javascript:DrawImage(this,150,50)" nc_type="logo1"/></span></div>
    ...
    <dl>
      ...
      <dd>
        <input type="text" disabled="disabled" class="text" name="brand_price" value="<?php echo C('default_brand_price');?>" id="brand_initial" />
        <p class="hint">如需改价格，请联系平台管理员</p>
        <?php if ($output['brand_array']['brand_id'] ==''){ ?><p style="color:black;font-size: 12px;">提交之后将暂时不能修改，请确定!!!</p>
        <?php } ?>	
      </dd>
    </dl>
    <div class="bottom">
