...
<div class="ncsc-form-default">
  <form id="add_form" action="index.php?act=store_groupbuy&op=groupbuy_edit_save" method="post" enctype="multipart/form-data">
    <input id="groupbuy_id" name="groupbuy_id" type="hidden" value="<?php echo $output['groupbuy_info']['groupbuy_id'];?>"/>
    <dl>
      <dt><i class="required">*</i><?php echo $lang['group_name'].$lang['nc_colon'];?></dt>
      <dd>
        <input class="w400 text" name="groupbuy_name" type="text" id="groupbuy_name" value="<?php echo $output['groupbuy_info']['groupbuy_name'];?>" maxlength="30"  />
        <span></span>
    ...
    <dl>
      ...
      <dd>
        <input class="w400 text" name="remark" type="text" id="remark" value="<?php echo $output['groupbuy_info']['remark'];?>" maxlength="30"  />
        <span></span>
    ...
    <dl>
      ...
      <dd>
          <input id="start_time" name="start_time" type="text" value="<?php echo $output['groupbuy_info']['start_time_text']?$output['groupbuy_info']['start_time_text']:'';?>" class="text w130" /><em class="add-on"><i class="icon-calendar"></i></em><span></span>
    ...
    <dl>
      ...
      <dd>
          <input id="end_time" name="end_time" type="text" class="text w130" value="<?php echo $output['groupbuy_info']['end_time_text']?$output['groupbuy_info']['end_time_text']:'';?>" /><em class="add-on"><i class="icon-calendar"></i></em><span></span>
          <p class="hint">
...
<?php } ?>
    ...
    <dl>
      ...
      <input id="groupbuy_goods_id" name="groupbuy_goods_id" type="hidden" value="<?php echo $output['groupbuy_info']['goods_id'];?>"/>
      <span></span>
      <div id="div_search_goods" class="div-goods-select mt10" style="display: none;">
          <table class="search-form">
              <tr>
                  ...
                  <td class="w160">
                      <input id="search_goods_name" type="text w150" class="text" name="goods_name" value="<?php echo $output['groupbuy_info']['goods_name'];?>"/>
                  </td>
                  <td class="w70 tc">
    ...
    <dl nctype="groupbuy_goods_info" style="display:none;">
      ...
      <dd> <?php echo $lang['currency'];?><span nctype="groupbuy_goods_price"></span><input id="input_groupbuy_goods_price" type="hidden" value="<?php echo $output['groupbuy_info']['goods_price'];?>"></dd>
    </dl>
    <dl>
      <dt><i class="required">*</i><?php echo $lang['groupbuy_price'].$lang['nc_colon'];?></dt>
      <dd>
        <input class="w70 text" id="groupbuy_price" name="groupbuy_price" type="text" value="<?php echo $output['groupbuy_info']['groupbuy_price']?$output['groupbuy_info']['groupbuy_price']:'';?>"/><em class="add-on"><i class="icon-renminbi"></i></em> <span></span>
    ...
    <dl>
      ...
      <dd>
        <select id="class_id" name="class_id" class="w80">
          <option value="<?php echo $output['groupbuy_info']['class_id']?$output['groupbuy_info']['class_id']:0;?>"><?php echo $lang['text_no_limit']; ?></option>
        </select>
        <select id="s_class_id" name="s_class_id" class="w80">
          <option value="<?php echo $output['groupbuy_info']['s_class_id']?$output['groupbuy_info']['s_class_id']:0;?>"><?php echo $lang['text_no_limit']; ?></option>
        </select>
        <span></span>
    ...
    <dl>
      ...
      <dd>
        <input class="w70 text" id="virtual_quantity" name="virtual_quantity" type="text" value="<?php echo $output['groupbuy_info']['virtual_quantity']?$output['groupbuy_info']['virtual_quantity']:0;?>"/>
        <span></span>
    ...
    <dl>
      ...
      <dd>
        <input class="w70 text" id="upper_limit" name="upper_limit" type="text" value="<?php echo $output['groupbuy_info']['upper_limit']?$output['groupbuy_info']['upper_limit']:0;?>"/>
        <span></span>
    ...
    <dl>
      ...
      <dd>
        <?php uk86_showEditor('groupbuy_intro','','740px','360px','','false',false);?>
...
$(document).ready(function(){
    ...
    $('#btn_search_goods').on('click', function() {
        var url = "<?php echo uk86_urlShop('store_groupbuy', 'search_goods');?>";
    ...
    $('#div_goods_search_result').on('click', '[nctype="btn_add_groupbuy_goods"]', function() {
        ...
        $.get('<?php echo uk86_urlShop('store_groupbuy', 'groupbuy_goods_info');?>', {goods_commonid: goods_commonid}, function(data) {
            if(data.result) {
    ...
    $('[nctype="btn_upload_image"]').fileupload({
        dataType: 'json',
            url: "<?php echo uk86_urlShop('store_groupbuy', 'image_upload');?>",
            add: function(e, data) {
    ...
    jQuery.validator.methods.checkGroupbuyGoods = function(value, element) {
        ...
        $.ajax({
            type:"GET",
            url:'<?php echo uk86_urlShop('store_groupbuy', 'check_groupbuy_goods');?>',
            async:false,
