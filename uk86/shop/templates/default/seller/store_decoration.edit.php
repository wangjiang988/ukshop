...
<div class="ncsc-decoration-layout">
  <div class="ncsc-decoration-menu" id="waypoints">
    ...
    <ul class="menu">
      ...
      <li><a id="btn_preview" href="<?php echo uk86_urlShop('store_decoration', 'decoration_preview', array('decoration_id' => $_GET['decoration_id']));?>" target="_blank"><i class="preview"></i>设计预览</a></li>
...
<script type="text/javascript"> 
    ...
    var URL_DECORATION_ALBUM_UPLOAD = '<?php echo uk86_urlShop('store_decoration', 'decoration_album_upload');?>';
    var URL_DECORATION_BACKGROUND_SETTING_SAVE = '<?php echo uk86_urlShop('store_decoration', 'decoration_background_setting_save');?>';
    var URL_DECORATION_NAV_SAVE = '<?php echo uk86_urlShop('store_decoration', 'decoration_nav_save');?>';
    var URL_DECORATION_BANNER_SAVE = '<?php echo uk86_urlShop('store_decoration', 'decoration_banner_save');?>';
    var URL_DECORATION_BLOCK_ADD = '<?php echo uk86_urlShop('store_decoration', 'decoration_block_add');?>';
    var URL_DECORATION_BLOCK_DEL = '<?php echo uk86_urlShop('store_decoration', 'decoration_block_del');?>';
    var URL_DECORATION_BLOCK_SAVE = '<?php echo uk86_urlShop('store_decoration', 'decoration_block_save');?>';
    var URL_DECORATION_BLOCK_SORT = '<?php echo uk86_urlShop('store_decoration', 'decoration_block_sort');?>';
    var URL_DECORATION_GOODS_SEARCH = '<?php echo uk86_urlShop('store_decoration', 'goods_search');?>';
