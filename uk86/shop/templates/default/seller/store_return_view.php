...
<div class="ncsc-flow-layout">
  ...
  <?php require uk86_template('seller/store_refund_right');?>
</div>
...
$(function(){
	$.getJSON('index.php?act=store_deliver&op=get_express&e_code=<?php echo $output['e_code'];?>&shipping_code=<?php echo $output['return']['invoice_no'];?>&t=<?php echo uk86_random(7);?>',function(data){
		if(data){
