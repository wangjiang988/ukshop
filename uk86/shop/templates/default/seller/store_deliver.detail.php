...
<div class="ncsc-flow-layout">
  ...
  <div class="ncsc-flow-item">
    ...
    <div class="item-goods">
      ...
      <dl>
        <dt>
          <div class="ncsc-goods-thumb-mini"><a target="_blank" href="<?php echo uk86_urlShop('goods','index',array('goods_id'=>$goods['goods_id']));?>"><img src="<?php echo uk86_thumb($goods, 60); ?>" onMouseOver="toolTip('<img src=<?php echo uk86_thumb($goods,'240'); ?>>')" onMouseOut="toolTip()"/></a></div>
        </dt>
        <dd><a target="_blank" href="<?php echo uk86_urlShop('goods','index',array('goods_id'=>$goods['goods_id']));?>"><?php echo $goods['goods_name']; ?></a><span class="rmb-price"><i class="mr5"><?php echo $goods['goods_price']; ?></i>&nbsp;*&nbsp;<?php echo $goods['goods_num']; ?></span></dd>
        </dt>
      </dl>
      <?php } } ?>
    </div>
...
$(function(){
	...
	$.getJSON('index.php?act=store_deliver&op=get_express&e_code=<?php echo $output['e_code']?>&shipping_code=<?php echo $output['order_info']['shipping_code']?>&t=<?php echo uk86_random(7);?>',function(data){
		if(data){
			data = var_send+data;
