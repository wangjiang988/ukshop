<div class="groupbuy-gallery"> <a class='sample_demo' id="select_s" href="index.php?act=store_album&op=pic_list&item=groupbuy" style="display:none;"><?php echo $lang['store_goods_batch_edit_submit'];?></a>
  ...
  <ul class="list">
    ...
    <li onclick="insert_editor('<?php echo uk86_cthumb($v['apic_cover'], 1280,$_SESSION['store_id']);?>');"><a href="JavaScript:void(0);"><span class="thumb size90"><i></i><img src="<?php echo uk86_cthumb($v['apic_cover'], 60,$_SESSION['store_id']);?>" onload="javascript:DrawImage(this,90,90);" title='<?php echo $v['apic_name']?>'/></span></a></li>
    <?php }?>
    <?php }else{?>
