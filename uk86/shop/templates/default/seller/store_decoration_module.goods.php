...
<ul class="goods-list">
  ...
  <li nctype="goods_item" data-goods-id="<?php echo $val['goods_id'];?>" data-goods-name="<?php echo $val['goods_name'];?>" data-goods-price="<?php echo $val['goods_price'];?>"  data-goods-image="<?php echo $val['goods_image'];?>">
    <?php $goods_url = uk86_urlShop('goods', 'index', array('goods_id' => $val['goods_id']));?>
    <div class="goods-thumb"> <a href="<?php echo $goods_url;?>" target="_blank" title="<?php echo $val['goods_name'];?>"> <img src="<?php echo uk86_cthumb($val['goods_image'], 240);?>"/ alt="<?php echo $val['goods_name'];?>"> </a> </div>
    <dl class="goods-info">
