    ...
    <tr class="bd-line"><td></td>
      ...
      <td><ul class="ncsc-mansong-rule-list">
          ...
          <li>
              ...
              <?php } else { ?>
              		<?php echo $lang['gift_name'];?><a href="<?php echo $val['goods_url'];?>" title="<?php echo $val['mansong_goods_name'];?>" target="_blank" class="goods-thumb"> <img src="<?php echo uk86_cthumb($val['goods_image']);?>"/> </a>
              <?php } ?>
          </li>
          <?php }?>
          <?php }?>
