...
<div id="pictureFolder" class="ncsc-picture-folder">
  <dl class="ncsc-album-intro">
    ...
    <dd class="album-covers">
      ...
      <img id="aclass_cover" src="<?php echo uk86_cthumb($output['class_info']['aclass_cover'], 60,$_SESSION['store_id']);?>">
      <?php }else{?>
