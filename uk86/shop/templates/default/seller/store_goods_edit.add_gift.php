...
<form method="post" id="goods_gift" action="<?php echo uk86_urlShop('store_goods_online', 'save_gift');?>">
  ...
  <div class="ncsc-form-goods-gift" data-gid="<?php echo $value['goods_id'];?>">
    <div class="goods-pic"> <span><img src="<?php echo uk86_thumb($value, 240);?>"/></span></div>
      ...
      <dl>
        ...
        <dd>
          <ul class="goods-gift-list" nctype="choose_goods_list">
            ...
            <li>
              <div class="pic-thumb"><span><img src="<?php echo uk86_cthumb($gift['gift_goodsimage'], '60', $_SESSION['store_id']);?>"></span></div>
              <dl class="goods_name">
