          ...
          <table class="ncsc-default-table mb15">
            ...
            <tbody nctype="bundling_data"  class="bd-line tip" title="<?php echo $lang['bundling_add_goods_explain'];?>">
              ...
              <tr id="bundling_tr_<?php echo $val['goods_id']?>" class="off-shelf">
                ...
                <td class="w50"><div class="shelf-state"><div class="pic-thumb"><img src="<?php echo uk86_cthumb($output['goods_list'][$val['goods_id']]['goods_image'], 60, $_SESSION['store_id']);?>" ncname="<?php echo $output['goods_list'][$val['goods_id']]['goods_image'];?>" nctype="bundling_data_img">
                    </div></div>
                </td>
...
var DEFAULT_GOODS_IMAGE = '<?php echo uk86_defaultGoodsImage(60);?>';
$(function(){
