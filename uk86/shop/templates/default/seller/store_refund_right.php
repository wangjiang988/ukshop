...
<div class="ncsc-flow-item">
  ...
  <div class="item-goods">
      ...
      <dl>
        <dt>
          <div class="ncsc-goods-thumb-mini"><a target="_blank" href="<?php echo uk86_urlShop('goods','index',array('goods_id'=> $val['goods_id'])); ?>">
            <img src="<?php echo uk86_thumb($val,60); ?>" onMouseOver="toolTip('<img src=<?php echo uk86_thumb($val,240); ?>>')" onMouseOut="toolTip()" /></a></div>
        </dt>
        <dd><a target="_blank" href="<?php echo uk86_urlShop('goods','index',array('goods_id'=> $val['goods_id'])); ?>"><?php echo $val['goods_name']; ?></a>
            <?php echo $lang['currency'];?><?php echo $val['goods_price']; ?> * <?php echo $val['goods_num']; ?> <font color="#AAA">(数量)</font>
            <span><?php echo uk86_orderGoodsType($val['goods_type']);?></span>
        </dd>
      </dl>
        <?php } ?>
        <?php } ?>
  ...
  <div class="item-order">
    ...
    <dl>
      <dt>订单总额：</dt>
      <dd><strong><?php echo $lang['currency'];?><?php echo uk86_ncPriceFormat($output['order']['order_amount']); ?>
