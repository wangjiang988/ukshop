...
<div class="ncsc-flow-item">
  ...
  <div class="item-goods">
    ...
    <dl>
      <dt>
        <div class="ncsc-goods-uk86_thumb-mini"><a href="<?php echo uk86_urlShop('goods','index',array('goods_id'=> $val['goods_id'])); ?>" target="_blank"> <img src="<?php echo uk86_thumb($val,60); ?>" onMouseOver="toolTip('<img src=<?php echo uk86_thumb($val,240); ?>>')" onMouseOut="toolTip()" /> </a></div>
      </dt>
      <dd><a href="<?php echo uk86_urlShop('goods','index',array('goods_id'=> $val['goods_id'])); ?>" target="_blank"> <?php echo $val['goods_name']; ?> </a> <?php echo $lang['currency'];?><?php echo $val['goods_price'];?>&nbsp;*&nbsp;<?php echo $val['goods_num'];?><font color="#AAA">(<?php echo $lang['complain_text_num'];?>)</font>
            <span><?php echo uk86_orderGoodsType($val['goods_type']);?></span></dd>
    </dl>
    <?php } ?>
    <?php } ?>
  </div>
  <div class="item-order">
    <dl>
      <dt>运&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;费：</dt>
      <dd><?php echo $output['order']['shipping_fee']>0 ? uk86_ncPriceFormat($output['order']['shipping_fee']):$lang['nc_common_shipping_free']; ?></dd>
    </dl>
    <dl>
