...
<form method="post" id="goods_combo" action="<?php echo uk86_urlShop('store_goods_online', 'save_combo');?>">
  ...
  <div class="ncsc-form-goods-combo" data-gid="<?php echo $value['goods_id'];?>">
    <div class="default-goods">
      <div class="goods-pic"><span><img src="<?php echo uk86_thumb($value, 240);?>"/></span><em>SKU：<?php echo $value['goods_id'];?></em></div>
    ...
    <div class="combo-goods" nctype="choose_goods_list">
      <ul>
        ...
        <li>
          ...
          <div class="pic-thumb"> <a target="_blank" href="<?php echo uk86_urlShop('goods', 'index', array('goods_id' => $combo['goods_id']));?>"> <img src="<?php echo uk86_cthumb($combo['goods_image'], '240', $_SESSION['store_id']);?>"> </a> </div>
          <dl>
            <dt><a target="_blank" href="<?php echo uk86_urlShop('goods', 'index', array('goods_id' => $combo['goods_id']));?>"><?php echo $combo['goods_name'];?></a></dt>
...
$(function(){
    ...
    $('a[nctype="search_combo"]').click(function(){
        _url = "<?php echo uk86_urlShop('store_goods_online', 'search_goods');?>";
