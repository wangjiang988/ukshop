...
<?php }?>
<form method="post" id="goods_image" action="<?php if ($output['edit_goods_sign']) { echo uk86_urlShop('store_goods_online', 'edit_save_image'); } else { echo uk86_urlShop('store_goods_add', 'save_image');}?>">
      ...
      <div class="ncsc-goodspic-list">
        ...
        <ul nctype="ul<?php echo $value['sp_value_id'];?>">
          ...
          <li class="ncsc-goodspic-upload">
            <div class="upload-thumb"><img src="<?php echo uk86_cthumb($output['img'][$value['sp_value_id']][$i]['goods_image'], 240);?>" nctype="file_<?php echo $value['sp_value_id'] . $i;?>">
...
var DEFAULT_GOODS_IMAGE = "<?php echo UPLOAD_SITE_URL.DS.uk86_defaultGoodsImage(240);?>";
