...
<div class="ncsc-form-default">
  <form method="post" action="<?php if (empty($output['plate_info'])) { echo uk86_urlShop('store_plate', 'plate_add');} else { echo uk86_urlShop('store_plate', 'plate_edit');}?>" id="plate_form">
    ...
    <input type="hidden" name="p_id" value="<?php echo $output['plate_info']['plate_id'];?>"/>
        ...
        <dl>
          ...
          <dd>
            <?php uk86_showEditor('p_content',$output['plate_info']['plate_content'],'100%','480px','visibility:hidden;',"false",$output['editor_multimedia']);?>
            <p class="hr8">
