...
<?php if ($output['isOwnShop']) { ?>
    <a class="ncsc-btn ncsc-btn-green" href="<?php echo uk86_urlShop('store_voucher', 'templateadd');?>"><i class="icon-plus-sign"></i><?php echo $lang['voucher_templateadd']; ?></a>

<?php } else { ?>
    <?php if(!empty($output['current_quota'])) { ?>
    <a class="ncsc-btn ncsc-btn-green" style="right:100px" href="<?php echo uk86_urlShop('store_voucher', 'templateadd');?>"><i class="icon-plus-sign"></i><?php echo $lang['voucher_templateadd']; ?></a>
    <a class="ncsc-btn ncsc-btn-acidblue" href="<?php echo uk86_urlShop('store_voucher', 'quotaadd');?>" title=""><i class="icon-money"></i>套餐续费</a>
    <?php } else { ?>
    <a class="ncsc-btn ncsc-btn-acidblue" href="<?php echo uk86_urlShop('store_voucher', 'quotaadd');?>" title=""><i class="icon-money"></i>购买套餐</a>
    <?php } ?>
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td class="nscs-table-handle">
        	<?php if($val['voucher_t_state']==$output['templatestate_arr']['usable'][0] && !$val['voucher_t_giveout']) {//卡券包模板有效并且没有领取时可以编辑?>
        		<span>
        	...
        	<?php }?>
        	<?php if (!$val['voucher_t_giveout']){//该模板没有发放过卡券包时可以删除?>
        	<span>
