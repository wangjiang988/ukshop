...
<div class="ncsc-form-default">
  <form id="add_form" action="index.php?act=store_livegroup&op=edit_livegroupbuy" method="post" enctype="multipart/form-data">
    ...
    <dl>
      ...
      <dd>
        <div class="ncsc-upload-thumb groupbuy-pic">
          <p> <img nctype="img_groupbuy_image" src="<?php echo uk86_gthumb($output['groupbuy']['groupbuy_pic'], 'max');?>"/></p>
        </div>
    ...
    <dl>
      ...
      <dd>
        <div class="ncsc-upload-thumb groupbuy-commend-pic">
          <p><i class="icon-picture"></i> <img nctype="img_groupbuy_image" src="<?php echo uk86_gthumb($output['groupbuy']['groupbuy_pic1'], 'max');?>"/></p>
        </div>
    ...
    <dl>
      ...
      <dd>
        <?php uk86_showEditor('groupbuy_intro',$output['groupbuy']['groupbuy_intro'],'740px','360px','','false',false);?>
...
$(document).ready(function(){
    ...
    $('[nctype="btn_upload_image"]').fileupload({
        dataType: 'json',
            url: "<?php echo uk86_urlShop('store_livegroup', 'image_upload');?>",
            add: function(e, data) {
