...
<div class="ncsc-form-default">
  ...
  <form id="add_form" name="add_form" action="<?php echo uk86_urlShop('store_groupbuy', 'quota_create_order',array('type'=>'1'));?>" method="post">
    <input type="hidden" value="0" id="price" name="price">
      ...
      <dd>
          <input id="quota_quantity" name="quota_quantity" type="text" class="text w30" /><em class="add-on">月</em><span></span>
