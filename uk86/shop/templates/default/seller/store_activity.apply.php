...
<form method="GET">
  ...
  <table class="ncsc-default-table" >
    ...
    <tbody>
      ...
      <tr class="bd-line">
        <td><div class="pic-thumb"><a href="index.php?act=goods&goods_id=<?php echo $v['goods_id']; ?>" target="_blank"><img src="<?php echo uk86_cthumb($v['goods_image'], 60,$_SESSION['store_id']);?>"></a></div></td>
        <td class="tl"><dl class="goods-name">
            <dt><a target="_blank" href="<?php echo uk86_urlShop('goods', 'index', array('goods_id' => $v['goods_id']));?>"><?php echo $v['goods_name'];?></a></dt>
    ...
    <form method="POST" id="apply_form" onsubmit="ajaxpost('apply_form','','','onerror');" action="index.php?act=store_activity&op=activity_apply_save">
      ...
      <div class="search-result">
        <ul class="goods-list">
          ...
          <li>
            <div class="goods-thumb"><a href="<?php echo uk86_urlShop('goods', 'index', array('goods_id' => $goods['goods_id']));?>" target="_blank"><img alt="<?php echo $goods['goods_name'];?>" title="<?php echo $goods['goods_name'];?>" src="<?php echo uk86_cthumb($goods['goods_image'], 240, $_SESSION['store_id']);?>"/></a></div>
            <dl class="goods-info">
              <dt>
                <input type="checkbox" value="<?php echo $goods['goods_id'];?>" class="vm" name="item_id[]"/>
                <label><a href="<?php echo uk86_urlShop('goods', 'index', array('goods_id' => $goods['goods_id']));?>" target="_blank"><?php echo $goods['goods_name'];?></a></label>
              </dt>
