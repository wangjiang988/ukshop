...
<header id="header">
	<div class="header_con">
		...
		<div class="headerRight" style="font-size:0.25rem; line-height:0.9rem; padding-left:0.3rem; padding-right:0.3rem;">确定</div>
	</div>
</header>
<!--顶部结束-->

<div id="content" class="p_bottom_b" style="background: #F5F5F5;">
  <form id="select_addr" method="get" action="<?php echo SHOP_SITE_URL.DS ?>index.php">
  ...
  <div class="manage_new_add"><a href="index.php?act=wap_buy&op=add_addr">+添加新地址</a></div>
</div>
...
$(function(){
	...
	$('.manage_list_3_1 a').click(function(){
		...
		window.location.href="index.php?act=wap_buy&op=edit_addr&id="+id;
		return false;
	});
	$('.manage_list_3_2 a').click(function(){
		if(confirm('确认删除？')){
			var id=$(this).attr('nctype');
			window.location.href="index.php?act=wap_buy&op=load_addr&id="+id;
			return false;
		}
	});
});
