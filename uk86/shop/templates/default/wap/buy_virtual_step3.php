...
<div id="content" class="p_bottom" style="background:#F5F5F5;">
 <div style="color:#999; width:100%; height:83%; font-size:0.3rem; text-align:center; background:#FFF;"><span style="margin-top:2.9rem; width:100%; text-align:left; padding:0 0 0 0.3rem; display:inline-block;">订单支付成功<br>您已成功支付订单金额：<em style="color:#FF3300;">￥<?php echo $_GET['order_amount']; ?></em></span><br />
