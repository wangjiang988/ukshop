...
<div class="ncc-receipt-info">
  ...
  <table class="ncc-table-style">
    ...
    <tbody>
      <tr>
        <th colspan="20"><strong>店铺：<a href="<?php echo uk86_urlShop('show_store','index',array('store_id'=>$store_id));?>"><?php echo $cart_list[0]['store_name']; ?></a></strong> <span member_id="<?php echo $output['store_list'][$store_id]['member_id'];?>"></span>
          <div class="store-sale">
            ...
            <a href="<?php echo uk86_urlShop('goods','index',array('goods_id'=>$goods_info['goods_id']));?>" target="_blank" class="ncc-store-gift" title="<?php echo $goods_info['goods_name']; ?>"><img src="<?php echo uk86_thumb($goods_info['goods_image'],60,$store_id);?>" alt="<?php echo $goods_info['goods_name']; ?>" /></a>
            <?php } ?>
            <?php  } ?>
            <?php } ?>
          </div></th>
      ...
      <tr id="cart_item_<?php echo $cart_info['cart_id'];?>" class="shop-list <?php echo ($cart_info['state'] && $cart_info['storage_state']) ? '' : 'item_disabled';?>">
        ...
        <td class="w60"><a href="<?php echo uk86_urlShop('goods','index',array('goods_id'=>$cart_info['goods_id']));?>" target="_blank" class="ncc-goods-uk86_thumb"><img src="<?php echo uk86_thumb($cart_info,60);?>" alt="<?php echo $cart_info['goods_name']; ?>" /></a></td>
        <?php } ?>
        <td class="tl" <?php if ($cart_info['bl_id'] != '0') {?>colspan="2"<?php }?>><dl class="ncc-goods-info">
            <dt><a href="<?php echo uk86_urlShop('goods','index',array('goods_id'=>$cart_info['goods_id']));?>" target="_blank"><?php echo $cart_info['goods_name']; ?></a></dt>
      ...
      <tr class="shop-list <?php echo $cart_info['state'] && $cart_info['storage_state'] ? '' : 'item_disabled';?>">
        <td></td>
        <td class="w60"><a href="<?php echo uk86_urlShop('goods','index',array('goods_id'=>$goods_info['goods_id']));?>" target="_blank" class="ncc-goods-thumb"><img src="<?php echo uk86_thumb($goods_info,60,$store_id);?>" alt="<?php echo $goods_info['goods_name']; ?>" /></a></td>
        <td class="tl"><dl class="ncc-goods-info">
            <dt><a href="<?php echo uk86_urlShop('goods','index',array('goods_id'=>$goods_info['goods_id']));?>" target="_blank"><?php echo $goods_info['goods_name']; ?></a> </dt>
          </dl></td>
      ...
      <tr>
        <td class="tr" colspan="20"><div class="ncc-store-account">
            <dl class="freight" id="freight_sotre">
              <dt>运费：</dt>
      ...
      <tr>
        <td class="w10"></td>
        <td class="tl" colspan="2">是否匿名购买：<label><input type="radio" value="1" checked="checked" name="is_anonymous" id="is_anonymous_yes"  /> 是</label>&nbsp;&nbsp;&nbsp;&nbsp;
      <label><input type="radio" value="0" name="is_anonymous" id="is_anonymous_no" /> 否</label></td>
        <td class="tl" colspan="10"><div class="ncc-form-default"> </div></td>
      </tr>
      <?php }?>
