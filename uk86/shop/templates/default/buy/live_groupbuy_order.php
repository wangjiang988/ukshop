...
<div class="ncc-main">
  ...
  <form action="<?php echo uk86_urlShop('show_live_groupbuy','livegroupbuystep1');?>" method="POST" id="apply_form" name="apply_form">
    ...
    <table class="ncc-table-style" nc_type="table_cart">
      ...
      <tbody>
        ...
        <tr class="shop-list">
          <td class="w10"></td>
          <td class="w60">
			<a class="ncc-goods-thumb" target="_blank" href="<?php echo uk86_urlShop('show_live_groupbuy','groupbuy_detail',array('groupbuy_id'=>$output['live_groupbuy']['groupbuy_id']));?>"> <img alt="<?php echo $output['live_groupbuy']['groupbuy_name'];?>" src="<?php echo uk86_gthumb($output['live_groupbuy']['groupbuy_pic'],'small');?>"> </a>
		  </td>
          <td class="tl">
			<a target="_blank" href="<?php echo uk86_urlShop('show_live_groupbuy','groupbuy_detail',array('groupbuy_id'=>$output['live_groupbuy']['groupbuy_id']));?>"><?php echo $output['live_groupbuy']['groupbuy_name'];?></a></td>
