...
<div class="ncc-main">
  ...
  <form action="<?php echo uk86_urlShop('show_live_groupbuy','livegroupbuystep2');?>" method="POST" id="apply_form" name="apply_form">
    ...
    <table class="ncc-table-style" nc_type="table_cart">
      ...
      <tbody>
        <tr>
          <th colspan="20">
			...
			<?php }else{?>
			<a href="<?php echo uk86_urlShop('show_store', 'index', array('store_id'=>$output['store_info']['store_id']));?>" target="_blank"><?php echo $output['store_info']['store_name'];?></a>
			<?php }?>
		  <span></span>
		 </th>
        </tr>
        <tr>
          <td class="w10"></td>
          <td class="w60"><a class="ncc-goods-thumb" target="_blank" href="<?php echo uk86_urlShop('show_live_groupbuy','groupbuy_detail',array('groupbuy_id'=>$output['live_groupbuy']['groupbuy_id']));?>"> <img alt="<?php echo $output['live_groupbuy']['groupbuy_name'];?>" src="<?php echo uk86_gthumb($output['live_groupbuy']['groupbuy_pic'],'small');?>"> </a></td>
          <td class="tl"><a target="_blank" href="<?php echo uk86_urlShop('show_live_groupbuy','groupbuy_detail',array('groupbuy_id'=>$output['live_groupbuy']['groupbuy_id']));?>"><?php echo $output['live_groupbuy']['groupbuy_name'];?></a></td>
          <td><span id="deal-buy-price"><?php echo $output['live_groupbuy']['groupbuy_price'];?></span></td>
          <td><?php echo $output['q_number'];?></td>
          <td><span id="deal-buy-total"><?php echo uk86_ncPriceFormat($output['q_number']*$output['live_groupbuy']['groupbuy_price']);?></span></td>
        </tr>
      ...
      <tfoot>
        <tr>
          <td colspan="20"><div class="ncc-all-account">订单总额：￥<em id="payment"><?php echo uk86_ncPriceFormat($output['q_number']*$output['live_groupbuy']['groupbuy_price']);?></em>元</div></td>
        </tr>
      </tfoot>
    </table>
