...
<div class="ncc-main">
 <div class="ncc-title">
  ...
  <form action="<?php echo uk86_urlShop('buy_virtual','buy_step2');?>" method="POST" id="form_buy" name="form_buy">
  <input type="hidden" name="goods_id" value="<?php echo $output['goods_info']['goods_id'];?>">
    <table class="ncc-table-style" nc_type="table_cart">
      ...
      <tbody>
        <tr>
          <th colspan="20"><i class="icon-home"></i><a href="<?php echo uk86_urlShop('show_store','index',array('store_id'=>$output['store_info']['store_id']));?>"><?php echo $output['store_info']['store_name'];?></a> <span member_id="<?php echo $output['store_info']['member_id'];?>"></span>
          </th>
        </tr>

        <tr class="shop-list">
          <td class="w10"></td>
          <td class="w60"><a href="<?php echo uk86_urlShop('goods','index',array('goods_id'=>$output['goods_info']['goods_id']));?>" target="_blank" class="ncc-goods-thumb"><img src="<?php echo uk86_thumb($output['goods_info'],60);?>" alt="<?php echo $output['goods_info']['goods_name']; ?>" /></a></td>
