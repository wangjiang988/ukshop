...
<div class="ncc-main">
 <div class="ncc-title">
  ...
  <form action="<?php echo uk86_urlShop('buy_virtual','buy_step3');?>" method="POST" id="form_buy" name="form_buy">
  ...
  <input type="hidden" name="quantity" value="<?php echo $output['goods_info']['quantity'];?>">
    ...
    <table class="ncc-table-style" nc_type="table_cart">
      ...
      <tbody>
        <tr>
          <th colspan="20">店铺：<a href="<?php echo uk86_urlShop('show_store','index',array('store_id'=>$output['store_info']['store_id']));?>"><?php echo $output['store_info']['store_name'];?></a> <span member_id="<?php echo $output['store_info']['member_id'];?>"></span>
          </th>
        </tr>

        <tr class="shop-list">
          <td class="w10"></td>
          <td class="w60"><a href="<?php echo uk86_urlShop('goods','index',array('goods_id'=>$output['goods_info']['goods_id']));?>" target="_blank" class="ncc-goods-uk86_thumb"><img src="<?php echo uk86_thumb($output['goods_info'],60);?>" alt="<?php echo $output['goods_info']['goods_name']; ?>" /></a></td>
          <td class="tl"><dl class="ncc-goods-info">
              <dt><a href="<?php echo uk86_urlShop('goods','index',array('goods_id'=>$output['goods_info']['goods_id']));?>" target="_blank"><?php echo $output['goods_info']['goods_name']; ?></a></dt>
                <dd>
            ...
            <dl class="voucher">
              <dt>
                <select nctype="voucher" name="voucher">
                  <option value="|0.00">选择卡券包</option>
