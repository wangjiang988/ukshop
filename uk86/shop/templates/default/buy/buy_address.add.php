    ...
    if ($('#addr_form').valid()){
        ...
        $.post('index.php',datas,function(data){
            if (data.state){
            	...
            	uk86_showShippingPrice($('#city_id').val(),$('#area_id').val());
            	uk86_hideAddrList(data.addr_id,true_name,area_info+'&nbsp;&nbsp;'+address,(mob_phone != '' ? mob_phone : tel_phone));
            }else{
                alert(data.msg);
            }
        },'json');
