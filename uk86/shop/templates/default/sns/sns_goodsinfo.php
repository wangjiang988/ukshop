...
<div class="sidebar">
<?php include uk86_template('sns/sns_sidebar_sharegoods');?>
</div>
  ...
  <div class="snsgoods-info">
    ...
    <div class="gcontainer">
      ...
      <?php if($output['sharegoods_info']['snsgoods_isfirst'] == false){?>
          ...
          <?php }?>
        <div class="good-img"> <img src="<?php echo uk86_cthumb($output['sharegoods_info']['snsgoods_goodsimage'],1280,$output['sharegoods_info']['snsgoods_storeid']);?>"/> </div>
      </div>
