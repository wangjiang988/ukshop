  ...
  <div class="sharelist-g mt30">
    ...
    <ul class="nc-sns-pinterest" id="snsPinterest">
      ...
      <li id="recordone_<?php echo $v['share_id'];?>" class="item">
        ...
        <dl>
          <dt class="goodspic"><span class="thumb size233"><i></i><a href="index.php?act=member_snshome&op=goodsinfo&mid=<?php echo $v['share_memberid'];?>&id=<?php echo $v['share_id'];?>" title="<?php echo $v['snsgoods_goodsname']?>"> <img src="<?php echo uk86_cthumb($v['snsgoods_goodsimage'],240,$v['snsgoods_storeid']);?>"/></a></span>
