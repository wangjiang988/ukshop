        ...
        <div class="shop-content">
          ...
          <div class="detail">
            ...
            <ul nc_type="mycarousel" class="jcarousel-skin-tango">
              ...
              <li><div class="goods-pic"><a href="<?php echo $g_v['goodsurl'];?>" target="_blank"><img alt="<?php echo $g_v['goods_name'];?>" src="<?php echo uk86_thumb($g_v, 240);?>"/></a></div></li>
              <?php }?>
            </ul>
            <?php }?>
          </div>
          <div class="operate">
            ...
            <div class="button"><span><a href="<?php echo uk86_urlShop('show_store', 'index', array('store_id'=>$v['store_id']));?>"><?php echo $lang['sns_round_store'];?></a></span><span><a href="javascript:collect_store('<?php echo $v['store_id'];?>','count','store_collect')"><?php echo $lang['sns_collect_store'];?></a></span></div>
          </div>
