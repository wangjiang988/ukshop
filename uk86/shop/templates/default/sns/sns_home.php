...
<div class="sidebar">
<?php include uk86_template('sns/sns_sidebar_visitor');?>
<?php include uk86_template('sns/sns_sidebar_messageboard');?>
</div>
<div class="left-content">
  ...
  <ul class="sns-home-share">
    ...
    <li id="recordone_<?php echo $v['share_id'];?>"><a href="index.php?act=member_snshome&op=goodsinfo&mid=<?php echo $v['share_memberid'];?>&id=<?php echo $v['share_id'];?>" title="<?php echo $v['snsgoods_goodsname']?>" class="pic" style=" background-image:url(<?php echo uk86_cthumb($v['snsgoods_goodsimage'],240,$v['snsgoods_storeid']);?>)"> </a>
    ...
    <ul>
      ...
      <li id="recordone_<?php echo $v['share_id']; ?>">
        ...
        <div class="shop-content">
          ...
          <div class="info">
            <div class="title"><a title="<?php echo $v['store_name'];?>" href="<?php echo uk86_urlShop('show_store', 'index', array('store_id'=>$v['store_id']));?>"><i class="ico" ></i><?php echo $v['store_name'];?></a>
            </div>
          </div>
          <div class="detail">
            ...
            <ul nc_type="mycarousel" class="jcarousel-skin-tango">
              ...
              <li><div class="goods-pic"><a href="<?php echo $g_v['goodsurl'];?>" target="_blank" title="<?php echo $g_v['goods_name'];?>"><img alt="<?php echo $g_v['goods_name'];?>" src="<?php echo uk86_thumb($g_v,240);?>" /></a></div></li>
              <?php }?>
            </ul>
            <?php }?>
          </div>
  ...
  <ul class="fd-list" id="friendtrace">
    ...
    <li nc_type="tracerow_<?php echo $v['trace_id']; ?>">
      <dl class="fd-wrap">
        <dt><img src="<?php echo uk86_getMemberAvatarForID($v['trace_memberid']);?>"  data-param="{'id':<?php echo $v['trace_memberid'];?>}" nctype="mcard">
          <h3><a href="index.php?act=member_snshome&mid=<?php echo $v['trace_memberid'];?>" target="_blank" data-param="{'id':<?php echo $v['trace_memberid'];?>}" nctype="mcard"><?php echo $v['trace_membername'];?><?php echo $lang['nc_colon'];?></a><?php echo uk86_parsesmiles($v['trace_title']);?></h3>
        </dt>
        <dd>
          ...
          <div class="fd-forward">
            ...
            <?php echo uk86_parsesmiles($v['trace_content']);?>
        ...
        <dd>
          ...
          <span class="fl ml10"><?php echo uk86_snsShareFrom($v['trace_from']);?></span>
