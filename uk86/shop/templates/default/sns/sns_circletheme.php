      ...
      <li>
        <dl class="theme-info">
          ...
          <?php foreach ($array as $v){?>
            <div class="thumb-cut"><a href="Javascript: void(0);"><img src="<?php echo uk86_themeImageUrl($v['affix_filethumb']);?>" class="t-img" /></a></div>
          <?php }?>
          <?php }?>
          </dd>
          <dd class="theme-txt"><p><?php echo uk86_removeUBBTag($val['theme_content']);?></p><a href="<?php echo CIRCLE_SITE_URL;?>/index.php?act=theme&op=theme_detail&c_id=<?php echo $val['circle_id'];?>&t_id=<?php echo $val['theme_id'];?>">[<?php echo $lang['sns_look_at_original'];?>]</a></dd>
