...
<ul class="handle">
  <?php if ($output['relation'] == 3){//主人自己?><li class="delete" style=" margin-left: 150px;" nc_type="delbtn" data-param='{"sid":"<?php echo $v['share_id'];?>","tabtype":"like"}'><a href="javascript:void(0)"><i></i><?php echo $lang['nc_delete'];?></a></li>
    <?php } ?></ul>
  <dl>
    <dt class="goodspic"><span class="thumb size233"><i></i><a href="index.php?act=member_snshome&op=goodsinfo&type=like&mid=<?php echo $v['share_memberid'];?>&id=<?php echo $v['share_id'];?>" title="<?php echo $v['snsgoods_goodsname']?>"> <img src="<?php echo uk86_cthumb($v['snsgoods_goodsimage'],240,$v['snsgoods_storeid']);?>"/> </a></span></dt>
