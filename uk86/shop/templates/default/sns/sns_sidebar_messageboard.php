...
<div class="side-message">
  ...
  <div nctype="message_list" class="message-list">
    ...
    <dl nctype="dl<?php echo $val['message_id'];?>">
      <dt><a href="index.php?act=member_snshome&mid=<?php echo $val['from_member_id'];?>" data-param="{'id':<?php echo $val['from_member_id'];?>}" nctype="mcard"><?php echo $val['from_member_name'].$lang['nc_colon'];?></a><span><?php echo uk86_parsesmiles($val['message_body']);?></span></dt>
      ...
      <dd>
        ...
        <dl class="re-content">
          <dt><a href="index.php?act=member_snshome&mid=<?php echo $v['from_member_id'];?>"><?php echo $v['from_member_name'];?><?php echo $lang['sns_reply'].$lang['nc_colon'];?></a><span><?php echo uk86_parsesmiles($v['message_body']);?></span></dt>
