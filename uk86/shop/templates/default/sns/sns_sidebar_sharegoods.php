...
<div class="side-goodslist">
  <ul>
    ...
    <li>
      <div class="goods-pic"><span class="thumb size75"><i></i><a href="index.php?act=member_snshome&op=goodsinfo<?php if($_GET['type'] == 'like') echo '&type=like';?>&mid=<?php echo $val['share_memberid'];?>&id=<?php echo $val['share_id'];?>" title="<?php echo $val['snsgoods_goodsname']?>"> <img src="<?php echo uk86_cthumb($val['snsgoods_goodsimage'], 60,$val['snsgoods_storeid']);?>"/></a></span><em class="price"><?php echo $lang['currency'].$val['snsgoods_goodsprice'];?></em></div>
    </li>
    <?php }?>
    <?php }else{?>
    <li>
