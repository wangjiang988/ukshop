			...
			<?php foreach($output['out_class'] as $val){?>
				<li class="fn-left">
					<a keycate="<?php echo $val['gc_id'];?>" class="blue" href="#" title="<?php echo $val['gc_name'];?>">
						<?php echo uk86_str_cut($val['gc_name'],13);?>
					</a>
				</li>
			<?php };?>
		<?php };?>
          ...
          <div class="list fn-left">
            <h2>
				<a class="blue" href="index.php?act=flea_goods&goods_id=<?php echo $val['goods_id'];?>" title="<?php echo $val['goods_name'];?>">
					<?php echo $lang['flea_index_goods_1'];?><?php echo $val['quality'];?><?php echo $lang['flea_index_goods_2'];?><?php echo str_replace($output['condition_out']['key_input'],"<font color='red'>".$output['condition_out']['key_input']."</font>",uk86_str_cut($val['goods_name'],42));?>
				</a>
			</h2>
            <p class="details"><strong class="orange fn-left"><span style="font-size:12px;"><?php echo $lang['currency'];?></span><?php echo $val['goods_store_price'];?></strong><span class="fn-right gray"><?php echo $lang['flea_ftf_trade'];?></span></p>
				<p class="list_content">
					<?php if($val['explain']){echo uk86_str_cut($val['explain'],140);}else{?><?php echo $lang['flea_no_explain'];?><?php }?>
				</p>
            <p>
          ...
          <div class="seller fn-left">
            <div class="pic fn-left">
              <span class="thumb size50">
                <i></i>
                <a href="index.php?act=flea_class&seller_input=<?php echo $val['member_info']['member_id'];?>&pic_input=1"><img src="<?php echo uk86_getMemberAvatar($_SESSION['avatar']);?>" width="50px" height="50px"/></a>
              </span>
            </div>
            <p class="seller_name">
					...
					<li class="sell_one">
					  <div>
						<p class="pic1">
						  ...
						  <a href="index.php?act=flea_class&seller_input=<?php echo $val['member_id'];?>">
								<img src="<?php echo uk86_getMemberAvatar($_SESSION['avatar']);?>" width="25px" height="25px"/>
							</a>              
						  </span>
						</p>
					  ...
					  <p class="items_title">
						<a href="index.php?act=flea_goods&goods_id=<?php echo $val['goods_id'];?>">
							<?php echo uk86_str_cut($val['goods_name'],40);?>
						</a>
					  </p>
