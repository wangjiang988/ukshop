...
<div class="ncp-container">
  <div class="ncp-base-layout">
    ...
    <div class="ncp-banner-right"><?php echo uk86_loadadv(35,'html');?></div>
  </div>
  <?php if (C('voucher_allow')==1){?>
  <div class="ncp-main-layout">
    <div class="title">
      <h3><i class="voucher"></i>热门卡券包</h3>
      <span class="more"><a href="<?php echo uk86_urlShop('pointvoucher', 'index');?>"><?php echo $lang['home_voucher_moretitle'];?></a></span> </div>
    ...
    <ul class="ncp-voucher-list">
      ...
      <li>
        <div class="ncp-voucher">
          <div class="cut"></div>
          <div class="info"><a href="<?php echo uk86_urlShop('show_store', 'index', array('store_id'=>$v['voucher_t_store_id']));?>" class="store"><?php echo $v['voucher_t_storename'];?></a>
            <p class="store-classify"><?php echo $v['voucher_t_sc_name'];?></p>
            <div class="pic"><img src="<?php echo $v['voucher_t_customimg'];?>" onerror="this.src='<?php echo UPLOAD_SITE_URL.DS.uk86_defaultGoodsImage(240);?>'"/></div>
          </div>
          <dl class="value">
          ...
          <div class="point">
            <p class="required">需<em><?php echo $v['voucher_t_points'];?></em>U币</p>
  ...
  <div class="ncp-main-layout mb30">
    <div class="title">
      ...
      <span class="more"><a href="<?php echo uk86_urlShop('pointprod', 'plist');?>"><?php echo $lang['pointprod_list_more'];?></a></span> </div>
    ...
    <ul class="ncp-exchange-list">
      ...
      <li>
        <div class="gift-pic"><a target="_blank" href="<?php echo uk86_urlShop('pointprod', 'pinfo', array('id' => $v['pgoods_id']));?>"> <img src="<?php echo $v['pgoods_image'] ?>" alt="<?php echo $v['pgoods_name']; ?>" /> </a></div>
        <div class="gift-name"><a href="<?php echo uk86_urlShop('pointprod', 'pinfo', array('id' => $v['pgoods_id']));?>" target="_blank" title="<?php echo $v['pgoods_name']; ?>"><?php echo $v['pgoods_name']; ?></a></div>
