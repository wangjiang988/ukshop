...
<div class="ncp-container">
  ...
  <div class="ncp-main-layout">
    ...
    <ul class="ncp-exchange-list">
      ...
      <li>
        <div class="gift-pic"><a href="<?php echo uk86_urlShop('pointprod', 'pinfo', array('id' => $v['pgoods_id']));?>"  > <img src="<?php echo $v['pgoods_image'] ?>" title="<?php echo $v['pgoods_name']; ?>" alt="<?php echo $v['pgoods_name']; ?>"></a></div>
        <div class="gift-name"><a href="<?php echo uk86_urlShop('pointprod', 'pinfo', array('id' => $v['pgoods_id']));?>" ><?php echo $v['pgoods_name']; ?></a></div>
