    ...
    <div class="span-24" id="content">
      <div class="invite-bd">
        <div class="invite-form">
          ...
          <div>
            <input type="text" readonly value="<?php echo BASE_SITE_URL;?>/#UKxsh<?php echo $member_id;?>" class="std-input i-invite-link">
        ...
        <div class="invite-share-site clearfix"> 
          <!-- Baidu Button BEGIN -->
          <p id="bdshare" class="bdshare_t bds_tools get-codes-bdshare" data="{'url':'<?php echo BASE_SITE_URL;?>/#UKxsh<?php echo intval($_SESSION['member_id'])*1;?>'}"> <span class="bds_more">快捷邀请：</span> <a class="bds_qzone">QQ空间</a> <a class="bds_tsina">新浪微博</a> <a class="bds_tqq">腾讯微博</a> <a class="bds_taobao">我的淘宝</a> <a class="bds_renren">人人网</a> <a class="bds_douban">豆瓣</a> </p>
          <!-- Baidu Button END --> 
        </div>
        <div class="invite-rebate"><a href="<?php echo uk86_urlShop('member_points','index');?>" target="_blank" hidefocus="true"><img src="<?php echo SHOP_TEMPLATES_URL;?>/images/invite/income.png"></a></div>
        <div class="invite-rules">
          <p>1. 成功邀请一个好友，可获100U币奖励；</p>
          <p>2. 当好友成功购买了商品，可获得10%返利U币。<br />
            (例如：好友购买100元商品，您可获得10U币)</p>
        </div>
      </div>
