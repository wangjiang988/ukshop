...
<div class="goods-guess-like">
  ...
  <div class="content">
    ...
    <ul id="mycarousel" class="jcarousel-skin-tango">
      ...
      <li>
        <div class="goods-pic"> <a href="<?php echo uk86_urlShop('goods','index',array('goods_id'=>$v['goods_id']));?>" target="_blank"><img alt="" src="<?php echo uk86_cthumb($v['goods_image'], 240);?>"></a> </div>
        ...
        <?php } ?>
        <dl class="goods-info">
          <dt><a href="<?php echo uk86_urlShop('goods','index',array('goods_id'=>$v['goods_id']));?>" title="<?php echo $v['goods_name'];?>" target="_blank"><?php echo $v['goods_name'];?></a></dt>
          <dd>
            <div>￥<em><?php echo uk86_ncPriceFormat($v['goods_promotion_price']);?></em></div>
          </dd>
        </dl>
      </li>
      <?php } ?>
