...
<?php foreach($output['store_list'] as $skey => $store){?>
    <li class="item">
      <dl class="shop-info">
        ...
        <dd class="shop-pic"><a href="<?php echo uk86_urlShop('show_store','', array('store_id'=>$store['store_id']),$store['store_domain']);?>" title="" target="_blank"><span class="size72"><img src="<?php echo uk86_getStoreLogo($store['store_avatar']);?>"  alt="<?php echo $store['store_name'];?>" title="<?php echo $store['store_name'];?>" class="size72" /></span></a></dd>
      ...
      <dl class="w120">
        <dd class="shop-sc"><a href="javascript:collect_store('<?php echo $store['store_id'];?>','count','store_collect')" ></a></dd>
      </dl>
