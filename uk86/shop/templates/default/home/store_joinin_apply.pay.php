    ...
    <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
      ...
      <tbody>
        ...
        <tr>
          <th>组织机构代码证<br/>
            电子版：</th>
          <td><a nctype="nyroModal"  href="<?php echo uk86_getStoreJoininImageUrl($output['joinin_detail']['organization_code_electronic']);?>"> <img src="<?php echo uk86_getStoreJoininImageUrl($output['joinin_detail']['organization_code_electronic']);?>" alt="" /> </a></td>
        </tr>
      </tbody>
    </table>
    <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
      ...
      <tbody>
        <tr>
          <th>一般纳税人证明：</th>
          <td><a nctype="nyroModal"  href="<?php echo uk86_getStoreJoininImageUrl($output['joinin_detail']['general_taxpayer']);?>"> <img src="<?php echo uk86_getStoreJoininImageUrl($output['joinin_detail']['general_taxpayer']);?>" alt="" /> </a></td>
        </tr>
      </tbody>
    </table>
    <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
