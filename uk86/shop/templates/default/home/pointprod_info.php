      ...
      <div class="ncp-info">
        ...
        <ul class="ncp-exchangeNote">
          ...
          <li>
            ...
            <div class="user-name"><?php echo uk86_str_cut($v['point_buyername'],'4').'***'; ?></div>
      ...
      <div class="ncp-sidebar-container">
        ...
        <div class="content">
          ...
          <ul class="recommend">
            ...
            <li>
              <div class="gift-pic"><a target="_blank" href="<?php echo uk86_urlShop('pointprod', 'pinfo', array('id' => $v['pgoods_id']));?>" title="<?php echo $v['pgoods_name']; ?>"> <img src="<?php echo $v['pgoods_image'] ?>" alt="<?php echo $v['pgoods_name']; ?>" /> </a></div>
              <div class="gift-name"><a href="<?php echo uk86_urlShop('pointprod', 'pinfo', array('id' => $v['pgoods_id']));?>" target="_blank" tile="<?php echo $v['pgoods_name']; ?>"><?php echo $v['pgoods_name']; ?></a></div>
