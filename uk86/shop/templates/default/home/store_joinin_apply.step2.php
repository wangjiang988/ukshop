    ...
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      ...
      <tbody>
        <tr>
          ...
          <td><input name="bank_account_name" type="text" value="<?php echo $output['joininfo']['bank_account_name']; ?>" class="w200" />
            <span></span></td>
        </tr>
        <tr>
          <th><i>*</i>公司银行账号：</th>
          <td><input name="bank_account_number" type="text" value="<?php echo $output['joininfo']['bank_account_number']; ?>" class="w200" />
            <span></span></td>
        </tr>
        <tr>
          <th><i>*</i>开户银行支行名称：</th>
          <td><input name="bank_name" type="text" value="<?php echo $output['joininfo']['bank_name']; ?>" class="w200" />
            <span></span></td>
        </tr>
        <!--ukshop 简化 tr>
          <th><i>*</i>支行联行号：</th>
        ...
        <tr>
          <th><i>*</i>开户银行所在地：</th>
          <td><input id="bank_address" name="bank_address" value="<?php echo $output['joininfo']['bank_address']; ?>" type="hidden" />
            <span></span></td>
        </tr>
	<!--  简化-->
        <!--<tr>
        ...
        <tr>
          <th></th>
          <td><input id="is_settlement_account" name="is_settlement_account" type="checkbox" value="<?php if($output['joininfo']['is_settlement_account']==1) echo 'checked'; ?>" />
    ...
    <div id="div_settlement">
      <table border="0" cellpadding="0" cellspacing="0" class="all">
        ...
        <tbody>
          <tr>
            <th class="w150"><i>*</i>银行开户名：</th>
            <td><input id="settlement_bank_account_name" name="settlement_bank_account_name" value="<?php echo $output['joininfo']['settlement_bank_account_name']; ?>"  type="text" class="w200"/>
              <span></span></td>
          </tr>
          <tr>
            <th><i>*</i>公司银行账号：</th>
            <td><input id="settlement_bank_account_number" name="settlement_bank_account_number" value="<?php echo $output['joininfo']['settlement_bank_account_number']; ?>"  type="text" class="w200"/>
              <span></span></td>
          </tr>
          <tr>
            <th><i>*</i>开户银行支行名称：</th>
            <td><input id="settlement_bank_name" name="settlement_bank_name" type="text" value="<?php echo $output['joininfo']['settlement_bank_name']; ?>"  class="w200"/>
              <span></span></td>
          </tr>
	  <!-- 好商城 v3-10 简化-->
          <!--tr>
          ...
          <tr>
            <th><i>*</i>开户银行所在地：</th>
            <td><input id="settlement_bank_address" name="settlement_bank_address" value="<?php echo $output['joininfo']['settlement_bank_address']; ?>"  type="hidden" />
              <span></span></td>
          </tr>
        </tbody>
        <tfoot>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      ...
      <tbody>
        <tr>
          ...
          <td><input name="tax_registration_certificate" type="text" value="<?php echo $output['joininfo']['tax_registration_certificate']; ?>" class="w200"/>
            <span></span></td>
        </tr>
	<!--好商城 v3-10 简化-->
        <!--tr>
