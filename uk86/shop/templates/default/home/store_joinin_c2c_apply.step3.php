    ...
    <form id="form_store_info" action="index.php?act=store_joinin_c2c&op=step4" method="post">
        <table border="0" cellpadding="0" cellspacing="0" class="all">
            ...
            <tr>
                ...
                <td><input id="seller_name" name="seller_name" value="<?php echo $output['joininfo']['seller_name']; ?>"
            ...
            <tr>
                ...
                <td><input name="store_name" type="text" value="<?php echo $output['joininfo']['store_name']; ?>"
                           class="w200"/>
                    <span></span>
                ...
                <td><select name="sg_id" id="sg_id">
                        ...
                        <?php if (!empty($output['grade_list']) && is_array($output['grade_list'])) { ?>
                            <?php foreach ($output['grade_list'] as $k => $v) { ?>
                                ...
                                <option value="<?php echo $v['sg_id']; ?>" <?php if($output['joininfo']['sg_id']==$v['sg_id']) echo 'selected'; ?>
                                        data-explain="<?php echo $explain; ?>"><?php echo $v['sg_name']; ?></option>
                            <?php } ?>
                        <?php } ?>
                    </select>
                ...
                <td><select name="sc_id" id="sc_id">
                        ...
                        <?php if (!empty($output['store_class']) && is_array($output['store_class'])) { ?>
                            <?php foreach ($output['store_class'] as $k => $v) { ?>
                                <option value="<?php echo $v['sc_id']; ?>" <?php if($output['joininfo']['sc_id']==$v['sc_id']) echo 'selected'; ?>> <?php echo $v['sc_name']; ?></option>
                            <?php } ?>
                        <?php } ?>
                    </select>
