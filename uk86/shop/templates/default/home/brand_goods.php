    ...
    <div class="nch-module nch-module-style01">
      ...
      <div class="content">
        ...
        <ul class="nch-sidebar-brand">
          ...
          <li class="picture"> <a href="<?php echo uk86_urlShop('brand', 'list',array('brand'=>$brand_r['brand_id']));?>" target="_blank"> <span class="brand-logo"><img src="<?php echo uk86_brandImage($brand_r['brand_pic']);?>" alt="<?php echo $brand_r['brand_name'];?>" /></span> <span class="brand-name"><?php echo $brand_r['brand_name'];?></span></a> </li>
          <?php }?>
        </ul>
        <?php }?>
      </div>
    </div>
    <div class="nch-module nch-module-style03"><?php echo uk86_loadadv(37,'html');?> </div>
    <!-- 浏览历史 -->
      ...
      <div class="content">
        <div class="nch-sidebar-viewed" id="nchSidebarViewed">
          ...
          <?php if(!empty($output['viewed_goods'])){ ?>
            ...
            <li>
              <div class="goods-pic"><a href="<?php echo uk86_urlShop('goods','index',array('goods_id'=>$v['goods_id'])); ?>"><img src="<?php echo uk86_thumb($v, 60); ?>" title="<?php echo $v['goods_name']; ?>" alt="<?php echo $v['goods_name']; ?>" ></a></div>
              <dl>
                <dt><a href="<?php echo uk86_urlShop('goods','index',array('goods_id'=>$v['goods_id'])); ?>"><?php echo $v['goods_name']; ?></a></dt>
