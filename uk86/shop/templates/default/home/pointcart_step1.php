      ...
      <div class="ncc-receipt-info">
        ...
        <table class="ncc-table-style">
          ...
          <tbody>
            ...
            <tr class="shop-list ">
              <td></td>
              <td class="w60"><a href="<?php echo uk86_urlShop('pointprod', 'pinfo', array('id' => $val['pgoods_id']));?>" class="ncc-goods-thumb" target="_blank"><img src="<?php echo $val['pgoods_image_small']; ?>" alt="<?php echo $val['pgoods_name']; ?>"/></a></td>
              <td class="tl"><dl class="ncc-goods-info">
                  <dt><a target="_blank" href="<?php echo uk86_urlShop('pointprod', 'pinfo', array('id' => $val['pgoods_id']));?>"><?php echo $val['pgoods_name']; ?></a></dt>
                </dl></td>
