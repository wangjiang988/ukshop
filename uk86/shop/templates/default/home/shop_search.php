...
<?php foreach($output['store_list'] as $skey => $store){?>
    <li class="item">
      ...
      <div class="nc-shop-goodslist" nc_type='goods_<?php echo $skey;?>'>
        ...
        <li>
            <dl>
              <dt class="goods-pic"><span class="uk86_thumb size160"> <i></i> <a href="index.php?act=goods&goods_id=<?php echo $v['goods_id'];?>" target="_blank"> <img  onload="javascript:DrawImage(this,160,160);" alt="<?php echo $v['goods_name'];?>" src="<?php echo uk86_thumb($v,'small');?>"></a></span></dt>
