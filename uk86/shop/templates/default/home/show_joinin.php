		  ...
		  <?php if($_SESSION['is_login'] == '1'){?>
			<div class="user-joinin">
				  ...
				  <dl>
					...
					<dd> 若您还没有填写入驻申请资料<br/>
					  请点击“<a href="<?php echo uk86_urlShop('store_joinin','step0');?>" target="_blank">我要入住</a>”进行入驻资料填写</dd>
					<dd>若您的店铺还未开通<br/>
					  请通过“<a href="<?php echo uk86_urlShop('store_joinin','index');?>" target="_blank">查看入驻进度</a>”了解店铺开通的最新状况 </dd>
				  </dl>
				  <div class="bottom"><a href="<?php echo uk86_urlShop('store_joinin','step0');?>" target="_blank">我要入住</a><a href="<?php echo uk86_urlShop('store_joinin','index');?>" target="_blank">查看入驻进度</a></div>
			</div>
		  <?php }else{?>
			<div class="user-login">
			  ...
			  <form id="login_form" action="index.php?act=login" method="post">
				...
				<input name="nchash" type="hidden" value="<?php echo uk86_urlShop();?>" />
				<dl>
				  <dt>用户名：</dt>
				  <dd>
				...
				<dl>
				  ...
				  <dd>
					...
					<a href="JavaScript:void(0);" onclick="javascript:document.getElementById('codeimage').src='<?php echo SHOP_SITE_URL?>/index.php?act=seccode&op=makecode&nchash=<?php echo uk86_urlShop();?>&t=' + Math.random();" class="change" title="看不清，换一张">
					<img src="<?php echo SHOP_SITE_URL?>/index.php?act=seccode&op=makecode&nchash=<?php echo uk86_urlShop();?>" class="fl ml5" name="codeimage" id="codeimage" border="0"/></a>
					<label></label>
				  </dd>
				</dl>
				<?php } ?>
				<dl>
				  ...
				  <dd>
					...
					<a href="<?php echo uk86_urlShop('login','forget_password');?>" target="_blank">忘记密码？</a></dd>
				</dl>
			  </form>
			  <div class="register">还没有成为我们的合作伙伴？ <a href="<?php echo uk86_urlShop('login','register');?>" target="_blank">快速注册</a></div>
			</div>
		  <?php }?>
   </div>
	...
	$("#login_form ").validate({
		...
		rules: {
			...
			,captcha : {
                ...
                minlength: 4,
                remote   : {
                    url : '<?php echo SHOP_SITE_URL?>/index.php?act=seccode&op=check&nchash=<?php echo uk86_urlShop();?>',
                    type: 'get',
                    data:{
                        captcha : function(){
                            return $('#captcha').val();
