...
<div class="ncp-member-grade">
  ...
  <?php } ?>
  <div class="links">
    <div class="links"> <a href="<?php echo uk86_urlShop('pointgrade','index');?>" target="_blank">我的成长进度</a> <a href="<?php echo uk86_urlShop('pointgrade','exppointlog');?>" target="_blank">经验值明细</a> </div>
  </div>
</div>
<div class="ncp-member-point">
  <dl style="border-left: none 0;">
    <a href="index.php?act=member_points" target="_blank">
    <dt><strong><?php echo $output['member_info']['member_points'];?></strong>U币</dt>
    <dd>我的U币</dd>
    </a>
  </dl>
