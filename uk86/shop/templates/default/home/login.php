    ...
    <form id="login_form" method="post" action="index.php?act=login&op=login"  class="bg">
        ...
        <div class="register-right">
            ...
            <div class="box-01" style="margin-top:20px;">
                ...
                <div class="pt-box">
                    <div class="input-out">
                        <input type="text" class="input-01" autocomplete="off"   placeholder="<?php echo $lang['login_index_username'];?>"  name="user_name"
                               id="user_name" autofocus >
                        <span class="ico-01"></span>
                    </div>
                </div>
                <div class="pt-box">
                    <div class="input-out">
                        <input type="password" class="input-01" name="password" autocomplete="off"  id="password" placeholder="密码" >
                ...
                <div class="pt-box">
                    ...
                    <?php if(C('captcha_status_login') == '1') { ?>
                        <div class="input-out input-yz-out">
                            <input type="text" name="captcha" autocomplete="off" class="input-01 w50 fl"
                                   id="captcha" maxlength="4" size="10"  placeholder="验证码" />
                        </div>
                        <span class="yzm">
                            <img src="<?php echo SHOP_SITE_URL?>/index.php?act=seccode&op=makecode&nchash=<?php echo uk86_getNchash();?>"
                           name="codeimage" border="0" id="codeimage" class="fl ml5">
                        </span>
                        <a href="javascript:void(0)" class="change-a"
                           onclick="javascript:document.getElementById('codeimage').src='<?php echo SHOP_SITE_URL?>/index.php?act=seccode&op=makecode&nchash=<?php echo uk86_getNchash();?>&t=' + Math.random();">
                            <?php echo $lang['login_index_change_checkcode'];?>
                        </a>
                ...
                <div class="text-box">
                    ...
                    <input type="submit" class="login-a" value="<?php echo $lang['login_index_login'];?>">
                    <a class="forget-a" href="index.php?act=login&op=forget_password"><?php echo $lang['login_index_forget_password'];?></a>
                    <p class="ps">还不是本站会员？立即</p>
                    <a title="" href="index.php?act=login&op=register&ref_url=<?php echo urlencode($output['ref_url']);?>" class="register-a"><?php echo $lang['login_index_regist_now_2'];?></a>
                </div>
            </div>
            ...
            <div class="quick-box">
                ...
                <?php if ($output['setting_config']['qq_isuse'] == 1){?>
                    <a href="<?php echo SHOP_SITE_URL;?>/api.php?act=toqq" class="qq">QQ登录</a>
                <?php } ?>

                <?php if ($output['setting_config']['sina_isuse'] == 1){?>
                    <a href="<?php echo SHOP_SITE_URL;?>/api.php?act=tosina" title="<?php echo $lang['nc_otherlogintip_sina']; ?>" class="sina">新浪微博</a>
                <?php } ?>
            </div>
                ...
                <?php /*if(C('captcha_status_login') == '1') { */?>
                    <dl>
                        ...
                        <dd style="min-height:54px;">
                            ...
                            <img src="<?php /*echo SHOP_SITE_URL*/?>/index.php?act=seccode&op=makecode&nchash=<?php /*echo uk86_getNchash();*/?>" name="codeimage" border="0" id="codeimage" class="fl ml5"> <a href="javascript:void(0)" class="ml5" onclick="javascript:document.getElementById('codeimage').src='<?php /*echo SHOP_SITE_URL*/?>/index.php?act=seccode&op=makecode&nchash=<?php /*echo uk86_getNchash();*/?>&t=' + Math.random();"><?php /*echo $lang['login_index_change_checkcode'];*/?></a>
                            <label></label>
                        </dd>
                    </dl>
                <?php /*} */?>
	...
	$("#login_form").validate({
		...
		rules: {
            ...
            ,captcha : {
                required : true,
                remote   : {
                    url : '<?php echo SHOP_SITE_URL?>/index.php?act=seccode&op=check&nchash=<?php echo uk86_getNchash();?>',
                    type: 'get',
                    data:{
                        captcha : function(){
                            return $('#captcha').val();
