...
<div class="nch-activity">
  ...
  <div class="sale" id="sale">
    <ul class="list_pic">
      ...
      <li class="c1">
        <dl>
          <dt class="goodspic"><a href="<?php echo uk86_urlShop('goods', 'index', array('goods_id'=>$v['goods_id']));?>" target="_blank"><img src="<?php echo uk86_thumb($v, 240);?>"/></a></dt>
          <dd class="goodsname"><a href="<?php echo uk86_urlShop('goods', 'index', array('goods_id'=>$v['goods_id']));?>" target="_blank" title="<?php echo $v['goods_name'];?>"><?php echo $v['goods_name'];?></a></dd>
          <dd class="price">
            <h4><?php echo uk86_ncPriceFormatForList($v['goods_price']);?></h4>
          </dd>
        </dl>
      </li>
      <?php }?>
