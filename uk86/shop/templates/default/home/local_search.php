    ...
    <div class="nch-module nch-module-style02">
      ...
      <div class="content">
        <ul id="files" class="tree">
          ...
          <li><i class="tree-parent tree-parent-collapsed"></i><a href="<?php echo uk86_urlShop('search', 'index', array('cate_id' => $value['gc_id'], 'keyword' => $_GET['keyword']));?>" <?php if ($value['gc_id'] == $_GET['cate_id']) {?>class="selected"<?php }?>><?php echo $value['gc_name']?></a>
            <?php if (!empty($value['class2'])) {?>
            <ul>
              <?php foreach ($value['class2'] as $val) {?>
              <li><i class="tree-parent tree-parent-collapsed"></i><a href="<?php echo uk86_urlShop('search', 'index', array('cate_id' => $val['gc_id'], 'keyword' => $_GET['keyword']));?>" <?php if ($val['gc_id'] == $_GET['cate_id']) {?>class="selected"<?php }?>><?php echo $val['gc_name']?></a>
                <?php if (!empty($val['class3'])) {?>
                <ul>
                  <?php foreach ($val['class3'] as $v) {?>
                  <li class="tree-parent tree-parent-collapsed"><i></i><a href="<?php echo uk86_urlShop('search', 'index', array('cate_id' => $v['gc_id'], 'keyword' => $_GET['keyword']));?>" <?php if ($v['gc_id'] == $_GET['cate_id']) {?>class="selected"<?php }?>><?php echo $v['gc_name']?></a></li>
                  <?php }?>
                </ul>
                <?php }?>
              </li>
        ...
        <div class="nch-sidebar-viewed" id="nchSidebarViewed">
          <ul>
            ...
            <li class="nch-sidebar-bowers">
              <div class="goods-pic"><a href="<?php echo uk86_urlShop('goods','index',array('goods_id'=>$v['goods_id'])); ?>" target="_blank"><img src="<?php echo uk86_thumb($v, 60); ?>" title="<?php echo $v['goods_name']; ?>" alt="<?php echo $v['goods_name']; ?>" ></a></div>
              <dl>
                <dt><a href="<?php echo uk86_urlShop('goods','index',array('goods_id'=>$v['goods_id'])); ?>" target="_blank"><?php echo $v['goods_name']; ?></a></dt>
      ...
      <nav class="sort-bar" id="main-nav">
        ...
        <div class="nch-all-category">
          <div class="all-category">
            <?php require uk86_template('layout/home_goods_class');?>
          </div>
        </div>
        ...
        <div class="nch-sortbar-location">商品所在地：
          <div class="select-layer">
            ...
            <i class="direction"></i>
            <ul class="options">
              <?php require(BASE_TPL_PATH.'/home/goods_class_area_city.php');?>
            </ul>
          </div>
        </div>
      </nav>
