...
<div class="nch-breadcrumb-layout" style="display: block;">
  <div class="nch-breadcrumb wrapper"> <i class="icon-home"></i> <span> <a href="<?php echo uk86_urlShop(); ?>">首页</a> </span> <span class="arrow">></span>
<?php if ($output['groupbuy_info']['is_vr']) { ?>
  <span><a href="<?php echo uk86_urlShop('show_groupbuy', 'vr_groupbuy_list'); ?>">虚拟抢</a></span>
<?php } else { ?>
  <span><a href="<?php echo uk86_urlShop('show_groupbuy', 'groupbuy_list'); ?>">线上抢</a></span>
<?php } ?>
  ...
  <div class="ncg-layout-l">
    <div class="ncg-main <?php echo $output['groupbuy_info']['state_flag'];?>">
      <div class="ncg-group">
        ...
        <div class="ncg-item">
          <div class="pic"><img src="<?php echo uk86_gthumb($output['groupbuy_info']['groupbuy_image'],'max');?>" alt=""></div>
        ...
        <div class="floating-bar">
          ...
          <div class="prices">
            ...
            <dl>
              <dt>商品来自</dt>
              <dd><a href="<?php echo uk86_urlShop('show_store', 'index', array('store_id' => $output['groupbuy_info']['store_id']));?>"><?php echo $output['groupbuy_info']['store_name'];?></a></dd>
            </dl>
          </div>
        </div>
      </div>
      ...
      <div class="ncg-evaluate">
        <div class="top">
          ...
          <div class="btns"><span>您可对已购商品进行评价</span>
            <p><a href="<?php if ($output['groupbuy_info']['is_vr']) { echo uk86_urlShop('member_vr_order', 'index');} else { echo uk86_urlShop('member_order', 'index');}?>" class="ncg-btn ncg-btn-red" target="_blank"><i class="icon-comment-alt"></i>评价商品</a></p>
          </div>
        </div>
        <!-- 商品评价内容部分 -->
...
<?php } ?>
          ...
          <div class="goto"> <a href="<?php echo uk86_urlShop('show_store', 'index', array('store_id' => $output['groupbuy_info']['store_id']));?>" >进入商家店铺</a></div>
        </div>
      </div>
    </div>
<?php } ?>
      ...
      <div class="content">
        <div class="ncg-group-command">
          ...
          <dl <?php if($hot_groupbuy_count === 1) { echo "style=' border:none'";$hot_groupbuy_count++; }?> >
            ...
            <dd class="pic-thumb"><a href="<?php echo $hot_groupbuy['groupbuy_url'];?>" target="_blank"><img src="<?php echo uk86_gthumb($hot_groupbuy['groupbuy_image1'],'max');?>"></a></dd>
...
$(function(){
    ...
    $("#groupbuy_order").load('<?php echo uk86_urlShop('show_groupbuy', 'groupbuy_order', array('group_id' => $output['groupbuy_info']['groupbuy_id'],'is_vr'=>$output['groupbuy_info']['is_vr']));?>');
    $("#groupbuy_evaluate").load('<?php echo uk86_urlShop('show_groupbuy', 'groupbuy_evaluate', array('commonid' => $output['groupbuy_info']['goods_commonid']));?>');
});
</script>
