...
<?php } ?>
    ...
    <?php } ?>
    	  	  <!--只有实名认证实体店认证后才显示保障体系 by ukshop.com -->	  
...
<?php }?>	  
    ...
    <div class="goto"><a href="<?php echo uk86_urlShop('show_store', 'index', array('store_id' => $output['store_info']['store_id']), $output['store_info']['store_domain']);?>" >进入商家店铺</a><a href="javascript:collect_store('<?php echo $output['store_info']['store_id'];?>','count','store_collect')" >收藏店铺<em nctype="store_collect"><?php echo $output['store_info']['store_collect']?></em></a></div>
    ...
    <ul>
      ...
      <li class="ncs-info-btn-qrcode"><a href="javascript:void(0)" class="pngFix"><span>店铺二维码</span><b></b> <!-- 店铺二维码 -->
        <p class="ncs-info-qrcode"><img src="http://qr.liantu.com/api.php?&el=l&w=208&m=10&text=<?php echo uk86_urlShop('show_store', 'index', array('store_id' => $output['store_info']['store_id']), $output['store_info']['store_domain']);?>"></p>
        </a></li>
    </ul>
    </div> 
  </div>
