  	...
  	<div class="fd-aside">
		<span class="thumb size60"><i></i>
			<a href="index.php?act=store_snshome&sid=<?php echo $output['strace_info']['strace_storeid'];?>" target="_blank">
				<img src="<?php echo uk86_getStoreLogo($output['strace_info']['strace_storelogo']);  ?>" onload="javascript:DrawImage(this,60,60);">
			</a>
		</span>
      </div>
    <dl class="fd-wrap">
      ...
      <dd>
        <?php echo uk86_parsesmiles($output['strace_info']['strace_content']);?>
      </dd>
	  <dd>
