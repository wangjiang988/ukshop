...
<div id="faq" style="margin-top: 30px;">
  <div class="faq-wrapper">
   ...
   <li> <dl class="s<?php echo ''.$k+1;?>">
      ...
      <dd><i></i><a href="<?php if($article['article_url'] != '')echo $article['article_url'];else echo uk86_urlShop('article', 'show',array('article_id'=> $article['article_id']));?>" title="<?php echo $article['article_title']; ?>"> <?php echo $article['article_title'];?> </a></dd>
      <?php }?>
      <?php }?>
    </dl></li>
    <?php }?>
...
<div class="help">
    ...
    <img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.$GLOBALS['setting_config']['site_logowx']; ?>" class="f-l jImg img-error">
        				...
        				<div class="weibo f-l">
        					<div class="ic qq" style="padding-left: 0px;"><?php echo uk86_rec(8);?></div>
        					<div class="ic sina" style="padding-left: 0px;"><?php echo uk86_rec(7);?></div>
        				</div>
        			</div>
    			</div>
    		</div>
