    ...
    <div id="ncToolbar" class="nc-appbar">
        <div class="nc-appbar-tabs" id="appBarTabs">
            <?php if ($_SESSION['is_login']) {?>
                <div class="user" nctype="a-barUserInfo">
                    <div class="avatar"><img src="<?php echo uk86_getMemberAvatar($_SESSION['avatar']);?>"/></div>
                    <p>我</p>
                </div>
                <div class="user-info" nctype="barUserInfo" style="display:none;"><i class="arrow"></i>
                    <div class="avatar"><img src="<?php echo uk86_getMemberAvatar($_SESSION['avatar']);?>"/>
                        <div class="frame"></div>
                    </div>
                    <dl>
            ...
            <?php } else {?>
                ...
                <div class="user-login-box" nctype="barLoginBox" style="display:none;"> <i class="arrow"></i> <a href="javascript:void(0);" class="close" nctype="close-barLoginBox" title="关闭">X</a>
                    <form id="login_form" method="post" action="index.php?act=login&op=login" onsubmit="ajaxpost('login_form', '', '', 'onerror')">
                        ...
                        <input name="nchash" type="hidden" value="<?php echo uk86_getNchash('login','index');?>" />
                        <dl>
                        ...
                        <?php if(C('captcha_status_login') == '1') { ?>
                            <dl>
                                <dt><strong>验证码</strong><a href="javascript:void(0)" class="ml5" onclick="javascript:document.getElementById('codeimage').src='<?php echo SHOP_SITE_URL?>/index.php?act=seccode&op=makecode&nchash=<?php echo uk86_getNchash('login','index');?>&t=' + Math.random();">更换验证码</a></dt>
                                <dd>
        ...
        <div class="nc-hidebar" id="ncHideBar">
            <div class="nc-hidebar-bg">
                <?php if ($_SESSION['is_login']) {?>
                    <div class="user-avatar"><img src="<?php echo uk86_getMemberAvatar($_SESSION['avatar']);?>"/></div>
                <?php } else {?>
                    <div class="user-avatar"><img src="<?php echo uk86_getMemberAvatar($_SESSION['avatar']);?>"/></div>
                <?php }?>
                <div class="frame"></div>
...
<div class="public-top-layout w">
    <div class="topbar wrapper">
        <div class="user-entry">
           ...
           <a href="<?php echo uk86_urlShop('member','home');?>"><?php echo $_SESSION['member_name'];?></a>
                ...
                <?php echo $lang['nc_comma'],$lang['welcome_to_site'];?> <a href="<?php echo BASE_SITE_URL;?>"  title="<?php echo $lang['homepage'];?>" alt="<?php echo $lang['homepage'];?>"><span><?php echo $output['setting_config']['site_name']; ?></span></a> <span><a style="color:#e70012" href="<?php echo uk86_urlShop('login','logout');?>"><?php echo $lang['nc_logout'];?></a> </span>
            <?php }else{?>
                <?php echo $lang['nc_hello'].$lang['nc_comma'].$lang['welcome_to_site'];?> <a href="<?php echo BASE_SITE_URL;?>" title="<?php echo $lang['homepage'];?>" alt="<?php echo $lang['homepage'];?>"><?php echo $output['setting_config']['site_name']; ?></a> <span><a style="color:#e70012" href="<?php echo uk86_urlShop('login');?>"><?php echo $lang['nc_login'];?></a></span> <span><a style="color:#e70012" href="<?php echo uk86_urlShop('login','register');?>"><?php echo $lang['nc_register'];?></a></span>
            <?php }?><span style="margin-left:10px;"><?php if($_SESSION['is_login'] == '1'){?><a href="index.php?act=invite" style="color:red;">邀请返利</a><?php }?></span>
            <!-- <span style="margin-left: 10px;"><a href="index.php?act=wheel&op=index" style="color: blue">大转盘</a></span> -->
        </div>
        <div class="quick-menu">
            <dl>
                <dt><a href="<?php echo BASE_SITE_URL;?>/wap">手机优康</a></dt>
                <dd>
                    <?php if (C('mobile_isuse') && C('mobile_app')){?>
                        <div class="head-app" style="margin-top:30px; ">
                            <div class="download-app">
                                ...
                                <div class="addurl">
                                    <?php if (C('mobile_apk')){?>
                                        <a href="<?php echo C('mobile_apk');?>" target="_blank"><i class="icon-android"></i><i>Android</i></a>
                                    <?php } ?>
                                    <?php if (C('mobile_ios')){?>
                                        <a href="<?php echo C('mobile_ios');?>" target="_blank"><i class="icon-apple"></i><i>iPhone</i></a>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
            ...
            <dl>
                <dt><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=show_joinin&op=index" title="免费开店">免费开店</a></dt>
                <dd>
                    <ul>
                        <li><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=show_joinin&op=index" title="招商入驻">招商入驻</a></li>
                        <li><a href="<?php echo uk86_urlShop('seller_login','show_login');?>" target="_blank" title="登录商家管理中心">商家登录</a></li>
                    </ul>
                </dd>
            </dl>
            <dl>
            ...
            <dl>
                <dt><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=member_favorites&op=fglist"><?php echo $lang['nc_favorites'];?></a></dt>
                <dd>
                    <ul>
            ...
            <dl>
                ...
                <dd>
                    <ul>
                        <li><a href="<?php echo uk86_urlShop('article', 'article', array('ac_id' => 2));?>">帮助中心</a></li>
                        <li><a href="<?php echo uk86_urlShop('article', 'article', array('ac_id' => 5));?>">售后服务</a></li>
                        <li><a href="<?php echo uk86_urlShop('article', 'article', array('ac_id' => 6));?>">客服中心</a></li>
                    </ul>
                </dd>
            </dl>
            <?php
                            ...
                            <?php foreach($output['nav_list_top'] as $nav){?>
                                <li><a
                                        ...
                                        switch($nav['nav_type']) {
                                            ...
                                            case '1':echo uk86_urlShop('search', 'index', array('cate_id'=>$nav['item_id']));break;
                                            case '2':echo uk86_urlShop('article', 'article', array('ac_id'=>$nav['item_id']));break;
                                            case '3':echo uk86_urlShop('activity', 'index', array('activity_id'=>$nav['item_id']));break;
                                        }
                                        echo '"';
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $('div[nctype="a-barLoginBox"]').click(function(){
            ...
            document.getElementById('codeimage').src='<?php echo SHOP_SITE_URL?>/index.php?act=seccode&op=makecode&nchash=<?php echo uk86_getNchash('login','index');?>&t=' + Math.random();
        });
