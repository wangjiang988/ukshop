...
<div class="header">
  ...
  <ul class="header_menu">
    <li class="<?php echo $output['show_sign']=='joinin' ? 'current':'';?>"><a href="<?php echo uk86_urlShop('show_joinin', 'index');?>" class="joinin"><i></i>商家入驻申请</a></li>
    <li class=""><a href="<?php echo uk86_urlShop('seller_center', 'index');?>" class="login"><i></i>商家管理中心</a></li>
    <li class="<?php echo $output['show_sign']=='help' ? 'current':'';?>"><a href="<?php echo uk86_urlShop('show_help', 'index');?>" class="faq"><i></i>商家帮助指南</a></li>
  </ul>
</div>
