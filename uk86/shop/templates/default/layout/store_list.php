...
<div class="nc-store-class">
  ...
  <dl>
    ...
    <dd>
      <a href="<?php echo uk86_urlShop('store_list','index');?>">全部</a>
...
<?php foreach($output['store_list'] as $skey => $store){?>
    <li class="item">
      <dl class="shop-info">
        <dt class="shop-name"><a href="<?php echo uk86_urlShop('show_store','', array('store_id'=>$store['store_id']),$store['store_domain']);?>" target="_blank"><?php echo $store['store_name'];?></a></dt>
        <dd class="shop-pic"><a href="<?php echo uk86_urlShop('show_store','', array('store_id'=>$store['store_id']),$store['store_domain']);?>" title="" target="_blank"><span class="size72"><img src="<?php echo uk86_getStoreLogo($store['store_label']);?>"  alt="<?php echo $store['store_name'];?>" title="<?php echo $store['store_name'];?>" class="size72" /></span></a></dd>
      ...
      <dl class="w100" style="background-color: red">
      <dd style="background:url(../image/shop/collect.png) no-repeat 0 0;"></dd>
      </dl>
      ...
      <div class="nc-shop-goodslist" nc_type='goods_<?php echo $skey;?>'>
        ...
        <li>
            <dl>
              <dt class="goods-pic"><span class="thumb size160"> <i></i> <a href="index.php?act=goods&goods_id=<?php echo $v['goods_id'];?>" target="_blank"> <img  onload="javascript:DrawImage(this,160,160);" alt="<?php echo $v['goods_name'];?>" src="<?php echo uk86_thumb($v,'small');?>"></a></span></dt>
              <dd class="goods-name"><a href="<?php echo uk86_urlShop('goods','',array('goods_id'=>$v['goods_id']));?>" title="<?php echo $v['goods_name'];?>" target="_blank"><?php echo $v['goods_name'];?></a></dd>
