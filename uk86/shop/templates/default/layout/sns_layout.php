...
<body>
<?php require_once uk86_template('layout/layout_top');?>
<header id="header" class="pngFix">
  <div class="wrapper">
    ...
    <ul class="menu">
      <li class="noborder"><a href="<?php echo uk86_urlShop('member', 'home');?>"><?php echo $lang['sns_return_my_shop'];?></a></li>
...
<?php
require_once uk86_template('footer');
?>
