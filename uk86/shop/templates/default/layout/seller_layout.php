...
$(document).ready(function(){
    ...
    $('[nctype="btn_add_quicklink"]').on('click', function() {
        ...
        if($quicklink_item.hasClass('selected')) {
            $.post("<?php echo uk86_urlShop('seller_center', 'quicklink_del');?>", { item: item }, function(data) {
            ...
            if(count >= 8) {
                ...
                $.post("<?php echo uk86_urlShop('seller_center', 'quicklink_add');?>", { item: item }, function(data) {
...
<div id="tbox">
  <div class="btn" id="msg"><a href="<?php echo uk86_urlShop('store_msg', 'index');?>"><i class="msg"><?php if ($output['store_msg_num'] > 0) { ?><em><?php echo $output['store_msg_num'];?></em><?php } ?></i>站内消息</a></div>
