...
class flea_classControl extends BaseFleaControl {
	...
	public function indexOp(){
		 ...
		 */
		$navigation=array(
			'index.php?act=flea_class'=>Uk86Language::uk86_get('flea_index_all')
		);
		/*	卖家优先 */
	...
	private function time_comb($goods_add_time){
		...
		if($last_time>2592000)	return intval($last_time/2592000).Uk86Language::uk86_get('flea_index_mouth');
		if($last_time>86400)	return intval($last_time/86400).Uk86Language::uk86_get('flea_index_day');
		if($last_time>3600)		return intval($last_time/3600).Uk86Language::uk86_get('flea_index_hour');
		if($last_time>60)		return intval($last_time/60).Uk86Language::uk86_get('flea_index_minute');
		return $last_time.Uk86Language::uk86_get('flea_index_seconds');
	}
}
