...
class store_promotion_mansongControl extends BaseSellerControl {
    ...
    public function mansong_addOp() {
        ...
        if (uk86_checkPlatformStore()) {
            ...
            if(empty($current_mansong_quota)) {
                uk86_showMessage(Uk86Language::uk86_get('mansong_quota_current_error'),'','','error');
            }
    ...
    public function mansong_delOp() {
        ...
        if($result) {
           ...
           showDialog(L('nc_common_op_succ'), uk86_urlShop('store_promotion_mansong', 'mansong_list'), 'succ');
        } else {
...
//      }
		...
		$mansong_quota_quantity = isset($order['goods_num'])?$order['goods_num']:0; //餐套数量
       ...
       showDialog(Uk86Language::uk86_get('mansong_quota_add_success'), uk86_urlShop('store_promotion_mansong', 'mansong_list'), 'succ');
    }
    ...
    private function profile_menu($menu_key='') {
        $menu_array = array(
            1=>array('menu_key'=>'mansong_list','menu_name'=>Uk86Language::uk86_get('promotion_active_list'),'menu_url'=>uk86_urlShop('store_promotion_mansong', 'mansong_list')),
        );
        switch ($menu_key){
        	case 'mansong_add':
                $menu_array[] = array('menu_key'=>'mansong_add','menu_name'=>Uk86Language::uk86_get('promotion_join_active'),'menu_url'=>uk86_urlShop('store_promotion_mansong', 'mansong_add'));
        		break;
        	case 'mansong_quota_add':
                $menu_array[] = array('menu_key'=>'mansong_quota_add','menu_name'=>Uk86Language::uk86_get('promotion_buy_product'),'menu_url'=>uk86_urlShop('store_promotion_mansong', 'mansong_quota_add'));
        		break;
        	case 'mansong_detail':
                $menu_array[] = array('menu_key'=>'mansong_detail','menu_name'=>Uk86Language::uk86_get('mansong_active_content'),'menu_url'=>uk86_urlShop('store_promotion_mansong', 'mansong_detail', array('mansong_id' => $_GET['mansong_id'])));
        		break;
        }
