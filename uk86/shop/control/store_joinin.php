...
class store_joininControl extends BaseHomeControl
{
    ...
    private function check_joinin_state()
    {
        ...
        if (!empty($joinin_detail)) {
            ...
            //  判断用户申请店铺类型 **** add by Don
            switch (intval($joinin_detail['join_type'])) {
                case STORE_JOIN_TYPE_COMPANY:
                    break;
                case STORE_JOIN_TYPE_PERSON:
                    // 跳转到c2c
    ...
    public function step2Op()
    {
        ...
        if (!empty($_POST)) {
            ...
            //  申请类型
            $param['join_type'] = STORE_JOIN_TYPE_COMPANY;
