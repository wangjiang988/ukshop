...
class compareControl extends BaseHomeControl{
    ...
    public function indexOp() {
        $gids = trim($_GET['gids']);
        if(!$gids){
            $gids = trim(uk86_cookie('comparegoods'));
        }
    ...
    public function addcompareOp(){
        ...
        if (uk86_cookie('comparegoods')) {//如果cookie已经存在
            $comparegoods_str = uk86_cookie('comparegoods');
        ...
        uk86_setNcCookie('comparegoods', $comparegoods_str);
    ...
    public function showcompareOp(){
        ...
        if($gid_arr){
            ...
            if ($goods_listtmp){
                ...
                //更新cookie数据
                uk86_setNcCookie('comparegoods', $goodsid_arr?implode(',',$goodsid_arr):'');
            } else {
                //更新cookie数据
