...
class store_complainControl extends BaseSellerControl{
    ...
    public function __construct() {
        parent::__construct() ;
        Uk86Language::uk86_read('member_layout,member_complain');
    }
    ...
    public function appeal_saveOp() {
        ...
        $obj_validate->validateparam = array(
            array("input"=>$input['appeal_message'], "require"=>"true","validator"=>"Length","min"=>"1","max"=>"255","message"=>Uk86Language::uk86_get('appeal_message_error')),
        );
    ...
    public function apply_handleOp() {
        ...
        uk86_showMessage(Uk86Language::uk86_get('handle_submit_success'),'index.php?act=store_complain');
    }
    ...
    private function profile_menu($menu_key='') {
        $menu_array = array(
            array('menu_key'=>'complain_accused_list','menu_name'=>Uk86Language::uk86_get('complain_manage_title'),'menu_url'=>'index.php?act=store_complain')
        );
