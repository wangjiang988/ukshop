...
class store_callcenterControl extends BaseSellerControl {
	...
	public function saveOp(){
		if(uk86_chksubmit()){
			...
			showDialog(Uk86Language::uk86_get('nc_common_save_succ'), 'index.php?act=store_callcenter', 'succ');
		}
	}
	/**
	 * 用户中心右边，小导航
	...
	private function profile_menu($menu_key) {
		$menu_array	= array(
			1=>array('menu_key'=>'store_callcenter','menu_name'=>Uk86Language::uk86_get('nc_member_path_store_callcenter'),'menu_url'=>'index.php?act=store_callcenter'),
		);
