...
class statistics_goodsControl extends BaseSellerControl {
	...
	public function goodsinfoOp(){
		...
		$stat_count['ordergamount'] = uk86_ncPriceFormat($stat_count['ordergamount']);
    	...
    	$stat_json['ordergoodsnum'] = uk86_getStatData_LineLabels($stat_arr['ordergoodsnum']);
    	...
    	$stat_json['ordergamount'] = uk86_getStatData_LineLabels($stat_arr['ordergamount']);
