...
class goodsControl extends BaseGoodsControl {
    public function __construct() {
        parent::__construct ();
        Uk86Language::uk86_read('store_goods_index');
    }
    ...
    public function salelogOp() {
        ...
        if ($_GET['vr']) {
            ...
            $sales = $model_order->getOrderAndOrderGoodsSalesRecordList(array('order_goods.goods_id'=>$goods_id), 'order_goods.*, order.buyer_name, order.add_time, order.is_anonymous', 10);
        }
    ...
    public function arrival_notice_submitOp() {
        ...
        $js = "ajax_form('arrival_notice', '". $title ."', '" . uk86_urlShop('goods', 'arrival_notice_succ', array('type' => $type)) . "', 480);";
       showDialog('','','js',$js);
    }
