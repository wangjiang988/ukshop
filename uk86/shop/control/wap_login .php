...
<div id="content" class="p_bottom">
	<form action="" id="login_check" method="get">
		...
		<div class="check_submit">
			...
			<a href="index.php?act=wap_login&op=register&url=<?php echo $_GET['url']?$_GET['url']:uk86_getReferer() ?>"><input class="check_submit_2" type="button" value="注册" /></a>
	...
	<div class="ort_login">
		<div class="list_ort_login">
			<ul>
				...
				<li><dl><dt><a href="#"><img src="<?php echo SHOP_TEMPLATES_URL ?>/images/wap/weixin_login.png"></a></dt><dt class="login_name">微信</dt></dl></li>		
			</ul>
		</div>
	</div>
</div>
