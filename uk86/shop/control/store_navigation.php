...
class store_navigationControl extends BaseSellerControl {
    ...
    public function navigation_saveOp() {
       ...
       showDialog(L('nc_common_op_succ'), uk86_urlShop('store_navigation', 'navigation_list'), 'succ');
    }
    ...
    public function navigation_delOp() {
        ...
        if($sn_id > 0) {
           ...
           showDialog(L('nc_common_op_fail'), uk86_urlShop('store_navigation', 'navigation_list'), 'error');
        }
    }
    ...
    private function profile_menu($menu_key = '') {
        ...
        $menu_array[] = array(
            ...
            'menu_name' => '导航列表',
            'menu_url' => uk86_urlShop('store_navigation', 'navigation_list')
        );
        if($menu_key == 'navigation_add') {
            $menu_array[] = array(
                'menu_key' => 'navigation_add',
                'menu_name' => '添加导航',
                'menu_url' => uk86_urlShop('store_navigation', 'navigation_add')
            );
        }
        if($menu_key == 'navigation_edit') {
            $menu_array[] = array(
                ...
                'menu_name' => '编辑导航',
                'menu_url' => uk86_urlShop('store_navigation', 'navigation_edit')
            );
        }
