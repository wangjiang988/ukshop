...
class member_snsfriendControl extends BaseMemberControl {
	public function __construct(){
		parent::__construct();
		Uk86Language::uk86_read('member_sns_friend');
	}
	...
	public function findOp(){
		if(uk86_chksubmit()) {
			...
			if(!empty($mtag_list)){
				...
				// 整理
				$tagmember_list = uk86_array_under_reset($tagmember_list, 'mtag_id', 2);
	...
	public function addfollowOp() {
		...
		if($friend_count >0 ){
			showDialog(Uk86Language::uk86_get('snsfriend_havefollowed'),'','error');
		}
	...
	private function profile_menu($menu_key) {
		$menu_array = array(
			1=>array('menu_key'=>'find',	'menu_name'=>Uk86Language::uk86_get('snsfriend_findmember'),	'menu_url'=>'index.php?act=member_snsfriend&op=find'),
			2=>array('menu_key'=>'follow',	'menu_name'=>Uk86Language::uk86_get('snsfriend_follow'),	'menu_url'=>'index.php?act=member_snsfriend&op=follow'),
			3=>array('menu_key'=>'fan',		'menu_name'=>Uk86Language::uk86_get('snsfriend_fans'),	'menu_url'=>'index.php?act=member_snsfriend&op=fan')
		);
