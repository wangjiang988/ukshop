...
class AlipaySubmit {
	...
	private $parameter;
	public function __construct($alipay_config,$refund_info){
		...
		'batch_num'         => 1,
		'detail_data'	    => $refund_info['trade_no'].'^'.$refund_info['refund_amount'].'^'.'sss',//$refund_info['reason_info'],
...
//     }
     ...
     * @return 提交表单HTML文本
     */
	function buildRequestForm($method='GET', $button_name='正在处理') {
