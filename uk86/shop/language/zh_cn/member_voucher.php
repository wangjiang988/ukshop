...
$lang['voucher_unavailable']    = '卡券包功能尚未开启';
...
$lang['voucher_templateedit']= '编辑卡券包';
$lang['voucher_templateinfo']= '卡券包详细';
/**
 * 套餐申请
 */
...
$lang['voucher_apply_add_tip1']    		= '购买单位为月(30天)，一次最多购买12个月，您可以在所购买周期内以月为单位发布卡券包活动';
...
$lang['voucher_apply_goldlog']    		= '购买卡券包活动%s个月，单价%s金币，总共花费%s金币';
...
$lang['voucher_template_pricelisterror']	= '平台卡券包面额设置出现问题，请联系客服帮助解决';
...
$lang['voucher_template_title']			= '卡券包名称';
...
$lang['voucher_template_styleimg']		= '选择卡券包皮肤';
$lang['voucher_template_styleimg_text']	= '店铺优惠券';
$lang['voucher_template_image']			= '卡券包图片';
$lang['voucher_template_image_tip']		= '该图片将在U币中心的卡券包模块中显示，建议尺寸为160*160px。';
$lang['voucher_template_list_tip1'] = "1、手工设置卡券包失效后,用户将不能领取该卡券包,但是已经领取的卡券包仍然可以使用";
$lang['voucher_template_list_tip2'] = "2、卡券包模版和已发放的卡券包过期后自动失效";
