    ...
    <table class="base-table-style">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><dl class="member-base"><dt class="name"><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=sns_circle&mid=<?php echo $val['member_id'];?>" target="_blank"><?php echo $val['member_name'];?></a></dt><dd class="member-avatar-s"><img src="<?php echo uk86_getMemberAvatarForID($val['member_id']);?>" /></dd>
            </dl></td>
