  ...
  <div class="mainbox">
    ...
    <div class="group-share-goods">
      ...
      <?php foreach($output['goods_list'] as $val){?>
        <li class="item">
          <div class="share-goods-pic thumb"><a href="<?php echo uk86_urlShop('goods', 'index', array('goods_id'=>$val['snsgoods_goodsid']));?>" target="_blank" title="<?php echo $val['snsgoods_goodsname'];?>"><img alt="<?php echo $val['snsgoods_goodsname'];?>" title="<?php echo $val['snsgoods_goodsname'];?>" src="<?php echo uk86_cthumb($val['snsgoods_goodsimage'], 240, $val['snsgoods_storeid']);?>"></a></div>
          <dl class="share-describe">
            <dt class="member-avatar-s"><img src="<?php echo uk86_getMemberAvatarForID($val['share_memberid']);?>" /></dt>
