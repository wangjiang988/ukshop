...
<div class="group-top">
  <dl class="circle-info">
    ...
    <dd class="pic"><a href="<?php echo CIRCLE_SITE_URL;?>/index.php?act=group&c_id=<?php echo $output['c_id'];?>"><img src="<?php echo uk86_circleLogo($output['circle_info']['circle_id']);?>"/></a></dd>
    ...
    <dd class="manage">
      ...
      <span class="moderator">
        ...
        <?php if($val['member_id'] == $_SESSION['member_id']){ $ok = true; } ?>
