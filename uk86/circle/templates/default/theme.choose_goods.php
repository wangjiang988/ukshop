...
<div class="choose-goods">
    ...
    <ul id="mycarousel1" class="jcarousel-skin-tango">
      ...
      <li><a href="javascript:void(0);"
				data-param="{'id':'<?php echo $v['goods_id'];?>','name':'<?php echo $v['goods_name'];?>','price':'<?php echo $v['goods_price'];?>','storeid':'<?php echo $v['store_id'];?>','img':'<?php echo uk86_thumb($v, 60);?>','image':'<?php echo $v['goods_image'];?>','uri':'<?php echo uk86_urlShop('goods', 'index', array('goods_id'=>$v['goods_id']));?>','type':0}">
					<img title="<?php echo $v['goods_name']?>"
					src="<?php echo uk86_thumb($v, 240);?>" />
    ...
    <ul id="mycarousel2" class="snsgoodsimglist jcarousel-skin-tango">
      ...
      <li><a href="javascript:void(0);"
				data-param="{'id':'<?php echo $v['goods_id'];?>','name':'<?php echo $v['goods_name'];?>','price':'<?php echo $v['goods_price'];?>','storeid':'<?php echo $v['store_id'];?>','img':'<?php echo uk86_thumb($v, 60);?>','image':'<?php echo $v['goods_image'];?>','uri':'<?php echo uk86_urlShop('goods', 'index', array('goods_id'=>$v['goods_id']));?>','type':0}"><img
