...
<div class="public-top-layout w">
  <div class="topbar wrapper">
    ...
    <?php if($_SESSION['is_login'] == '1'){?>
      <?php echo $lang['nc_hello'];?><span><a href="<?php echo uk86_urlShop('member', 'home');?>"><?php echo uk86_str_cut($_SESSION['member_name'],20);?></a></span><?php echo $lang['nc_comma'],$lang['welcome_to_site'];?>
      ...
      <span>[<a href="<?php echo uk86_urlShop('login','logout');?>"><?php echo $lang['nc_logout'];?></a>]</span>
    <?php }else{?>
      ...
      <a href="<?php echo SHOP_SITE_URL;?>" title="<?php echo $lang['homepage'];?>" alt="<?php echo $lang['homepage'];?>"><?php echo $output['setting_config']['site_name']; ?></a>
       <span>[<a href="<?php echo uk86_urlShop('login');?>"><?php echo $lang['nc_login'];?></a>]</span>
        <span>[<a href="<?php echo uk86_urlShop('login','register');?>"><?php echo $lang['nc_register'];?></a>]</span>
    <?php }?></div>
...
<header id="topHeader">
  <div class="warp-all">
    ...
    <div class="circle-user">
      ...
      <div class="head-portrait"><span class="thumb size20"> <?php if ($output['super']) {?><i title="超级管理员"></i><?php }?><img src="<?php  echo uk86_getMemberAvatarForID($_SESSION['member_id']);?>" /></span></div>
