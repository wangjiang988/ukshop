      ...
      <div class="post-btn"><a href="index.php?act=theme&op=new_theme&c_id=<?php echo $output['c_id'];?>" class="new-theme"><i></i><?php echo $lang['circle_new_theme'];?></a>
        <div class="sub-menu"><span class="arrow"></span>
          <ul>
            ...
            <li class="new-poll"><a href="index.php?act=theme&op=new_theme&sp=2&c_id=<?php echo $output['c_id'];?>"><i class="new_biao_ming"></i>新报名</a></li>
          </ul>
        </div>
      </div>
    </div>
        ...
        <ul class="group-theme-list">
          ...
          <li nctype="li<?php echo $val['theme_id'];?>">
            ...
            <div class="theme-title">
              ...
              <?php }?>
              <?php if($val['theme_special'] == 0){ echo '';}elseif ($val['theme_special'] == 1){echo '【报】';}else{echo '【票】';}?>
            ...
            <div class="theme-intro">
              ...
              <div class="theme-intro-pic">
                ...
                <div class="thumb"><a href="javascript:void(0);" class="read-unfold"><img src="<?php echo uk86_themeImageUrl($v['affix_filethumb']);?>" class="t-img"/> </a> <span nctype="theme_read"><?php echo $lang['circle_click_image_unfold'];?></span></div>
                <?php }?>
              </div>
              <?php }?>
              <?php }?>
