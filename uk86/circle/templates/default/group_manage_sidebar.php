...
<div class="my-info">
  <div class="avatar"><img src="<?php echo uk86_getMemberAvatarForID($_SESSION['member_id']);?>" /><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=member_information&op=avatar" title="<?php echo $lang['nc_edit_avatar'];?>"><?php echo $lang['nc_edit_avatar'];?></a></div>
  <dl>
    <dt>
...
<div class="side-tab-nav">
  ...
  <div class="my-circle-list tabs-panel">
    ...
    <dl <?php if($val['is_identity'] == 3){?>nctype="member"<?php }?>>
      ...
      <dd class="pic"><span class="thumb size50"><i></i><a href="javascript:void(0);"><img src="<?php echo uk86_circleLogo($val['circle_id']);?>" /></a></span></dd>
