...
<style type="text/css">
.readperm{display:none;}
</style>
<div class="group warp-all">
  <?php require_once circle_template('group.top');?>
  <div class="theme-editor">
    <form method="post" id="theme_form" action="<?php echo CIRCLE_SITE_URL;?>/index.php?act=theme&op=save_theme&sp=2&c_id=<?php echo $output['c_id'];?>">
      ...
      <div class="quick-thread">
        <div class="base-tab-menu">
          <ul class="base-tabs-nav">
            ...
            <li class="selected"><a href="javasctipt:void(0);">新报名</a></li>
          </ul>
        </div>
        <div class="quick-thread-box">
          ...
          <div class="bottom"> 
            <a class="submit-btn" nctype="theme_submit" href="Javascript: void(0)"><?php echo $lang['nc_release_new_theme'];?></a> 
            <a class="cancel-btn" nctype="theme_cancle" href="Javascript:history.go(-1);"><?php echo $lang['nc_cancel'];?></a>
            <div id="warning"></div>
        </div>
      </div>
    </form>
