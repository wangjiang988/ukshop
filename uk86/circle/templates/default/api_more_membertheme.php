...
<ul class="circle-more-membertheme">
  ...
  <li class="circle-member-item">
    <div class="circle-member-avatar"> <a target="_blank" href="<?php echo SHOP_SITE_URL;?>/index.php?act=sns_circle&mid=<?php echo $value['member_id'];?>" target="_blank"> <img src="<?php echo uk86_getMemberAvatarForID($value['member_id']);?>" /> </a> </div>
