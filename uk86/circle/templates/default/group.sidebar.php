...
<div class="sidebar">
  ...
  <div class="my-info">
    <div class="avatar"><img src="<?php echo uk86_getMemberAvatarForID($output['cm_info']['member_id']);?>"/><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=member_information&op=avatar" title="<?php echo $lang['nc_edit_avatar'];?>"><?php echo $lang['nc_edit_avatar'];?></a></div>
    <dl>
      <dt>
  ...
  <div class="side-tab-nav">
    ...
    <div class="sidebar-circle-member tabs-panel">
      ...
      <dl>
        ...
        <dd class="member-avatar-s"><img src="<?php echo uk86_getMemberAvatarForID($val['member_id']);?>" /><em></em></dd>
    ...
    <div class="sidebar-circle-member tabs-panel tabs-hide">
      ...
      <dl>
        <dt class="member-name"><a target="_blank" href="<?php echo SHOP_SITE_URL;?>/index.php?act=sns_circle&mid=<?php echo $val['member_id'];?>"><?php echo $val['member_name'];?></a></dt>
        <dd class="member-avatar-s"><img src="<?php echo uk86_getMemberAvatarForID($val['member_id']);?>" /></dd>
        <dd class="theme-num" title="<?php echo $lang['circle_theme_count'];?>">(<b><?php echo $val['cm_thcount'];?></b>)</dd>
      </dl>
      <?php }?>
      <?php }?>
  ...
  <div class="sidebar-box">
    ...
    <div class="content">
      <ul class="sidebar-circle-links">
        ...
        <li><span class="thumb size32"><i></i><a href="<?php echo CIRCLE_SITE_URL;?>/index.php?act=group&c_id=<?php echo $val['friendship_id'];?>" title="<?php echo $val['friendship_name'];?>"><img src="<?php echo uk86_circleLogo($val['friendship_id']);?>" /></a></span></li>
        <?php }?>
      </ul>
    </div>
  </div>
