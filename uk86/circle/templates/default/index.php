...
<div class="homepage warp-all">
  ...
  <div class="layout-r">
    ...
    <dl class="member-me-info">
      ...
      <dd class="avatar"><img src="<?php  echo uk86_getMemberAvatarForID($_SESSION['member_id']);?>" /><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=member_information&op=avatar" title="<?php echo $lang['nc_edit_avatar'];?>"><?php echo $lang['nc_edit_avatar'];?></a></dd>
      ...
      <ul class="group-list">
        ...
        <li>
          <dl>
            ...
            <dd class="group-pic"><a href="<?php echo CIRCLE_SITE_URL;?>/index.php?act=group&c_id=<?php echo $val['circle_id'];?>"><img src="<?php echo uk86_circleLogo($val['circle_id']);?>" /></a></dd>
          ...
          <ul class="new-theme">
            ...
            <li>
              <dl>
                ...
                <dd class="member-avatar-s"><img src="<?php echo uk86_getMemberAvatarForID($v['member_id']);?>"/></dd>
  ...
  <div class="warp-all recommend-group">
    ...
    <div class="content">
      <ul id="mycarousel1" class="jcarousel-skin-tango">
        ...
        <li title="<?php echo $val['circle_name'];?>"><img src="<?php echo uk86_circleLogo($val['circle_id']);?>" /><a href="<?php echo CIRCLE_SITE_URL;?>/index.php?act=group&c_id=<?php echo $val['circle_id'];?>">
      ...
      <div class="recommend-theme">
        ...
        <div class="content show-goods">
          ...
          <dl>
            ...
            <dd class="member-avatar"><img src="<?php echo uk86_getMemberAvatarForID($val['member_id']);?>"/></dd>
      ...
      <div class="good-member clearfix">
        ...
        <div class="contnet special">
          <dl class="member-info">
            ...
            <dd class="avatar thumb"><a target="_blank" href="<?php echo SHOP_SITE_URL;?>/index.php?act=sns_circle&mid=<?php echo $output['one_member']['member_id'];?>"><img src="<?php echo uk86_getMemberAvatarForID($output['one_member']['member_id']);?>"  class="t-img"/></a></dd>
        ...
        <div class="contnet normal">
          ...
          <dl class="member-info">
            ...
            <dd class="avatar"><a target="_blank" href="<?php echo SHOP_SITE_URL;?>/index.php?act=sns_circle&mid=<?php echo $val['member_id'];?>"><img src="<?php echo uk86_getMemberAvatarForID($val['member_id']);?>"/></a></dd>
