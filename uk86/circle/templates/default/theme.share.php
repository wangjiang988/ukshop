  ...
  <form method="post" action="<?php echo CIRCLE_SITE_URL;?>/index.php?act=theme_share&c_id=<?php echo $output['c_id'];?>&t_id=<?php echo $output['t_id'];?>" id="share_form" class="feededitor">
    ...
    <dl class="share-target">
      ...
      <dd class="cover">
        ...
        <a href="Javascript: void(0);"><img src="<?php echo uk86_themeImageUrl($val['affix_filethumb']);?>"/></a>
        <?php }?>
        <?php }?>
      </dd>
      ...
      <dd class="abstract"><?php echo uk86_removeUBBTag($output['theme_info']['theme_content']);?></dd>
    </dl>
    <!-- 站外分享 -->
