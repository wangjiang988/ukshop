    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          ...
          <td class="vatop tips"><span class="vatop rowform">默认网站LOGO,通用头部显示，最佳显示尺寸为410*80像素</span></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
          ...
          <td class="vatop tips"><span class="vatop rowform">会员个人主页显示，最佳显示尺寸为410*80像素</span></td>
        </tr>
        <!-- 商家中心logo -->
        <tr>
...
<tr>
        ...
        <!-- 后台关于我们设置 -->
        <tr>
          <td colspan="2" class="required"><label for="aboutus">关于我们设置:</label></td>
        </tr> 
        <tr class="noborder">
          <td class="vatop rowform"><textarea name="aboutus" rows="6" class="tarea" id="aboutus"><?php echo $output['list_setting']['aboutus'];?></textarea></td>
          <td class="vatop tips"><span class="vatop rowform">关于我们的后台设置</span></td>
        </tr> 
        <tr>
