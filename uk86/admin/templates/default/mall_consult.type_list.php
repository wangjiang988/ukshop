...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3>平台客服</h3>
      <ul class="tab-base">
        <li><a href="<?php echo uk86_urlAdmin('mall_consult', 'index');?>"><span>平台客服咨询列表</span></a></li>
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        <tr>
          ...
          <td class="align-center"><a href="<?php echo uk86_urlAdmin('mall_consult', 'type_edit', array('mct_id' => $value['mct_id']));?>">编辑</a>&nbsp;|&nbsp;<a href="<?php echo uk86_urlAdmin('mall_consult', 'type_del', array('mct_id' => $value['mct_id']));?>">删除</a></td>
        </tr>
      </tbody>
      <?php }?>
      <?php }else{?>
