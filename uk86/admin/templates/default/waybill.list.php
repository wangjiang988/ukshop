    ...
    <table class="table tb-type2">
      ...
      <tbody id="treet1">
        ...
        <tr class="hover">
          ...
          <td class="nowrap align-center"><a href="<?php echo uk86_urlAdmin('waybill', 'waybill_design', array('waybill_id' => $value['waybill_id']));?>">设计</a>&nbsp;|&nbsp;<a href="<?php echo uk86_urlAdmin('waybill', 'waybill_test', array('waybill_id' => $value['waybill_id']));?>" target="_blank">测试</a>&nbsp;|&nbsp;<a href="<?php echo uk86_urlAdmin('waybill', 'waybill_edit', array('waybill_id' => $value['waybill_id']));?>">编辑</a>&nbsp;|&nbsp;<a href="javascript:;" nctype="btn_del" data-waybill-id="<?php echo $value['waybill_id'];?>">删除</a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
...
<form id="del_form" action="<?php echo uk86_urlAdmin('waybill', 'waybill_del');?>" method="post">
