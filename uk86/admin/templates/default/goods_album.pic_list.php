      ...
      <tbody>
        <tr>
          ...
          <td><a href="javascript:document.formSearch.submit();" class="btn-search " title="<?php echo $lang['nc_query'];?>">&nbsp;</a>
            ...
            <a class="btns" href="<?php echo uk86_urlShop('show_store','index', array('store_id'=>$output['list'][0]['store_id']));?>"><span><?php echo $output['store_name'];?></span></a>
            <?php }?>
          </td>
        </tr>
      </tbody>
          ...
          <li class="picture">
            <div class="size-64x64">
              <span class="thumb">
                <i></i>
				<?php if($v['apic_cover'] != ''){ ?>
				<a nctype="nyroModal"  href="<?php echo uk86_cthumb($v['apic_cover'], 1280, $v['store_id']);?>" rel="gal"><img title="<?php echo date('Y-m-d',$v['upload_time']); ?><br/><?php echo $v['apic_spec']; ?>px<br/><?php echo number_format($v['apic_size']/1024,2);?>k" width="64" height="64"  class="tip" src="<?php echo uk86_cthumb($v['apic_cover'], 60, $v['store_id']);?>" /></a>
				<?php }else{?>
