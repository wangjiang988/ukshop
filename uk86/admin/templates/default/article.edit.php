...
<div class="page">
  ...
  <form id="article_form" method="post">
    ...
    <input type="hidden" name="ref_url" value="<?php echo uk86_getReferer();?>" />
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td colspan="2" class="vatop rowform"><?php uk86_showEditor('article_content',$output['article_array']['article_content']);?></td>
        </tr>
        <tr>
