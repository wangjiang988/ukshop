...
<div class="page">
  ...
  <div class="chat-log">
    <ul class="chat-log-list">
      ...
      <li class="from_log"><span class="avatar"><img src="<?php echo uk86_getMemberAvatarForID($val['f_id']);?>"/></span>
        ...
        <dl>
          ...
          <dd class="content"><?php echo uk86_parsesmiles($val['t_msg']);?></dd>
        </dl>
        <?php } else { ?>
        <dl>
      ...
      <?php } else { ?>
      <li class="to_log"><span class="avatar"><img src="<?php echo uk86_getMemberAvatarForID($val['f_id']);?>"/></span>
