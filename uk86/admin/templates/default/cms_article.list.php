    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="w60 picture"><div class="size-56x56"><span class="thumb size-56x56"><i></i><img onload="javascript:DrawImage(this,56,56);" src="<?php echo uk86_getCMSArticleImageUrl($val['article_attachment_path'], $val['article_image']);?>"></span></div></td>
