...
<div class="page">
  ...
  <table class="table tb-type2">
    ...
    <?php if(!empty($output['evalgoods_list'])){?>
      ...
      <tr class="hover">
        <td><a href="<?php echo uk86_urlShop('goods','index',array('goods_id'=>$v['geval_goodsid']));?>" target="_blank"><?php echo $v['geval_goodsname'];?></a></td>
...
<form id="submit_form" action="<?php echo uk86_urlAdmin('evaluate', 'evalgoods_del');?>" method="post">
