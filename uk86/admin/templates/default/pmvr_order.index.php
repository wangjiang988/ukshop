...
<div class="page">
  ...
  <form method="get" action="index.php" name="formSearch" id="formSearch">
    <input type="hidden" name="act" value="pmvr_order" />
  ...
  <table class="table tb-type2 nobdb">
    ...
    <tbody>
      ...
      <tr class="hover">
        ...
        <td class="align-center"><?php echo uk86_orderPaymentName($order['payment_code']);?></td>
        <td class="align-center"><?php echo $order['state_desc'];?></td>
        <td class="w144 align-center"><a href="index.php?act=pmvr_order&op=show_order&order_id=<?php echo $order['order_id'];?>"><?php echo $lang['nc_view'];?></a>

            <!-- 取消订单 -->
    		<?php if($order['if_cancel']) {?>
        	| <a href="javascript:void(0)" onclick="if(confirm('<?php echo $lang['order_confirm_cancel'];?>')){location.href='index.php?act=pmvr_order&op=change_state&state_type=cancel&order_id=<?php echo $order['order_id']; ?>'}">
        	<?php echo $lang['order_change_cancel'];?></a>
        	<?php }?>

        	<!-- 收款 -->
    		<?php if($order['if_system_receive_pay']) {?>
	        	| <a href="index.php?act=pmvr_order&op=change_state&state_type=receive_pay&order_id=<?php echo $order['order_id']; ?>">
