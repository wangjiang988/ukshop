...
<div class="page">
  ...
  <div class="info-panel">
    <dl class="member">
      ...
      <dd>
        <ul>
          <li class="w50pre normal" style="width:100%" ><a href="index.php?act=member&op=member"><?php echo $lang['dashboard_wel_new_add'];?><sub><em id="statistics_week_add_member"></em></sub></a></li>
        </ul>
      </dd>
    </dl>
    <dl class="shop">
    ...
    <dl class="goods">
      ...
      <dd>
        <ul>
          ...
          <li class="w25pre none"><a href="<?php echo uk86_urlAdmin('goods','goods',array('type'=>'waitverify', 'search_verify' => 10));?>">商品审核<sub><em id="statistics_product_verify">0</em></sub></a></li>
    ...
    <dl class="operation">
      ...
      <dd>
        <ul>
          ...
          <li class="w17pre none"><a href="<?php echo uk86_urlAdmin('mall_consult', 'index');?>">平台客服<sub><em id="statistics_mall_consult">0</em></sub></a></li>
          <li class="w17pre none"><a href="<?php echo uk86_urlAdmin('delivery', 'index', array('sign' => 'verify'));?>">服务站<sub><em id="statistics_delivery_point">0</em></sub></a></li>
        </ul>
      </dd>
    </dl>
    ...
    <dl class="cms">
      ...
      <dd>
        <ul>
          <li class="w33pre none"><a href="<?php echo uk86_urlAdmin('cms_article', 'cms_article_list_verify');?>">文章审核<sub><em id="statistics_cms_article_verify">0</em></sub></a></li>
          <li class="w33pre none"><a href="<?php echo uk86_urlAdmin('cms_picture', 'cms_picture_list_verify');?>">画报审核<sub><em id="statistics_cms_picture_verify">0</em></sub></a></li>
          <li class="w34pre none"><a href="<?php echo uk86_urlAdmin('cms_comment', 'comment_manage');?>">评论<sub></sub></a></li>
        </ul>
      </dd>
    </dl>
    <?php }?>
    ...
    <dl class="circle">
      ...
      <dd>
        <ul>
          <li class="w33pre none"><a href="<?php echo uk86_urlAdmin('circle_manage', 'circle_verify');?>">圈子申请<sub><em id="statistics_circle_verify">0</em></sub></a></li>
          <li class="w33pre none"><a href="<?php echo uk86_urlAdmin('circle_theme', 'theme_list');?>">话题</a></li>
          <li class="w34pre none"><a href="<?php echo uk86_urlAdmin('circle_inform', 'inform_list');?>">举报</a></li>
        </ul>
      </dd>
    </dl>
    <?php }?>
 ...
 <!--  <dl class="microshop">
      ...
      <dd>
        <ul>
          <li class="w33pre none"><a href="<?php echo uk86_urlAdmin('microshop', 'goods_manage');?>">随心看</a></li>
          <li class="w33pre none"><a href="<?php echo uk86_urlAdmin('circle_theme', 'theme_list');?>">个人秀</a></li>
          <li class="w34pre none"><a href="<?php echo uk86_urlAdmin('circle_inform', 'inform_list');?>">店铺街</a></li>
        </ul>
      </dd>
    </dl> -->  
    <?php }?>
    <dl class="system">
      <dt>
        ...
        <div id="system-info">
          <ul>
            <li>优康商城 <?php echo $lang['dashboard_welcome_version'];?><span>20150315</span></li>
      ...
      <dd>
        <ul>
          <li class="w50pre none"><a href="http://www.ukshop.com" target="_blank">官方网站<sub></sub></a></li>
          <li class="w50pre none"><a href="http://www.ukshop.com" target="_blank">官方论坛<sub></sub></a></li>
        </ul>
      </dd>
    </dl>
    <div class="clear"></div>
