  ...
  <form id="list_form" method="post">
    ...
    <table class="table tb-type2">
      ...
      <tbody id="treet1">
        ...
        <tr class="hover">
          <td class="align-left"><a href="<?php echo uk86_urlShop('show_store', 'index', array('store_id' => $val['store_id']));?>" ><span><?php echo $val['store_name'];?></span></a>
...
<?php } ?>
          ...
          <td class="nowrap align-center">
          	<a target="block" href="<?php echo uk86_urlShop('goods', 'index', array('goods_id' => $val['goods_id']));?>"><?php echo $lang['nc_view'];?></a>
          	<a href="<?php echo uk86_urlAdmin('promotion_bundling', 'del_bundling', array('bl_id' => $val['bl_id']));?>"><?php echo $lang['nc_del'];?></a>
          </td>
        </tr>
        <?php } ?>
        <?php }else { ?>
