...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3>圈子话题分类管理</h3>
      <ul class="tab-base">
        <li><a href="index.php?act=circle_theme&op=theme_class_list"><span><?php echo $lang['nc_manage'];?></span></a></li>
  ...
  <form id="class_form" method="post">
    ...
    <input type="hidden" name="class_id" value="<?php echo $output['class_info']['thclass_id'];?>" />
    <table class="table tb-type2">
      <tbody>
        <tr class="noborder">
          <td colspan="2" class="required"><label class="validation" for="class_name">圈子话题分类名称:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" name="class_name" id="class_name" class="txt" value="<?php echo $output['class_info']['thclass_name'];?>" /></td>
          <td class="vatop tips">不能超过四个字符</td>
        </tr>
       <!-- <tr>
        ...
        <tr class="noborder">
          <td class="vatop rowform onoff">
            <label for="site_status1" class="cb-enable <?php if($output['class_info']['thclass_status'] == '1'){?>selected<?php }?>" ><span><?php echo $lang['open'];?></span></label>
            <label for="site_status0" class="cb-disable <?php if($output['class_info']['thclass_status'] == '0'){?>selected<?php }?>" ><span><?php echo $lang['close'];?></span></label>
            <input id="site_status1" name="status" <?php if($output['class_info']['thclass_status'] == '1'){?>checked="checked"<?php }?> value="1" type="radio">
            <input id="site_status0" name="status" <?php if($output['class_info']['thclass_status'] == '0'){?>checked="checked"<?php }?> value="0" type="radio"></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
