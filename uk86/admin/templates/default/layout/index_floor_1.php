<style>
    .home-templates-board-layout dd.act-pic {
        height: 375px;
    }
    ...
    .ps-container .goods-list li img {
        width: 100%;
        height: 100%;
    }
...
<table id="layout_style" class="table tb-type2 nohover">    <!--模板编辑-->
    <tbody>
      <tr>
    ...
    <td colspan="2" class="vatop"><div class="home-templates-board-layout style-<?php echo $output['web_array']['style_name'];?>">
            <div class="left">
                <dl id="left_tit" style="display:none">   <!--标题图片设置-->
                    <dt>
                            ...
                            <dl recommend_id="<?php echo $key;?>">
                                   ...
                                   <!-- <a href="JavaScript:show_recommend_pic_dialog(<?php /*echo $key;*/?>);"><i class="icon-lightbulb"></i><?php /*echo '广告块';*/?></a>-->
                                    ...
                                    <?php }else { ?>
                                      <dd  style="height:400px;">
                                        <ul class="goods-list">
                                            <li style="height:200px;"><span><i class="icon-gift"></i></span></li>
                                            <li style="height:200px;"><span><i class="icon-gift"></i></span></li>
                                            <li style="height:200px;"><span><i class="icon-gift"></i></span></li>
                                            <li style="height:200px;"><span><i class="icon-gift"></i></span></li>
                                            <li style="height:200px;"><span><i class="icon-gift"></i></span></li>
            ...
            <div class="right">
                <dl>
                    <dt>
                    <h4>右侧推荐</h4>
                    <a href="JavaScript:show_dialog('upload_adv');"><i class="icon-ticket"></i><?php echo $lang['nc_edit'];?></a></dt>
                    <dd>
                        <ul>
                            <?php if (is_array($output['code_adv']['code_info']) && !empty($output['code_adv']['code_info'])) { ?>
                                <?php foreach ($output['code_adv']['code_info'] as $key => $val) { ?>
                                    <li><img style="height: 130px; width: 210px;" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_img'];?>"/></li>
                                <?php } ?>
                            <?php }else { ?>
                                <li>
...
<div id="upload_adv_dialog" class="upload_adv_dialog" style="display:none;">
    <form id="upload_adv_form" name="upload_adv_form" enctype="multipart/form-data" method="post" action="index.php?act=web_api&op=slide_adv" target="upload_pic">
        ...
        <dd>
            ...
            <div class="s-tips"><i></i><?php echo '小提示：单击图片选中修改，拖动可以排序，最少保留1个，最多可加3个，保存后生效。';?></div>
            ...
            <div class="add-adv"><a class="btn-add-nofloat" href="JavaScript:add_slide_adv();"><?php echo '新增图片';?></a>(最多3个)</div>
        </dd>
...
<script src="<?php echo RESOURCE_SITE_URL;?>/web_config/web_index_1.js"></script>