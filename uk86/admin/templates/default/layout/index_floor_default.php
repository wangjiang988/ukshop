...
<tfoot>
<tr class="tfoot">
    <td colspan="2" ><a href="index.php?act=web_config&op=web_html&web_id=<?php echo $_GET['web_id'];?>&web_style=<?php echo $_GET['style'];?>" class="btn" id="submitBtn"><span><?php echo $lang['web_config_web_html'];?></span></a></td>       <!--更新板块信息-->
</tr>
</tfoot>
</table>
<!-- 标题图片 -->
