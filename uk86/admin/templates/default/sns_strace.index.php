              ...
              <div class="fd-aside">
              	<span class="thumb size60">
					<a href="<?php echo SHOP_SITE_URL;?>/index.php?act=store_snshome&sid=<?php echo $v['strace_storeid'];?>" target="_blank">
						<img onload="javascript:DrawImage(this,60,60);" src="<?php echo uk86_getStoreLogo($v['strace_storelogo']); ?>">
					</a>
              	</span>
              </div>
              <dl class="fd-wrap">
                <dt>
					...
					<h5><?php echo uk86_parsesmiles($v['strace_title']);?></h5>
                </dt>
                <dd>
                  <?php echo uk86_parsesmiles($v['strace_content']);?>
                </dd>
                <dd>
