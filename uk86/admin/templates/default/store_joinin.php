            ...
            <tr>
                    ...
                    <select name="grade_id">
                        ...
                        <?php if (!empty($output['grade_list']) && is_array($output['grade_list'])) { ?>
                            <?php foreach ($output['grade_list'] as $k => $v) { ?>
                                <option value="<?php echo $v['sg_id']; ?>" <?php if ($v['sg_id'] == $_GET['grade_id']) {
                                    echo 'selected';
                                } ?>><?php echo $v['sg_name']; ?></option>
                            <?php } ?>
                        <?php } ?>
                    </select></td>
                <td>
                <th><label><?php echo $lang['join_type']; ?></label></th>
                <td>
                    <select name="join_type">
                        <option value=""><?php echo $lang['join_type']; ?>...</option>
                        <?php if (!empty($output['joinin_type_array']) && is_array($output['joinin_type_array'])) { ?>
                            <?php foreach ($output['joinin_type_array'] as $k => $v) { ?>
                                <option value="<?php echo $k; ?>" <?php if ($k == $_GET['join_type']) {
                                    echo 'selected';
                                } ?>><?php echo $v; ?></option>
                            <?php } ?>
                        <?php } ?>
                    ...
                    <select name="joinin_state">
                        ...
                        <?php if (!empty($output['joinin_state_array']) && is_array($output['joinin_state_array'])) { ?>
                            <?php foreach ($output['joinin_state_array'] as $k => $v) { ?>
                                <option value="<?php echo $k; ?>" <?php if ($k == $_GET['joinin_state']) {
                                    echo 'selected';
                                } ?>><?php echo $v; ?></option>
                            <?php } ?>
                        <?php } ?>
                ...
                <td><a href="javascript:document.formSearch.submit();" class="btn-search "
                    ...
                    <?php if ($output['owner_and_name'] != '' or $output['store_name'] != '' or $output['grade_id'] != '') { ?>
                        <a href="index.php?act=store&op=store_joinin" class="btns "
