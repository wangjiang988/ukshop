    ...
    <table class="table tb-type2">
      ...
      <tbody id="treet1">
        ...
        <tr class="hover">
          ...
          <td class="nowrap align-center"><a href="<?php echo uk86_urlAdmin('mb_special', 'special_edit', array('special_id' => $value['special_id']));?>">编辑</a>&nbsp;|&nbsp; <a href="javascript:;" nctype="btn_del" data-special-id="<?php echo $value['special_id'];?>">删除</a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
...
<form id="del_form" action="<?php echo uk86_urlAdmin('mb_special', 'special_del');?>" method="post">
  <input type="hidden" id="del_special_id" name="special_id">
</form>
<div id="dialog_add_mb_special" style="display:none;">
  <form id="add_form" method="post" action="<?php echo uk86_urlAdmin('mb_special', 'special_save');?>">
    <table class="table tb-type2">
      <tbody>
        <tr class="noborder">
