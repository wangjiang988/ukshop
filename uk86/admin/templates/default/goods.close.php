...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="<?php echo uk86_urlAdmin('goods', 'goods');?>" ><span><?php echo $lang['goods_index_all_goods'];?></span></a></li>
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo $lang['goods_index_lock_goods'];?></span></a></li>
        <li><a href="<?php echo uk86_urlAdmin('goods', 'goods', array('type' => 'waitverify'));?>"><span>等待审核</span></a></li>
        <li><a href="<?php echo uk86_urlAdmin('goods', 'goods_set');?>"><span><?php echo $lang['nc_goods_set'];?></span></a></li>
      </ul>
    </div>
  </div>
  ...
  <form method='post' id="form_goods" action="<?php echo uk86_urlAdmin('goods', 'goods_del');?>">
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="w60"><div class="goods-picture"><span class="thumb size-goods"><i></i><img src="<?php echo uk86_thumb($v, 60);?>" onload="javascript:DrawImage(this,56,56);"/></span></div></td>
          ...
          <td class="align-center"><p><?php echo $output['state'][$v['goods_state']];?></p>
            ...
            <?php }?></td>
          <td class="w48 align-center"><a href="<?php echo urlShop('goods', 'index', array('goods_id' => $output['storage_array'][$v['goods_commonid']]['goods_id']));?>" target="_blank"><?php echo $lang['nc_view'];?></a>&nbsp;|&nbsp;<a href="javascript:void(0);" nctype="del_batch" uri="<?php echo uk86_urlAdmin('goods', 'goods_del', array('goods_id' => $v['goods_commonid']));?>"><?php echo $lang['nc_del'];?></a></td>
        </tr>
