    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td><span title="<?php echo $v['adv_title']; ?>"><?php echo uk86_str_cut($v['adv_title'], '36'); ?></span></td>
          <?php
				 foreach ($output['ap_info'] as $ap_k => $ap_v){
				 	if($v['ap_id'] == $ap_v['ap_id']){
				 		?>
          <td><span title="<?php echo $ap_v['ap_name']; ?>"><?php echo uk86_str_cut($ap_v['ap_name'], '22'); ?></span></td>
