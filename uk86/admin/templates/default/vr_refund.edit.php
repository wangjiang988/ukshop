  ...
  <form id="post_form" method="post" action="index.php?act=vr_refund&op=edit&refund_id=<?php echo $output['refund']['refund_id']; ?>">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><?php echo uk86_ncPriceFormat($output['refund']['refund_amount']); ?></td>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><a href="<?php echo uk86_urlShop('goods','index',array('goods_id'=> $output['refund']['goods_id']));?>" target="_blank"><?php echo $output['refund']['goods_name']; ?></a></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
