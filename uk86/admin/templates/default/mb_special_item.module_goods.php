...
<div class="index_block goods-list">
  ...
  <div nctype="item_content" class="content">
    ...
    <div nctype="item_image" class="item">
      <div class="goods-pic"><img nctype="goods_image" src="<?php echo uk86_cthumb($item_value['goods_image']);?>" alt=""></div>
...
<script id="item_goods_template" type="text/html">
    <div nctype="item_image" class="item">
		...
		<input nctype="goods_marketprice" name="item_data[item][]" type="hidden" value="<%=goods_marketprice%>">
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#btn_mb_special_goods_search').on('click', function() {
            var url = '<?php echo uk86_urlAdmin('mb_special', 'goods_list');?>';
...
//             item.goods_marketprice = $(this).attr('data-goods-marketprice');
//             item.goods_fcode = $(this).attr('data-goods-fcode');
//             item.goods_promotion = $(this).attr('data-goods-promotion');
