  ...
  <tbody>
    ...
    <tr class="noborder">
      <td><table class="table tb-type2 goods ">
          ...
          <tr>
            <td width="65" align="center" valign="middle"><a style="text-decoration:none;" href="<?php echo uk86_urlShop('goods','index',array('goods_id'=> $complain_goods['goods_id']));?>" target="_blank">
              <img width="50" src="<?php echo uk86_cthumb($complain_goods['goods_image'], 60,$output['order_info']['store_id']);?>" />
              </a></td>
            <td class="intro">
                <p><a href="<?php echo uk86_urlShop('goods','index',array('goods_id'=> $complain_goods['goods_id']));?>" target="_blank"><?php echo $complain_goods['goods_name'];?> </a></p>
                <p><?php echo uk86_orderGoodsType($complain_goods['goods_type']); ?></p>
              </td>
    ...
    <tr class="noborder">
      <td>
        ...
        <?php foreach ($output['refund_list'] as $key => $val) { ?>
          <tr>
            <td width="65" align="center" valign="middle"><a style="text-decoration:none;" href="<?php echo uk86_urlShop('goods','index',array('goods_id'=> $val['goods_id']));?>" target="_blank">
              <img width="50" src="<?php echo uk86_thumb($val,60);?>" />
              </a></td>
            <td class="intro">
                <p><a href="<?php echo uk86_urlShop('goods','index',array('goods_id'=> $val['goods_id']));?>" target="_blank"><?php echo $val['goods_name'];?> </a></p>
                <p><?php echo uk86_orderGoodsType($val['goods_type']); ?></p>
              </td>
