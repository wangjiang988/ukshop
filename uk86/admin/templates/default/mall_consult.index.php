...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="<?php echo uk86_urlAdmin('mall_consult', 'type_list');?>"><span>平台咨询类型</span></a></li>
        <li><a href="<?php echo uk86_urlAdmin('mall_consult', 'type_add');?>"><span>新增类型</span></a></li>
      </ul>
    </div>
  </div>
      ...
      <tbody>
        <tr>
          ...
          <td><a href="javascript:document.formSearch.submit();" class="btn-search " title="<?php echo $lang['nc_query'];?>">&nbsp;</a>
            ...
            <a class="btns " href="<?php echo uk86_urlAdmin('mall_consult', 'index');?>" title="<?php echo $lang['nc_cancel_search'];?>"><span><?php echo $lang['nc_cancel_search'];?></span></a>
            <?php }?>
          </td>
        </tr>
      </tbody>
  ...
  <form method="post" action="<?php echo uk86_urlAdmin('mall_consult', 'del_consult_batch');?>" onsubmit="" name="form1">
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="space">
          ...
          <td>
            <a href="<?php echo uk86_urlAdmin('mall_consult', 'consult_reply', array('id' => $val['mc_id']));?>"><?php if ($val['is_reply'] == 0) {?>回复<?php } else {?>编辑<?php }?></a> | 
            <a href="javascript:if(confirm('<?php echo $lang['nc_ensure_del'];?>')){location.href='<?php echo uk86_urlAdmin('mall_consult', 'del_consult', array('id' => $val['mc_id']));?>';}" class="normal" ><?php echo $lang['nc_del'];?></a>
          </td>
        </tr>
        <?php }?>
        <?php }else{?>
