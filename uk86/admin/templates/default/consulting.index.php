  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="<?php echo uk86_urlAdmin('consulting', 'type_list');?>"><span>咨询类型</span></a></li>
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="space">
          ...
          <th><strong><?php echo $lang['consulting_index_store_name'];?>:</strong>&nbsp;<a href="<?php echo uk86_urlShop('show_store','index', array('store_id'=>$consult['store_id']));?>" class="normal" ><?php echo $consult['store_name'];?></a></th>
