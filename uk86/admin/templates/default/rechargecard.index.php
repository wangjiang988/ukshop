  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="<?php echo uk86_urlAdmin('rechargecard', 'add_card'); ?>"><span>新增</span></a></li>
      </ul>
    </div>
  </div>
...
<?php if ($output['form_submit'] == 'ok'): ?>
            <a class="btns " href="<?php echo uk86_urlAdmin('rechargecard', 'index');?>" title="<?php echo $lang['nc_cancel_search'];?>"><span><?php echo $lang['nc_cancel_search'];?></span></a>
<?php endif; ?>
          </td>
        </tr>
      </tbody>
...
<div style="text-align: right;"><a class="btns" href="index.php?<?php echo http_build_query($_GET); ?>&op=export_step1" target="_blank"><span>导出Excel</span></a></div>
  ...
  <form method="post" action="<?php echo uk86_urlAdmin('rechargecard', 'del_card_batch');?>" onsubmit="" name="form1">
...
<?php endif; ?>
          ...
          <td class="align-center">
<?php if ($val['state'] == 0): ?>
            <a onclick="return confirm('确定删除？');" href="<?php echo uk86_urlAdmin('rechargecard', 'del_card', array('id' => $val['id'])); ?>" class="normal"><?php echo $lang['nc_del'];?></a>
<?php endif; ?>
          </td>
        </tr>
<?php endforeach; ?>
