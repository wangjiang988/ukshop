...
<div class="page">
  ...
  <div class="homepage-focus" nctype="editStoreContent">
    ...
    <form id="store_form" method="post" action="index.php?act=store&op=store_edit">
    ...
    <table class="table tb-type2">
      ...
      <tbody>
       ...
       <tr>
          <td colspan="2" class="required"><label>
            <label for="grade_id"> 经营方式: </label>
            </label></td>
        </tr>
        <tr class='noboder'>
        <td class="vatop rowform "><select id="management_model" name="management_model">
        <option value="1">自营</option>
        <option value="2">联营</option>
        <option value="3">租赁</option>
        <option value="4">经销</option>
        <option value="5">扣率代销</option></select></td></tr>
        <tr>
...
电子版：</th>
        <td colspan="20">
          <a nctype="nyroModal"  href="<?php echo uk86_getStoreJoininImageUrl($output['joinin_detail']['business_licence_number_electronic']);?>"> <img src="<?php echo uk86_getStoreJoininImageUrl($output['joinin_detail']['business_licence_number_electronic']);?>" alt="" /> </a>
  ...
  <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td colspan="20">
          <a nctype="nyroModal"  href="<?php echo uk86_getStoreJoininImageUrl($output['joinin_detail']['organization_code_electronic']);?>"> <img src="<?php echo uk86_getStoreJoininImageUrl($output['joinin_detail']['organization_code_electronic']);?>" alt="" /> </a>
  ...
  <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
    ...
    <tbody>
      <tr>
        <th>一般纳税人证明：</th>
        <td colspan="20">
          <a nctype="nyroModal" href="<?php echo uk86_getStoreJoininImageUrl($output['joinin_detail']['general_taxpayer']);?>"> <img src="<?php echo uk86_getStoreJoininImageUrl($output['joinin_detail']['general_taxpayer']);?>" alt="" /> </a>
  ...
  <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td colspan="20">
          <a nctype="nyroModal"  href="<?php echo uk86_getStoreJoininImageUrl($output['joinin_detail']['bank_licence_electronic']);?>"> <img src="<?php echo uk86_getStoreJoininImageUrl($output['joinin_detail']['bank_licence_electronic']);?>" alt="" /> </a>
...
电子版：</th>
        <td>
          <a nctype="nyroModal"  href="<?php echo uk86_getStoreJoininImageUrl($output['joinin_detail']['tax_registration_certificate_electronic']);?>"> <img src="<?php echo uk86_getStoreJoininImageUrl($output['joinin_detail']['tax_registration_certificate_electronic']);?>" alt="" /> </a>
...
$(function(){
    ...
    $('#store_form').validate({
        ...
        rules : {
             store_name: {
                 required : true,
                 remote : '<?php echo uk86_urlAdmin('store', 'ckeck_store_name', array('store_id' => $output['store_array']['store_id']))?>'
              }
        },
        messages : {
            store_name: {
