...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="<?php echo uk86_urlAdmin('promotion_booth', 'booth_quota_list');?>"><span>套餐列表</span></a></li>
        <li><a href="<?php echo uk86_urlAdmin('promotion_booth', 'booth_setting');?>"><span><?php echo $lang['nc_config'];?></span></a></li>
      </ul>
    </div>
  </div>
  ...
  <form method='post' id="form_goods" action="<?php echo uk86_urlAdmin('promotion_booth', 'del_goods');?>">
...
<?php } ?>
          ...
          <td class="align-center">
            <p><a href="<?php echo uk86_urlShop('goods', 'index', array('goods_id' => $v['goods_id']));?>" target="_blank"><?php echo $lang['nc_view'];?></a></p>
            <p><a href="javascript:void(0);" onclick="ajaxget('<?php echo uk86_urlAdmin('promotion_booth', 'del_goods', array('goods_id' => $v['goods_id']));?>');">删除</a></p>
          </td>
        </tr>
        <?php } ?>
        <?php } else { ?>
