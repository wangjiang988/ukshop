  ...
  <table class="table tb-type2 order">
    <tbody>
      ...
      <tr>
        <td colspan="2"><ul>
            ...
            <li><strong><?php echo $lang['order_state'];?>:</strong><?php if($output['order_info']['lock_state']){echo "审核中";}else{echo uk86_orderState($output['order_info']);}?></li>
            <li><strong><?php echo $lang['order_total_price'];?>:</strong><span class="red_common"><?php echo $lang['currency'].$output['order_info']['order_amount'];?> </span>
            	...
            	<?php } ?></li>
            <li><strong><?php echo $lang['order_total_transport'];?>:</strong><?php echo $lang['currency'] ?><?php echo $output['order_info']['shipping_fee']?$output['order_info']['shipping_fee']:'0.00';?><?php if($output['order_info']['store_mentioning'] == 1){ echo '（ 门店自提 ）'; } ?></li>
          </ul></td>
      </tr>
      <tr>
        <td><ul>
      ...
      <tr>
        <td><ul>
            ...
            <?php if($output['order_info']['store_mentioning'] != 1) {?><li><strong><?php echo $lang['address'];?><?php echo $lang['nc_colon'];?></strong><?php echo @$output['order_info']['extend_order_common']['reciver_info']['address'];?></li><?php } ?>
      ...
      <tr>
        <td><table class="table tb-type2 goods ">
            <tbody>
              ...
              <tr>
                <td class="w60 picture"><div class="size-56x56"><span class="thumb size-56x56"><i></i><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=goods&goods_id=<?php echo $goods['goods_id'];?>" target="_blank"><img alt="<?php echo $lang['product_pic'];?>" src="<?php echo uk86_thumb($goods, 60);?>" /> </a></span></div></td>
                <td class="w50pre"><p><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=goods&goods_id=<?php echo $goods['goods_id'];?>" target="_blank"><?php echo $goods['goods_name'];?></a></p><p><?php echo uk86_orderGoodsType($goods['goods_type']);?></p></td>
                ...
                <td class="w96 align-center"><?php echo $goods['commis_rate'] == 200 ? '' : uk86_ncPriceFormat($goods['goods_pay_price']*$goods['commis_rate']/100);?></td>
              </tr>
              <?php }?>
            </tbody>
          </table></td>
    ...
    <!-- S 促销信息 -->
      ...
      <tr>
        ...
        使用了面额为 <?php echo $lang['nc_colon'];?> <?php echo $output['order_info']['extend_order_common']['voucher_price'];?> 元的卡券包，
