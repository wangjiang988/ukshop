...
<div class="page"> 
  ...
  <form id="form_item" action="<?php echo uk86_urlAdmin('mb_special', 'special_item_save');?>" method="post">
      ...
      <tfoot>
        <tr class="tfoot">
          <td colspan="2"><a id="btn_save" class="btn" href="javascript:;"><span>保存编辑</span></a>
            ...
            <a id="btn_back" href="<?php echo uk86_urlAdmin('mb_special', 'special_edit', array('special_id' => $output['item_info']['special_id']));?>" class="btn"><span>返回上一级</span></a>
            <?php } else { ?>
            <a id="btn_back" href="<?php echo uk86_urlAdmin('mb_special', 'index_edit');?>" class="btn"><span>返回上一级</span></a>
            <?php } ?></td>
        </tr>
      </tfoot>
    </table>
...
<div id="dialog_item_edit_image" style="display:none;">
  ...
  <form id="form_image" action="">
    <div class="dialog-handle-box clearfix">
      ...
      <div class="nav_name_txt"><h4 class="dialog-handle-title">导航名称：</h4><input class="w200" type="text" name="nav_list_name[]"/></div>
...
<script type="text/javascript">
    var url_upload_image = '<?php echo uk86_urlAdmin('mb_special', 'special_image_upload');?>';
