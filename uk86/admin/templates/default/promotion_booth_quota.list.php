...
<div class="page">
  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="<?php echo uk86_urlAdmin('promotion_booth', 'goods_list');?>"><span>商品列表</span></a></li>
  ...
  <form id="list_form" method="post">
    ...
    <table class="table tb-type2">
      ...
      <tbody id="treet1">
        ...
        <tr class="hover">
            <td class="align-left"><a href="<?php echo uk86_urlShop('show_store','index', array('store_id'=>$val['store_id']));?>" ><span><?php echo $val['store_name'];?></span></a></td>
          ...
          <td class="align-center"><a href="<?php echo uk86_urlAdmin('promotion_booth', 'goods_list', array('store_id' => $val['store_id']));?>">查看商品</a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
