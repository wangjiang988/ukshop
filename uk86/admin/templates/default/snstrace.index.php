      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="fd-list"><!-- 动态列表start -->
            ...
            <li>
              <div class="fd-aside"> <span class="thumb size60"><a href="<?php echo SHOP_SITE_URL.DS;?>index.php?act=member_snshome&mid=<?php echo $v['trace_memberid'];?>" target="_blank"> <img src="<?php echo uk86_getMemberAvatarForID($v['trace_memberid']);?>" onload="javascript:DrawImage(this,60,60);"> </a> </span> </div>
              <dl class="fd-wrap">
                <dt>
                  ...
                  <h5><?php echo uk86_parsesmiles($v['trace_title']);?></h5>
                </dt>
                <dd>
