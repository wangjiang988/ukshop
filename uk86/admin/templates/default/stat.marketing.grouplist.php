    ...
    <table class="table tb-type2 nobdb">
        ...
        <?php foreach ((array)$output['grouplist'] as $k=>$v){?>
          ...
          <tr nc_type="ginfo" class="hover ginfo" style="<?php echo $k==1?'':'display:none;'; ?>">
            <td colspan="3">
            	<div class="size-106x106 left img"><span class="thumb size-106x106"><i></i><a target="_blank" href="<?php echo SHOP_SITE_URL."/index.php?act=show_groupbuy&op=groupbuy_detail&group_id=".$v['groupbuy_id'];?>"><img src="<?php echo uk86_gthumb($v['groupbuy_image'], 'small');?>" style=" max-width: 106px; max-height: 106px;"/></a></span></div>
            	<div class="left">
