  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?act=brand&op=brand_setPrice"><span><?php echo '价格设置';?></span></a></li>
      </ul>
    </div>
  </div>
  ...
  <form id="brand_form" method="post" name="form1" enctype="multipart/form-data">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td colspan="2" class="required"><label class="validation">应付价格:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" disabled="disabled" value="<?php echo C('default_brand_price');?>" name="goods_price" id="goods_price" class="txt"></td>
          <td class="vatop tips">后台设置价格</td>
        </tr>
        <tr class="noborder">
          <td colspan="2" class="required"><label class="validation">实付价格:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo  $output['brand_array']['goods_price']?>"  name="order_amount" id="order_amount" class="txt"></td>
          <td class="vatop tips">实际应付价格</td>
        </tr>
        <tr>
      ...
      <tfoot>
        <tr class="tfoot">
          <td colspan="15" ><a href="JavaScript:void(0);" class="btn" id="submitBtn"><span><?php echo $lang['brand_apply_edit'];?></span></a></td>
        </tr>
      </tfoot>
    </table>
  </form>
