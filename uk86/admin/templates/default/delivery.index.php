...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3>物流自提服务站管理</h3>
      <ul class="tab-base">
        <li><a href="<?php echo uk86_urlAdmin('delivery', 'index');?>" <?php if ($output['sign'] != 'verify') {?>class="current"<?php }?>><span><?php echo $lang['nc_manage'];?></span></a></li>
        <li><a href="<?php echo uk86_urlAdmin('delivery', 'index', array('sign' => 'verify'));?>" <?php if ($output['sign'] == 'verify') {?>class="current"<?php }?>><span>等待审核</span></a></li>
        <li><a href="<?php echo uk86_urlAdmin('delivery', 'setting');?>"><span>设置</span></a></li>
      </ul>
    </div>
  </div>
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td class="align-center"><a href="<?php echo uk86_urlAdmin('delivery', 'edit_delivery', array('d_id' => $v['dlyp_id']));?>">编辑</a> | <a href="<?php echo uk86_urlAdmin('delivery', 'order_list', array('d_id' => $v['dlyp_id']));?>">查看订单</a></td>
        </tr>
        <?php } ?>
        <?php } else { ?>
        <tr class="no_data">
