...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="<?php echo uk86_urlAdmin('consulting', 'consulting');?>"><span><?php echo $lang['nc_manage'];?></span></a></li>
        <li><a href="<?php echo uk86_urlAdmin('consulting', 'setting');?>"><span>设置</span></a></li>
        <li><a href="JavaScript:void(0);" class="current"><span>咨询类型</span></a></li>
        <li><a href="<?php echo uk86_urlAdmin('consulting', 'type_add');?>"><span>新增类型</span></a></li>
      </ul>
    </div>
  </div>
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        <tr>
          ...
          <td class="align-center"><a href="<?php echo uk86_urlAdmin('consulting', 'type_edit', array('ct_id' => $value['ct_id']));?>">编辑</a>&nbsp;|&nbsp;<a href="<?php echo uk86_urlAdmin('consulting', 'type_del', array('ct_id' => $value['ct_id']));?>">删除</a></td>
        </tr>
      </tbody>
      <?php }?>
      <?php }else{?>
