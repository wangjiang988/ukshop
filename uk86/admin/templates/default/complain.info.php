...
<?php
        include uk86_template('complain_order.info');
        include uk86_template('complain_complain.info');
        if(!empty($output['complain_info']['appeal_message'])) {
            include uk86_template('complain_appeal.info');
        }
        if(intval($output['complain_info']['complain_state'])>20) {
            include uk86_template('complain_talk.info');
        }
        if(intval($output['complain_info']['complain_state']) == 99 && !empty($output['complain_info']['final_handle_message'])) {
            include uk86_template('complain_finish.info');
        }
    ?>
