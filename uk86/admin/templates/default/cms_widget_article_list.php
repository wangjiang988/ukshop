...
<div class="article-select-box">
    ...
    <ul id="article_search_list" class="article-search-list">
        ...
        <span nctype="cms_index_not_display" class="article-image">
            <p><img src="<?php echo uk86_getCMSArticleImageUrl($value['article_attachment_path'], $value['article_image']);?>" /></p>
        </span>
        <span class="title">
            <em nctype="cms_index_not_display" class="class-name">[<?php echo $value['class_name'];?>]</em>
            <a nctype="article_item" href="<?php echo uk86_getCMSArticleUrl($value['article_id']);?>" target="_blank" class_name="<?php echo $value['class_name'];?>" article_abstract="<?php echo $value['article_abstract'];?>" article_click="<?php echo $value['article_click'];?>" article_publish_time="<?php echo date('Y-m-d',$value['article_publish_time']);?>" article_image="<?php echo uk86_getCMSArticleImageUrl($value['article_attachment_path'], $value['article_image']);?>">
