    ...
    <table class="table tb-type2">
      ...
      <tbody>
      	...
      	<tr class="noborder">
            ...
            <td colspan="2" class="vatop tips">当会员兑换U币商品时，需要达到该级别或者以上级别后才能参与兑换</td>
      	</tr>
      </tbody>
      <tbody>
        <tr class="space">
      ...
      <tbody>
        ...
        <tr>
          <td colspan="10"><?php uk86_showEditor('pgoods_body',$output['prod_info']['pgoods_body'],'600px','400px','visibility:hidden;',"false",$output['editor_multimedia']);?></td>
        </tr>
        <tr>
