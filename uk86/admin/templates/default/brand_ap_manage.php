  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?act=adv&op=ap_add&type=2" ><span><?php echo $lang['ap_add'];?></span></a></li>
      </ul>
    </div>
  </div>
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td><span title="<?php echo $v['ap_name'];?>"><?php echo uk86_str_cut($v['ap_name'], '40');?></span></td>
