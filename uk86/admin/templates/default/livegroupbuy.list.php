      ...
      <tbody>
        ...
        <tr class="hover edit">
          <td class="w60 picture">
          	...
          	<a target="_blank" href="<?php echo SHOP_SITE_URL."/index.php?act=show_live_groupbuy&op=groupbuy_detail&groupbuy_id=".$val['groupbuy_id'];?>"><img src="<?php echo uk86_gthumb($val['groupbuy_pic'], 'small');?>" style=" max-width: 56px; max-height: 56px;"/></a></span></div>
          </td>
          <td class="group">
            ...
            <p class="store">店铺名称:<a target="_blank" href="<?php echo uk86_urlShop('show_store','index', array('store_id'=>$val['store_id']));?>" title="<?php echo $val['store_name'];?>"><?php echo $val['store_name'];?></a></p>
          </td>
