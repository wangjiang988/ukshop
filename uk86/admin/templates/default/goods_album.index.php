      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <?php if($v['aclass_cover'] != ''){ ?>
              <img src="<?php echo uk86_cthumb($v['aclass_cover'], 60, $v['store_id']);?>" onload="javascript:DrawImage(this,70,70);">
              <?php }else{?>
          ...
          <td class="class"><a href="<?php echo uk86_urlShop('show_store','index', array('store_id'=>$v['store_id']));?>" ><?php echo $v['store_name'];?></td>
