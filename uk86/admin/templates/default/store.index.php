  ...
  <form method="post" id="store_form">
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit <?php echo uk86_getStoreStateClassName($v);?>">
          <td>
              <a href="<?php echo uk86_urlShop('show_store','index', array('store_id'=>$v['store_id']));?>" >
        ...
        <td class="align-center w200">
            ...
            <?php if (uk86_getStoreStateClassName($v) != 'open' && uk86_cookie('remindRenewal'.$v['store_id']) == null) {?><a href="<?php echo uk86_urlAdmin('store', 'remind_renewal', array('store_id'=>$v['store_id']));?>">提醒续费</a><?php }?>&nbsp;&nbsp; <a href="index.php?act=store&op=del&id=<?php echo $v['store_id']?>">删除</a>
            </td>
        </tr>
        <?php } ?>
        <?php }else { ?>
