    ...
    <table class="table tb-type2 nobdb">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td><div class="brand-picture"><img src="<?php echo uk86_brandImage($v['brand_pic']);?>"/></div></td>
          <td class="w96 align-center"><a href="index.php?act=brand&op=brand_apply_edit&state=pass&brand_id=<?php echo $v['brand_id']?>"><?php echo $lang['brand_apply'];?></a> | 
          <a href="index.php?act=brand&op=brand_apply_set&state=refuse&brand_id=<?php echo $v['brand_id']?>"><?php echo $lang['nc_del'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
