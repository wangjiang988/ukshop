...
class promotion_xianshiControl extends SystemControl{
    ...
    public function __construct(){
        ...
        //读取语言包
        Uk86Language::uk86_read('promotion_xianshi');
        ...
        if (intval($_GET['promotion_allow']) !== 1 && intval(C('promotion_allow')) !== 1){
			...
			uk86_showMessage(Uk86Language::uk86_get('promotion_unavailable'),$url,'html','succ',1,6000);
        }
    }
    ...
    public function xianshi_setting_saveOp() {
        ...
        if ($result){
            ...
            uk86_showMessage(Uk86Language::uk86_get('setting_save_success'),'');
        }else {
            uk86_showMessage(Uk86Language::uk86_get('setting_save_fail'),'');
        }
    }
    ...
    private function show_menu($menu_key) {
        $menu_array = array(
            'xianshi_list'=>array('menu_type'=>'link','menu_name'=>Uk86Language::uk86_get('xianshi_list'),'menu_url'=>'index.php?act=promotion_xianshi&op=xianshi_list'),
            'xianshi_detail'=>array('menu_type'=>'link','menu_name'=>Uk86Language::uk86_get('xianshi_detail'),'menu_url'=>'index.php?act=promotion_xianshi&op=xianshi_detail'),
            'xianshi_quota'=>array('menu_type'=>'link','menu_name'=>Uk86Language::uk86_get('xianshi_quota'),'menu_url'=>'index.php?act=promotion_xianshi&op=xianshi_quota'),
            'xianshi_setting'=>array('menu_type'=>'link','menu_name'=>Uk86Language::uk86_get('xianshi_setting'),'menu_url'=>'index.php?act=promotion_xianshi&op=xianshi_setting'),
        );
