...
class mall_consultControl extends SystemControl{
    ...
    public function consult_replyOp() {
        ...
        if (uk86_chksubmit()) {
            ...
            if ($result) {
                ...
                $param['param'] = array(
                    'consult_url' => uk86_urlShop('member_mallconsult', 'mallconsult_info', array('id' => $mc_id))
                );
    ...
    public function type_addOp() {
        if (uk86_chksubmit()) {
            ...
            if ($result){
                $this->log('新增咨询类型',1);
                uk86_showMessage(L('nc_common_save_succ'), uk86_urlAdmin('mall_consult', 'type_list'));
            }else {
                $this->log('新增咨询类型',0);
    ...
    public function type_editOp() {
        ...
        if (uk86_chksubmit()) {
            ...
            if ($result){
                ...
                uk86_showMessage(L('nc_common_op_succ'), uk86_urlAdmin('mall_consult', 'type_list'));
            }else {
