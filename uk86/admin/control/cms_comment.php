...
class cms_commentControl extends SystemControl{
    ...
    private function get_type_array() {
        $type_array = array();
        $type_array[1] = array('name'=>Uk86Language::uk86_get('cms_text_artcile'),'key'=>'article');
        $type_array[2] = array('name'=>Uk86Language::uk86_get('cms_text_picture'),'key'=>'picture');
    ...
    private function show_menu($menu_key) {
        $menu_array = array(
            "{$menu_key}"=>array('menu_type'=>'link','menu_name'=>Uk86Language::uk86_get('nc_manage'),'menu_url'=>'index.php?act=cms_comment&op='.$menu_key),
        );
