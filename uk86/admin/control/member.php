		...
		if (uk86_chksubmit()){
			...
			if ($error != ''){
				...
				if ($result){
					...
					uk86_showMessage($lang['member_edit_succ'],$url);
				}else {
					uk86_showMessage($lang['member_edit_fail']);
				}
			}
		}
		...
		if (uk86_chksubmit()){
			...
			if ($error != ''){
				...
				if ($result){
					...
					uk86_showMessage($lang['member_add_succ'],$url);
				}else {
					uk86_showMessage($lang['member_add_fail']);
				}
			}
		}
