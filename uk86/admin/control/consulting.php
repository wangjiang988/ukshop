...
class consultingControl extends SystemControl{
	public function __construct(){
		parent::__construct();
		Uk86Language::uk86_read('consulting');
	}
    ...
    public function type_addOp() {
        if (uk86_chksubmit()) {
            ...
            if ($result){
                $this->log('新增咨询类型',1);
                uk86_showMessage(L('nc_common_save_succ'), uk86_urlAdmin('consulting', 'type_list'));
            }else {
                $this->log('新增咨询类型',0);
                uk86_showMessage(L('nc_common_save_fail'));
            }
    ...
    public function type_editOp() {
        ...
        if (uk86_chksubmit()) {
            ...
            if ($result){
                ...
                uk86_showMessage(L('nc_common_op_succ'), uk86_urlAdmin('consulting', 'type_list'));
            }else {
