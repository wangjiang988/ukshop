...
class article_classControl extends SystemControl{
	public function __construct(){
		parent::__construct();
		Uk86Language::uk86_read('article_class');
	}
...
//				$update_array['ac_parent_id'] = intval($_POST['ac_parent_id']);
				...
				if ($result){
					...
					uk86_showMessage($lang['article_class_edit_succ'],'index.php?act=article_class&op=article_class');
				}else {
					uk86_showMessage($lang['article_class_edit_fail']);
				}
			}
		}
	...
	public function article_class_delOp(){
		...
		if (intval($_GET['ac_id']) > 0){
			...
			uk86_showMessage($lang['article_class_index_del_succ'],'index.php?act=article_class&op=article_class');
		}else {
			uk86_showMessage($lang['article_class_index_choose'],'index.php?act=article_class&op=article_class');
		}
	}
	/**
	 * ajax操作
