...
class complainControl extends SystemControl {
    ...
    public function __construct() {
        parent::__construct();
        Uk86Language::uk86_read('complain');
    }
    ...
    public function complain_closeOp() {
        ...
        $obj_validate->validateparam = array(
            array("input"=>$final_handle_message, "require"=>"true","validator"=>"Length","min"=>"1","max"=>"255","message"=>Uk86Language::uk86_get('final_handle_message_error')),
        );
    ...
    public function complain_subject_saveOp() {
        ...
        $obj_validate = new Uk86Validate();
        $obj_validate->validateparam = array(
            array("input"=>$input['complain_subject_content'], "require"=>"true","validator"=>"Length","min"=>"1","max"=>"50","message"=>Uk86Language::uk86_get('complain_subject_content_error')),
            array("input"=>$input['complain_subject_desc'], "require"=>"true","validator"=>"Length","min"=>"1","max"=>"100","message"=>Uk86Language::uk86_get('complain_subject_desc_error')),
        );
        $error = $obj_validate->uk86_validate();
        if ($error != '') {
            uk86_showMessage($error);
            ...
            uk86_showMessage(Uk86Language::uk86_get('complain_subject_add_success'),'index.php?act=complain&op=complain_subject_list');
        }
    }
    ...
    public function complain_subject_dropOp() {
        ...
        if(empty($complain_subject_id)) {
            uk86_showMessage(Uk86Language::uk86_get('param_error'),'index.php?act=complain');
        }
        $model_complain_subject= Model('complain_subject');
        $update_array = array();
        ...
        if($model_complain_subject->updateComplainSubject($update_array,$where_array)) {
            ...
            uk86_showMessage(Uk86Language::uk86_get('complain_subject_delete_success'),'index.php?act=complain&op=complain_subject_list');
        } else {
            uk86_showMessage(Uk86Language::uk86_get('complain_subject_delete_fail'),'index.php?act=complain&op=complain_subject_list');
        }
    }
    ...
    public function get_complain_talkOp() {
        ...
        foreach($complain_talk_list as $talk) {
            ...
            switch($talk['talk_member_type']) {
                case 'accuser':
                    $talk_list[$i]['talk'] .= Uk86Language::uk86_get('complain_accuser');
                    break;
                case 'accused':
                    $talk_list[$i]['talk'] .= Uk86Language::uk86_get('complain_accused');
                    break;
                case 'admin':
                    $talk_list[$i]['talk'] .= Uk86Language::uk86_get('complain_admin');
                    break;
                default:
                    $talk_list[$i]['talk'] .= Uk86Language::uk86_get('complain_unknow');
            }
            if(intval($talk['talk_state']) === 2) {
                $talk['talk_content'] = Uk86Language::uk86_get('talk_forbit_message');
                $forbit_link = '';
            } else {
                $forbit_link = "&nbsp;&nbsp;<a href='#' onclick=forbit_talk(".$talk['talk_id'].")>".Uk86Language::uk86_get('complain_text_forbit')."</a>";
            }
            $talk_list[$i]['talk'].= '('.$talk['talk_member_name'].')'.Uk86Language::uk86_get('complain_text_say').':'.$talk['talk_content'].$forbit_link;
            $i++;
        }
        if (strtoupper(CHARSET) == 'GBK') {
            $talk_list = Uk86Language::uk86_getUTF8($talk_list);
		}
    ...
    public function complain_setting_saveOp() {
        ...
        if($model_setting->updateSetting($update_array)) {
            ...
            uk86_showMessage(Uk86Language::uk86_get('complain_setting_save_success'),'');
        } else {
            uk86_showMessage(Uk86Language::uk86_get('complain_setting_save_fail'),'');
        }
    }
    ...
    private function get_complain_state_text($complain_state) {
        switch(intval($complain_state)) {
            case self::STATE_NEW:
                return Uk86Language::uk86_get('complain_state_new');
                break;
            case self::STATE_APPEAL:
                return Uk86Language::uk86_get('complain_state_appeal');
                break;
            case self::STATE_TALK:
                return Uk86Language::uk86_get('complain_state_talk');
                break;
            case self::STATE_HANDLE:
                return Uk86Language::uk86_get('complain_state_handle');
                break;
            case self::STATE_FINISH:
                return Uk86Language::uk86_get('complain_state_finish');
                break;
            default:
                uk86_showMessage(Uk86Language::uk86_get('param_error'),'');
        }
	...
	private function show_menu($menu_key) {
		$menu_array = array(
			'complain_new_list'=>array('menu_type'=>'link','menu_name'=>Uk86Language::uk86_get('complain_new_list'),'menu_url'=>'index.php?act=complain&op=complain_new_list'),
			'complain_appeal_list'=>array('menu_type'=>'link','menu_name'=>Uk86Language::uk86_get('complain_appeal_list'),'menu_url'=>'index.php?act=complain&op=complain_appeal_list'),
			'complain_talk_list'=>array('menu_type'=>'link','menu_name'=>Uk86Language::uk86_get('complain_talk_list'),'menu_url'=>'index.php?act=complain&op=complain_talk_list'),
			'complain_handle_list'=>array('menu_type'=>'link','menu_name'=>Uk86Language::uk86_get('complain_handle_list'),'menu_url'=>'index.php?act=complain&op=complain_handle_list'),
			'complain_finish_list'=>array('menu_type'=>'link','menu_name'=>Uk86Language::uk86_get('complain_finish_list'),'menu_url'=>'index.php?act=complain&op=complain_finish_list'),
			'complain_subject_list'=>array('menu_type'=>'link','menu_name'=>Uk86Language::uk86_get('complain_subject_list'),'menu_url'=>'index.php?act=complain&op=complain_subject_list'),
			'complain_subject_add'=>array('menu_type'=>'link','menu_name'=>Uk86Language::uk86_get('complain_subject_add'),'menu_url'=>'index.php?act=complain&op=complain_subject_add'),
			'complain_setting'=>array('menu_type'=>'link','menu_name'=>Uk86Language::uk86_get('complain_setting'),'menu_url'=>'index.php?act=complain&op=complain_setting'),
			'complain_progress'=>array('menu_type'=>'link','menu_name'=>Uk86Language::uk86_get('complain_progress'),'menu_url'=>'###'),
		);
