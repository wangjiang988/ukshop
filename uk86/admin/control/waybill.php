...
class waybillControl extends SystemControl{
    ...
    public function __construct(){
        parent::__construct();
        $this->url_waybill_list = uk86_urlAdmin('waybill', 'waybill_list');
    }
    ...
    public function waybill_saveOp() {
        ...
        if(!isset($result['error'])) {
            ...
            uk86_showMessage(L('nc_common_save_succ'), $this->url_waybill_list);
        } else {
            $this->log('保存运单模板' . '[ID:' . $result. ']', 0);
           uk86_showMessage(L('nc_common_save_fail'), $this->url_waybill_list);
        }
    }
    ...
    private function show_menu($menu_key='') {
        $menu_array = array(
            1=>array('menu_key'=>'waybill_list','menu_name'=>'列表', 'menu_url'=>uk86_urlAdmin('waybill', 'waybill_list')),
            2=>array('menu_key'=>'waybill_add','menu_name'=>'添加',	'menu_url'=>uk86_urlAdmin('waybill', 'waybill_add')),
        );
