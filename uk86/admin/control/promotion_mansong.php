...
class promotion_mansongControl extends SystemControl{
    ...
    public function __construct(){
        ...
        //读取语言包
        Uk86Language::uk86_read('promotion_mansong');
    ...
    private function show_menu($menu_key) {
        $menu_array = array(
            'mansong_list'=>array('menu_type'=>'link','menu_name'=>Uk86Language::uk86_get('mansong_list'),'menu_url'=>uk86_urlAdmin('promotion_mansong', 'mansong_list')),
            'mansong_quota'=>array('menu_type'=>'link','menu_name'=>Uk86Language::uk86_get('mansong_quota'),'menu_url'=>uk86_urlAdmin('promotion_mansong', 'mansong_quota')),
            'mansong_detail'=>array('menu_type'=>'link','menu_name'=>Uk86Language::uk86_get('mansong_detail'),'menu_url'=>uk86_urlAdmin('promotion_mansong', 'mansong_detail')),
            'mansong_setting'=>array('menu_type'=>'link','menu_name'=>Uk86Language::uk86_get('mansong_setting'),'menu_url'=>uk86_urlAdmin('promotion_mansong', 'mansong_setting')),
        );
