...
class help_storeControl extends SystemControl{
	...
	public function add_helpOp() {
		...
		if (uk86_chksubmit()) {
			...
			if ($state) {
				...
				uk86_showMessage(Uk86Language::uk86_get('nc_common_save_succ'),'index.php?act=help_store&op=help_store');
			} else {
	...
	public function del_helpOp() {
		...
		if ($state) {
		    ...
		    uk86_showMessage(Uk86Language::uk86_get('nc_common_del_succ'),'index.php?act=help_store&op=help_store');
		} else {
	...
	public function add_typeOp() {
		...
		if (uk86_chksubmit()) {
			...
			if ($state) {
				...
				uk86_showMessage(Uk86Language::uk86_get('nc_common_save_succ'),'index.php?act=help_store&op=help_type');
			} else {
				uk86_showMessage(Uk86Language::uk86_get('nc_common_save_fail'));
			}
		}
	...
	public function del_typeOp() {
		...
		if ($state) {
		    ...
		    uk86_showMessage(Uk86Language::uk86_get('nc_common_del_succ'),'index.php?act=help_store&op=help_type');
		} else {
		    uk86_showMessage(Uk86Language::uk86_get('nc_common_del_fail'));
		}
	}
