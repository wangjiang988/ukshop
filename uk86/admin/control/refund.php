...
class refundControl extends SystemControl{
	...
	public function editOp() {
		...
		if (uk86_chksubmit()) {
			...
			if ($state) {
                ...
                $param['param'] = array(
                    'refund_url' => uk86_urlShop('member_refund', 'view', array('refund_id' => $refund['refund_id'])),
	...
	public function add_reasonOp() {
		...
		if (chksubmit()) {
			...
			if ($state) {
				...
				uk86_showMessage(Uk86Language::uk86_get('nc_common_save_succ'),'index.php?act=refund&op=reason');
			} else {
				uk86_showMessage(Uk86Language::uk86_get('nc_common_save_fail'));
			}
		}
	...
	public function del_reasonOp() {
		...
		if ($state) {
		    ...
		    uk86_showMessage(Uk86Language::uk86_get('nc_common_del_succ'),'index.php?act=refund&op=reason');
		} else {
