...
class informControl extends SystemControl{
    ...
    public function inform_subject_type_saveOp(){
        ...
        $obj_validate->validateparam = array(
            array("input"=>$input['inform_type_name'], "require"=>"true","validator"=>"Length","min"=>"1","max"=>"50","message"=>Uk86Language::uk86_get('inform_type_null')),
            array("input"=>$input['inform_type_desc'], "require"=>"true","validator"=>"Length","min"=>"1","max"=>"100","message"=>Uk86Language::uk86_get('inform_type_desc_null')),
        );
        ...
        if ($error != ''){
            ...
            uk86_showMessage(Uk86Language::uk86_get('nc_common_save_succ'),'index.php?act=inform&op=inform_subject_type_list');
        }
    }
    ...
    public function inform_subject_type_dropOp(){
        ...
        if(empty($inform_type_id)) {
            uk86_showMessage(Uk86Language::uk86_get('param_error'),'index.php?act=inform');
        }
        ...
        uk86_showMessage(Uk86Language::uk86_get('nc_common_del_succ'),'index.php?act=inform&op=inform_subject_type_list');
    ...
    public function inform_subject_addOp(){
        ...
        if(empty($inform_type_list)) {
            uk86_showMessage(Uk86Language::uk86_get('inform_type_error'));
        }
    ...
    public function inform_subject_saveOp(){
        ...
        $obj_validate = new Uk86Validate();
        $obj_validate->validateparam = array(
            array("input"=>$input['inform_subject_type_name'], "require"=>"true","validator"=>"Length","min"=>"1","max"=>"50","message"=>Uk86Language::uk86_get('inform_subject_null')),
            array("input"=>$input['inform_subject_content'], "require"=>"true","validator"=>"Length","min"=>"1","max"=>"50","message"=>Uk86Language::uk86_get('inform_content_null')),
            array("input"=>$input['inform_subject_type_id'], "require"=>"true","validator"=>"Number","message"=>Uk86Language::uk86_get('param_error')),
        );
        $error = $obj_validate->uk86_validate();
        ...
        if ($error != ''){
            ...
            uk86_showMessage(Uk86Language::uk86_get('nc_common_save_succ'),'index.php?act=inform&op=inform_subject_list');
        }
    }
    ...
    public function inform_subject_dropOp(){
        ...
        uk86_showMessage(Uk86Language::uk86_get('nc_common_del_succ'),'index.php?act=inform&op=inform_subject_list');
    }
    ...
    public function inform_handleOp(){
        ...
        $obj_validate->validateparam = array(
            ...
            array("input"=>$inform_handle_message, "require"=>"true","validator"=>"Length","min"=>"1","max"=>"100","message"=>Uk86Language::uk86_get('inform_handle_message_null')),
        );
        $error = $obj_validate->uk86_validate();
        if ($error != ''){
            uk86_showMessage($error);
        ...
        if($model_inform->updateInform($update_array,$where_array)) {
            ...
            uk86_showMessage(Uk86Language::uk86_get('nc_common_op_succ'),'index.php?act=inform&op=inform_list');
        }
        else {
	...
	private function show_menu($menu_key) {
		$menu_array = array(
			'inform_list'=>array('menu_type'=>'link','menu_name'=>Uk86Language::uk86_get('inform_state_unhandle'),'menu_url'=>'index.php?act=inform&op=inform_list'),
			'inform_handled_list'=>array('menu_type'=>'link','menu_name'=>Uk86Language::uk86_get('inform_state_handled'),'menu_url'=>'index.php?act=inform&op=inform_handled_list'),
			'inform_subject_type_list'=>array('menu_type'=>'link','menu_name'=>Uk86Language::uk86_get('inform_type'),'menu_url'=>'index.php?act=inform&op=inform_subject_type_list'),
			'inform_subject_type_add'=>array('menu_type'=>'link','menu_name'=>Uk86Language::uk86_get('inform_type_add'),'menu_url'=>'index.php?act=inform&op=inform_subject_type_add'),
			'inform_subject_list'=>array('menu_type'=>'link','menu_name'=>Uk86Language::uk86_get('inform_subject'),'menu_url'=>'index.php?act=inform&op=inform_subject_list'),
			'inform_subject_add'=>array('menu_type'=>'link','menu_name'=>Uk86Language::uk86_get('inform_subject_add'),'menu_url'=>'index.php?act=inform&op=inform_subject_add'),
		);
