...
class cms_articleControl extends SystemControl{
     ...
     **/
     public function cms_article_dropOp() {
        ...
        if($result) {
            $this->log(Uk86Language::uk86_get('cms_log_article_drop').$article_id, 1);
            uk86_showMessage(Uk86Language::uk86_get('nc_common_del_succ'),'');
        } else {
            $this->log(Uk86Language::uk86_get('cms_log_article_drop').$article_id, 0);
    ...
    private function show_menu($menu_key) {
        $menu_array = array(
            'list'=>array('menu_type'=>'link','menu_name'=>Uk86Language::uk86_get('nc_list'),'menu_url'=>'index.php?act=cms_article&op=cms_article_list'),
            'list_verify'=>array('menu_type'=>'link','menu_name'=>Uk86Language::uk86_get('cms_article_list_verify'),'menu_url'=>'index.php?act=cms_article&op=cms_article_list_verify'),
            'list_published'=>array('menu_type'=>'link','menu_name'=>Uk86Language::uk86_get('cms_article_list_published'),'menu_url'=>'index.php?act=cms_article&op=cms_article_list_published'),
        );
