		...
		'left' =>array(
			...
			1 => array(
				...
				'list' => array(
					...
					array('args'=>'index,servicegoods_area,setting','text'=>$lang['nc_service_area']),
//					array('args'=>'clearing,clearing,setting',      'text'=>'结算日期'),
				)
			),
			2 => array(
				'nav' => 'goods',
			...
			3 => array(
				...
				'list' => array(
					...
					array('args'=>'brand,brand,store',						'text'=>'旗舰店'),
					array('args'=>'brand_ap_manage,adv,store',						'text'=>'旗舰店广告'),
				)
			),
			4 => array(
				'nav' => 'member',
			...
			5 => array(
				...
				'list' => array(
					...
					array('args'=>'index,pmvr_order,trade',				    'text'=>'商家虚拟订单'),
			...
			6 => array(
				...
				'list' => array(
					...
					array('args'=>'viewlist,view,website',                  'text'=>'360全景'),
					array('args'=>'web_channel,web_channel,website',					'text'=>'频道管理'),
				)
			),
			7 => array(
				'nav' => 'operation',
				...
				'list' => array(
                    ...
                    array('args'=>'wheelList,wheel,operation',					'text'=>'大转盘')
				)
			),
			8 => array(
				'nav' => 'stat',
...
if(C('circle_isuse') !== null){
	...
	$arr['left'][] = array(
			...
			'list'	=> array(
				    ...
				    5 => array('args'=>'theme_class_list,circle_theme,circle',	'text'=>'圈子话题分类'),
					6 => array('args'=>'member_list,circle_member,circle',	'text'=>$lang['nc_circle_membermanage']),
					7 => array('args'=>'inform_list,circle_inform,circle',	'text'=>$lang['nc_circle_informnamage']),
					8 => array('args'=>'adv_manage,circle_setting,circle',	'text'=>$lang['nc_circle_advmanage']),
					9 => array('args'=>'index,circle_cache,circle',			'text'=>$lang['nc_circle_cache'])
			)
	);
}
