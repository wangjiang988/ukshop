...
$lang['admin_voucher_unavailable']    = '請確認卡券包、積分、金幣均以開啟';
...
$lang['admin_voucher_template_manage']= '店舖卡券包';
$lang['admin_voucher_template_edit']= '編輯卡券包';
...
$lang['admin_voucher_setting_buyertimes_tip']	= '買家最多只能擁有同一個店舖尚未消費抵用的店舖卡券包最大數量';
//$lang['admin_voucher_setting_default_styleimg']	= '卡券包預設樣式模板';
/**
 * 卡券包面額
 */
$lang['admin_voucher_price_error']   		= '卡券包面額應為大於0的整數';
$lang['admin_voucher_price_describe_error'] = '描述不能為空';
$lang['admin_voucher_price_describe_lengtherror'] = '卡券包描述不能為空且不能大於255個字元';
$lang['admin_voucher_price_points_error']   = '預設兌換積分數應為大於0的整數';
$lang['admin_voucher_price_exist']    		= '該卡券包面額已經存在';
$lang['admin_voucher_price_title']    		= '卡券包面額';
$lang['admin_voucher_price_describe']    	= '描述';
$lang['admin_voucher_price_points']    		= '預設兌換積分數';
$lang['admin_voucher_price_points_tip']    	= '當賣家發佈卡券包活動時，卡券包活動預設消耗的積分數';
$lang['admin_voucher_price_tip1']    	= '管理員規定卡券包面額，店舖發放卡券包時面額從規定的面額中選擇';
/**
 * 卡券包套餐申請
 */
$lang['admin_voucher_apply_goldnotenough']	= '該會員金幣不夠，操作失敗';
$lang['admin_voucher_apply_goldlog']    	= '購買卡券包活動%s個月，單價%s金幣，總共花費%s金幣';
$lang['admin_voucher_apply_message']    	= '您成功購買卡券包活動%s個月，單價%s金幣，總共花費%s金幣，時間從審核後開始計算';
...
$lang['admin_voucher_apply_list_tip2']    	= '當賣家金幣不足時審核會失敗，賣家發佈成功的卡券包會出現在積分中心，買家可憑積分進行兌換';
...
$lang['admin_voucher_template_title']			= '卡券包名稱';
...
$lang['admin_voucher_template_styleimg']		= '選擇卡券包皮膚';
$lang['admin_voucher_template_image']			= '卡券包圖片';
$lang['admin_voucher_template_points']			= '兌換所需積分數';
$lang['admin_voucher_template_adddate']			= '添加時間';
$lang['admin_voucher_template_list_tip']		= '手工設置卡券包失效後,用戶將不能領取該卡券包,但是已經領取的卡券包仍然可以使用';
