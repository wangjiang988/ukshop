...
$lang['voucher_allow_notice'] = '卡券包功能、積分功能、金幣功能、積分中心啟用後，賣家可以申請卡券包活動；會員積分達到要求時可以在積分中心兌換卡券包；<br>擁有卡券包的會員可在卡券包所屬店舖內購買商品時，選擇使用而得到優惠';
...
$lang['ftp_attach_dir_tip'] 	= '遠程附件目錄的絶對路徑或相對於 FTP 主目錄的相對路徑，如果是根目錄請填"/"，非根目錄，請保證伺服器端該目錄已存在，結尾不需要"/"，如"/upload/ukshop"';
$lang['ftp_access_url_tip'] = '支持 HTTP 和 FTP 協議，結尾不要加斜杠“/”；如果使用 FTP 協議，FTP 伺服器必需支持 PASV 模式，為了安全起見，使用 FTP 連接的帳號不要設置可寫權限和列表權限。如果是根目錄，直接輸入域名即可，如“http://www.ukshop.com”，如果非根目錄，需要填寫域名+目錄形式，如“http://www.ukshop.com/upload/ukshop”';
