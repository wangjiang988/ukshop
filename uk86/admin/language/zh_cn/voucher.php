...
$lang['admin_voucher_unavailable']    = '需开启 卡券包、U币，正在跳转到设置页面 。。。';
...
$lang['admin_voucher_template_manage']= '店铺卡券包';
$lang['admin_voucher_template_edit']= '编辑卡券包';
...
$lang['admin_voucher_setting_buyertimes_tip']	= '买家最多只能拥有同一个店铺尚未消费抵用的店铺卡券包最大数量';
//$lang['admin_voucher_setting_default_styleimg']	= '卡券包默认样式模板';
/**
 * 卡券包面额
 */
$lang['admin_voucher_price_error']   		= '卡券包面额应为大于0的整数';
$lang['admin_voucher_price_describe_error'] = '描述不能为空';
$lang['admin_voucher_price_describe_lengtherror'] = '卡券包描述不能为空且不能大于255个字符';
$lang['admin_voucher_price_points_error']   = '默认兑换U币数应为大于0的整数';
$lang['admin_voucher_price_exist']    		= '该卡券包面额已经存在';
$lang['admin_voucher_price_title']    		= '卡券包面额';
$lang['admin_voucher_price_describe']    	= '描述';
$lang['admin_voucher_price_points']    		= '兑换U币数';
$lang['admin_voucher_price_points_tip']    	= '当兑换卡券包时，消耗的U币数';
$lang['admin_voucher_price_tip1']    	= '管理员规定卡券包面额，店铺发放卡券包时面额从规定的面额中选择';
/**
 * 卡券包套餐申请
 */
$lang['admin_voucher_apply_goldnotenough']	= '该会员金币不够，操作失败';
$lang['admin_voucher_apply_goldlog']    	= '购买卡券包活动%s个月，单价%s金币，总共花费%s金币';
$lang['admin_voucher_apply_message']    	= '您成功购买卡券包活动%s个月，单价%s金币，总共花费%s金币，时间从审核后开始计算';
...
$lang['admin_voucher_apply_list_tip2']    	= '当卖家金币不足时审核会失败，卖家发布成功的卡券包会出现在U币中心，买家可凭U币进行兑换';
 ...
 * 卡券包
 */
$lang['admin_voucher_template_points_error']	= '兑换所需U币数应为大于0的整数';
$lang['admin_voucher_template_title']			= '卡券包名称';
...
$lang['admin_voucher_template_describe']		= '卡券包描述';
$lang['admin_voucher_template_styleimg']		= '选择卡券包皮肤';
$lang['admin_voucher_template_image']			= '卡券包图片';
$lang['admin_voucher_template_points']			= '兑换所需U币数';
$lang['admin_voucher_template_adddate']			= '添加时间';
$lang['admin_voucher_template_list_tip']		= '手工设置卡券包失效后,用户将不能领取该卡券包,但是已经领取的卡券包仍然可以使用';
